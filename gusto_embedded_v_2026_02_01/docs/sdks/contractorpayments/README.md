...
import { contractorPaymentsGetV1ContractorsContractorUuidPayments } from "@gusto/embedded-api-v-2026-02-01/funcs/contractorPaymentsGetV1ContractorsContractorUuidPayments.js";
...
} from "@gusto/embedded-api-v-2026-02-01/react-query/contractorPaymentsGetV1ContractorsContractorUuidPayments.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-02-01/core.js";
import { contractorPaymentsGetV1ContractorPaymentsContractorPaymentIdPdf } from "@gusto/embedded-api-v-2026-02-01/funcs/contractorPaymentsGetV1ContractorPaymentsContractorPaymentIdPdf.js";
...
} from "@gusto/embedded-api-v-2026-02-01/react-query/contractorPaymentsGetV1ContractorPaymentsContractorPaymentIdPdf.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-02-01/core.js";
import { contractorPaymentsList } from "@gusto/embedded-api-v-2026-02-01/funcs/contractorPaymentsList.js";
...
} from "@gusto/embedded-api-v-2026-02-01/react-query/contractorPaymentsList.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-02-01/core.js";
import { contractorPaymentsCreate } from "@gusto/embedded-api-v-2026-02-01/funcs/contractorPaymentsCreate.js";
import { RFCDate } from "@gusto/embedded-api-v-2026-02-01/types/rfcdate.js";
...
} from "@gusto/embedded-api-v-2026-02-01/react-query/contractorPaymentsCreate.js";
```
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.PostV1CompaniesCompanyIdContractorPaymentsRequest](../../models/operations/postv1companiescompanyidcontractorpaymentsrequest.md)                                   | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-02-01/core.js";
import { contractorPaymentsGet } from "@gusto/embedded-api-v-2026-02-01/funcs/contractorPaymentsGet.js";
...
import {
  ...
  useContractorPaymentsGetSuspense,
  ...
  // Utilities to invalidate the query cache for this query in response to
  // mutations and other user actions.
  invalidateContractorPaymentsGet,
  invalidateAllContractorPaymentsGet,
} from "@gusto/embedded-api-v-2026-02-01/react-query/contractorPaymentsGet.js";
```
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetV1CompaniesCompanyIdContractorPaymentContractorPaymentRequest](../../models/operations/getv1companiescompanyidcontractorpaymentcontractorpaymentrequest.md)     | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-02-01/core.js";
import { contractorPaymentsDelete } from "@gusto/embedded-api-v-2026-02-01/funcs/contractorPaymentsDelete.js";
...
} from "@gusto/embedded-api-v-2026-02-01/react-query/contractorPaymentsDelete.js";
```
...
| Parameter                                                                                                                                                                        | Type                                                                                                                                                                             | Required                                                                                                                                                                         | Description                                                                                                                                                                      |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `request`                                                                                                                                                                        | [operations.DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentRequest](../../models/operations/deletev1companiescompanyidcontractorpaymentcontractorpaymentrequest.md) | :heavy_check_mark:                                                                                                                                                               | The request object to use for the request.                                                                                                                                       |
| `options`                                                                                                                                                                        | RequestOptions                                                                                                                                                                   | :heavy_minus_sign:                                                                                                                                                               | Used to set various options for making HTTP requests.                                                                                                                            |
| `options.fetchOptions`                                                                                                                                                           | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                          | :heavy_minus_sign:                                                                                                                                                               | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed.   |
| `options.retries`                                                                                                                                                                | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                    | :heavy_minus_sign:                                                                                                                                                               | Enables retrying HTTP requests under certain failure conditions.                                                                                                                 |
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-02-01/core.js";
import { contractorPaymentsGetReceipt } from "@gusto/embedded-api-v-2026-02-01/funcs/contractorPaymentsGetReceipt.js";
...
} from "@gusto/embedded-api-v-2026-02-01/react-query/contractorPaymentsGetReceipt.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-02-01/core.js";
import { contractorPaymentsFund } from "@gusto/embedded-api-v-2026-02-01/funcs/contractorPaymentsFund.js";
...
} from "@gusto/embedded-api-v-2026-02-01/react-query/contractorPaymentsFund.js";
```
