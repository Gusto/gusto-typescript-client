...
import { locationsGetMinimumWages } from "@gusto/embedded-api-v-2026-02-01/funcs/locationsGetMinimumWages.js";
...
} from "@gusto/embedded-api-v-2026-02-01/react-query/locationsGetMinimumWages.js";
```
...
async function run() {
  const result = await gustoEmbedded.locations.retrieve({
    locationId: "<id>",
  });
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-02-01/core.js";
import { locationsRetrieve } from "@gusto/embedded-api-v-2026-02-01/funcs/locationsRetrieve.js";
...
async function run() {
  const res = await locationsRetrieve(gustoEmbedded, {
    locationId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
...
import {
  ...
  // Utilities to invalidate the query cache for this query in response to
  // mutations and other user actions.
  invalidateLocationsRetrieve,
  invalidateAllLocationsRetrieve,
} from "@gusto/embedded-api-v-2026-02-01/react-query/locationsRetrieve.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-02-01/core.js";
import { locationsUpdate } from "@gusto/embedded-api-v-2026-02-01/funcs/locationsUpdate.js";
...
} from "@gusto/embedded-api-v-2026-02-01/react-query/locationsUpdate.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-02-01/core.js";
import { locationsGet } from "@gusto/embedded-api-v-2026-02-01/funcs/locationsGet.js";
...
} from "@gusto/embedded-api-v-2026-02-01/react-query/locationsGet.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-02-01/core.js";
import { locationsCreate } from "@gusto/embedded-api-v-2026-02-01/funcs/locationsCreate.js";
...
} from "@gusto/embedded-api-v-2026-02-01/react-query/locationsCreate.js";
```
