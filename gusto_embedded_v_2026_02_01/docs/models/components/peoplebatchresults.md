...
```typescript
import { PeopleBatchResults } from "@gusto/embedded-api-v-2026-02-01/models/components/peoplebatchresults.js";
...
| `results`                                                                                            | [components.PeopleBatchResultsResults](../../models/components/peoplebatchresultsresults.md)[]       | :heavy_minus_sign:                                                                                   | The results for each batch item.                                                                     |
| `exclusions`                                                                                         | [components.PeopleBatchResultsExclusions](../../models/components/peoplebatchresultsexclusions.md)[] | :heavy_minus_sign:                                                                                   | Items excluded from processing due to validation errors.                                             |