...
```typescript
import { ContractorPaymentSummary } from "@gusto/embedded-api-v-2026-02-01/models/components/contractorpaymentsummary.js";
...
| `contractorPayments`                                                                      | [components.ContractorPayments](../../models/components/contractorpayments.md)[]          | :heavy_minus_sign:                                                                        | The individual contractor payments, within a given time period, grouped by contractor.    |