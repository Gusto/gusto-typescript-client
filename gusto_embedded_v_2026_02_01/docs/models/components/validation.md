...
```typescript
import { Validation } from "@gusto/embedded-api-v-2026-02-01/models/components/taxrequirementmetadata.js";
...
| ------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| `type`                                                                                                              | [components.TaxRequirementMetadataType](../../models/components/taxrequirementmetadatatype.md)                      | :heavy_check_mark:                                                                                                  | Describes the type of tax_rate validation rule                                                                      |
