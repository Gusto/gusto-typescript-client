...
Developer-friendly & type-safe Typescript SDK specifically catered to leverage *@gusto/embedded-api-v-2026-02-01* API.

[![Built by Speakeasy](https://img.shields.io/badge/Built_by-SPEAKEASY-374151?style=for-the-badge&labelColor=f3f4f6)](https://www.speakeasy.com/?utm_source=@gusto/embedded-api-v-2026-02-01&utm_campaign=typescript)
...
## Table of Contents
<!-- $toc-max-depth=2 -->
* [@gusto/embedded-api-v-2026-02-01](#gustoembedded-api-v-2026-02-01)
...
```bash
npm add @gusto/embedded-api-v-2026-02-01
...
```bash
pnpm add @gusto/embedded-api-v-2026-02-01
# Install optional peer dependencies if you plan to use React hooks
...
```bash
bun add @gusto/embedded-api-v-2026-02-01
# Install optional peer dependencies if you plan to use React hooks
...
```bash
yarn add @gusto/embedded-api-v-2026-02-01
# Install optional peer dependencies if you plan to use React hooks
...
> CommonJS, use `await import("@gusto/embedded-api-v-2026-02-01")` to import and use this package.
...
* [~~acceptTermsOfService~~](docs/sdks/companies/README.md#accepttermsofservice) - Accept terms of service for an admin :warning: **Deprecated**
* [~~retrieveTermsOfService~~](docs/sdks/companies/README.md#retrievetermsofservice) - Retrieve terms of service status for an admin :warning: **Deprecated**
* [getV1PartnerManagedCompaniesCompanyUuidTermsOfService](docs/sdks/companies/README.md#getv1partnermanagedcompaniescompanyuuidtermsofservice) - Get the terms of service status for a company
* [putV1PartnerManagedCompaniesCompanyUuidTermsOfService](docs/sdks/companies/README.md#putv1partnermanagedcompaniescompanyuuidtermsofservice) - Check terms of service status for a specific user
* [postV1PartnerManagedCompaniesCompanyUuidTermsOfService](docs/sdks/companies/README.md#postv1partnermanagedcompaniescompanyuuidtermsofservice) - Accept terms of service for a specific user
...
- [`companiesGetV1PartnerManagedCompaniesCompanyUuidTermsOfService`](docs/sdks/companies/README.md#getv1partnermanagedcompaniescompanyuuidtermsofservice) - Get the terms of service status for a company
...
- [`companyBenefitsGetAll`](docs/sdks/companybenefits/README.md#getall) - Get all supported benefits
...
- [`companyBenefitsGetRequirements`](docs/sdks/companybenefits/README.md#getrequirements) - Get benefit fields requirements by benefit type
...
- [`companyBenefitsGetSupported`](docs/sdks/companybenefits/README.md#getsupported) - Get a supported benefit
...
- [`employeePaymentMethodsGetBankAccounts`](docs/sdks/employeepaymentmethods/README.md#getbankaccounts) - List employee bank accounts
...
- [`externalPayrollsCreate`](docs/sdks/externalpayrolls/README.md#create) - Create an external payroll for a company
...
- ~~[`companiesAcceptTermsOfService`](docs/sdks/companies/README.md#accepttermsofservice)~~ - Accept terms of service for an admin :warning: **Deprecated**
- ~~[`companiesRetrieveTermsOfService`](docs/sdks/companies/README.md#retrievetermsofservice)~~ - Retrieve terms of service status for an admin :warning: **Deprecated**
...
- [`useCompaniesGetV1PartnerManagedCompaniesCompanyUuidTermsOfService`](docs/sdks/companies/README.md#getv1partnermanagedcompaniescompanyuuidtermsofservice) - Get the terms of service status for a company
...
- [`useCompanyBenefitsGetAll`](docs/sdks/companybenefits/README.md#getall) - Get all supported benefits
...
- [`useCompanyBenefitsGetRequirements`](docs/sdks/companybenefits/README.md#getrequirements) - Get benefit fields requirements by benefit type
...
- [`useCompanyBenefitsGetSupported`](docs/sdks/companybenefits/README.md#getsupported) - Get a supported benefit
...
- [`useEmployeePaymentMethodsGetBankAccounts`](docs/sdks/employeepaymentmethods/README.md#getbankaccounts) - List employee bank accounts
...
- [`useExternalPayrollsCreateMutation`](docs/sdks/externalpayrolls/README.md#create) - Create an external payroll for a company
...
- ~~[`useCompaniesAcceptTermsOfServiceMutation`](docs/sdks/companies/README.md#accepttermsofservice)~~ - Accept terms of service for an admin :warning: **Deprecated**
- ~~[`useCompaniesRetrieveTermsOfServiceMutation`](docs/sdks/companies/README.md#retrievetermsofservice)~~ - Retrieve terms of service status for an admin :warning: **Deprecated**
...
```typescript
import { GustoEmbedded } from "@gusto/embedded-api-v-2026-02-01";
import { GustoEmbeddedError } from "@gusto/embedded-api-v-2026-02-01/models/errors/gustoembeddederror.js.js";
import { NotFoundErrorObject } from "@gusto/embedded-api-v-2026-02-01/models/errors/notfounderrorobject.js";
...
async function run() {
  try {
    ...
    if (error instanceof GustoEmbeddedError) {
      ...
      if (error instanceof NotFoundErrorObject) {
...
* [`UnprocessableEntityError`](./src/models/errors/unprocessableentityerror.ts): Unprocessable Entity    This may happen when the body of your request contains errors such as `invalid_attribute_value`, or the request fails due to an `invalid_operation`. See the [Errors Categories](https://docs.gusto.com/embedded-payroll/docs/error-categories) guide for more details. Applicable to 173 of 316 methods.*
* [`ConflictErrorObject`](./src/models/errors/conflicterrorobject.ts): Conflict    This may happen when the resource version provided does not match the current version — retrieve the latest version and retry — or when the request conflicts with another in-progress operation on the same resource. See the [Errors Categories](https://docs.gusto.com/embedded-payroll/docs/error-categories) guide for more details. Status code `409`. Applicable to 3 of 316 methods.*
* [`ForbiddenErrorObject`](./src/models/errors/forbiddenerrorobject.ts): Forbidden    The targeted company has been archived because its EIN was reassigned to a replacement company. Use the replacement company referenced in the error metadata. Status code `403`. Applicable to 1 of 316 methods.*
* [`PayrollBatchConflictError`](./src/models/errors/payrollbatchconflicterror.ts): Error response when a payroll cancellation idempotency key has already been used by the same partner. Status code `409`. Applicable to 1 of 316 methods.*
* [`PayrollDigestConflictError`](./src/models/errors/payrolldigestconflicterror.ts): Error response when a payroll digest idempotency key has already been used by the same partner. Status code `409`. Applicable to 1 of 316 methods.*
* [`PeopleBatchConflictError`](./src/models/errors/peoplebatchconflicterror.ts): Error response when a people batch idempotency key conflict occurs. Status code `409`. Applicable to 1 of 316 methods.*
* [`PayrollBlockersError`](./src/models/errors/payrollblockerserror.ts): Payroll Blockers Error  For detailed information, see the [Payroll Blockers guide](https://docs.gusto.com/embedded-payroll/docs/payroll-blockers). Status code `422`. Applicable to 1 of 316 methods.*
...
import { HTTPClient } from "@gusto/embedded-api-v-2026-02-01/lib/http";
...
### SDK Created by [Speakeasy](https://www.speakeasy.com/?utm_source=@gusto/embedded-api-v-2026-02-01&utm_campaign=typescript)
