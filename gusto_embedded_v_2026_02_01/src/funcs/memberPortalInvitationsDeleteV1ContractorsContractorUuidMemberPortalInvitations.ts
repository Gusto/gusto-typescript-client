 ...
 */
export function memberPortalInvitationsDeleteV1ContractorsContractorUuidMemberPortalInvitations(
...
> {
  ...
  const context = {
    ...
    operationID:
      "delete-v1-contractors-contractor_uuid-member_portal_invitations",
    oAuth2Scopes: null,
