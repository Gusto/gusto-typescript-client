...
Developer-friendly & type-safe Typescript SDK specifically catered to leverage *@gusto/embedded-api-v2025-11-15* API.

[![Built by Speakeasy](https://img.shields.io/badge/Built_by-SPEAKEASY-374151?style=for-the-badge&labelColor=f3f4f6)](https://www.speakeasy.com/?utm_source=@gusto/embedded-api-v2025-11-15&utm_campaign=typescript)
...
## Table of Contents
<!-- $toc-max-depth=2 -->
* [@gusto/embedded-api-v2025-11-15](#gustoembedded-api-v2025-11-15)
...
```bash
npm add @gusto/embedded-api-v2025-11-15
...
```bash
pnpm add @gusto/embedded-api-v2025-11-15
# Install optional peer dependencies if you plan to use React hooks
...
```bash
bun add @gusto/embedded-api-v2025-11-15
# Install optional peer dependencies if you plan to use React hooks
...
```bash
yarn add @gusto/embedded-api-v2025-11-15
# Install optional peer dependencies if you plan to use React hooks
...
> CommonJS, use `await import("@gusto/embedded-api-v2025-11-15")` to import and use this package.
...
```typescript
import { GustoEmbedded } from "@gusto/embedded-api-v2025-11-15";
import { GustoEmbeddedError } from "@gusto/embedded-api-v2025-11-15/models/errors/gustoembeddederror.js.js";
import { UnprocessableEntityErrorObject } from "@gusto/embedded-api-v2025-11-15/models/errors/unprocessableentityerrorobject.js";
...
import { HTTPClient } from "@gusto/embedded-api-v2025-11-15/lib/http";
...
### SDK Created by [Speakeasy](https://www.speakeasy.com/?utm_source=@gusto/embedded-api-v2025-11-15&utm_campaign=typescript)
