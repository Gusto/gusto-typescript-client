...
```typescript
import { SalaryEstimate } from "openapi/models";
...
| `occupations`                                                                                 | [models.Occupation](../models/occupation.md)[]                                                | :heavy_check_mark:                                                                            | Array of occupations with their experience levels and time allocations.                       |