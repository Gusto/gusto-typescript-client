...
```typescript
import { PayrollCheck } from "openapi/models";
...
| `startingCheckNumber`                                                             | *number*                                                                          | :heavy_minus_sign:                                                                | The starting check number for the checks being printed.                           |
...
| `employeeCheckNumberMapping`                                                      | [models.EmployeeCheckNumberMapping](../models/employee-check-number-mapping.md)[] | :heavy_minus_sign:                                                                | An array of mapping employee uuids to their check numbers                         |