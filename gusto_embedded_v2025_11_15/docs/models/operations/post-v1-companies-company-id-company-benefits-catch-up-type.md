...
```typescript
import { PostV1CompaniesCompanyIdCompanyBenefitsCatchUpType } from "openapi/models/operations";

let value: PostV1CompaniesCompanyIdCompanyBenefitsCatchUpType = "deemed";
```
