...
```typescript
import { Earning } from "openapi/models/operations";
...
| `earningType`                                                     | [operations.EarningType](../../models/operations/earning-type.md) | :heavy_minus_sign:                                                | The earning type for the compensation.                            |