...
```typescript
import { PostV1CompaniesCompanyIdPeopleBatchesRequestBody } from "openapi/models/operations";
...
| `batchAction`                                                     | [operations.BatchAction](../../models/operations/batch-action.md) | :heavy_check_mark:                                                | The action to perform on the batch                                | create                                                            |
