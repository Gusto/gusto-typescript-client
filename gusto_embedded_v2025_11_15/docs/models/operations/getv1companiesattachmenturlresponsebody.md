...
```typescript
import { GetV1CompaniesAttachmentUrlResponseBody } from "@gusto/embedded-api-v2025-11-15/models/operations/getv1companiesattachmenturl.js";

let value: GetV1CompaniesAttachmentUrlResponseBody = {
  url: "https://gripping-pilot.com/",
};
```
