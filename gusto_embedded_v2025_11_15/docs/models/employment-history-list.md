...
```typescript
import { EmploymentHistoryList } from "openapi/models";
...
| `employmentStatus`                                                                                                                 | [models.EmploymentHistoryListEmploymentStatus](../models/employment-history-list-employment-status.md)                             | :heavy_minus_sign:                                                                                                                 | The employee's employment status. Supplying an invalid option will set the employment_status to *not_set*.                         |