...
```typescript
import { RehireBody } from "openapi/models";
...
| `employmentStatus`                                                                                                                 | [models.RehireBodyEmploymentStatus](../models/rehire-body-employment-status.md)                                                    | :heavy_minus_sign:                                                                                                                 | The employee's employment status. Supplying an invalid option will set the employment_status to *not_set*.                         |
