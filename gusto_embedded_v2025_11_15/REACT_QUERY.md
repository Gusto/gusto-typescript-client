...
import { GustoEmbeddedCore } from "@gusto/embedded-api-v2025-11-15";
import { GustoEmbeddedProvider } from "@gusto/embedded-api-v2025-11-15/react-query";
...
queryClient.setQueryDefaults(["@gusto/embedded-api-v2025-11-15"], { retry: false });
queryClient.setMutationDefaults(["@gusto/embedded-api-v2025-11-15"], { retry: false });
...
```tsx
import { useIntrospectionGetInfo } from "@gusto/embedded-api-v2025-11-15/react-query/introspectionGetInfo.js";
...
```tsx
import { useIntrospectionOauthAccessTokenMutation } from "@gusto/embedded-api-v2025-11-15/react-query/introspectionOauthAccessToken.js";
...
import { invalidateIntrospectionGetInfo, invalidateAllIntrospectionGetInfo } from "@gusto/embedded-api-v2025-11-15/react-query/introspectionGetInfo.js";
// Replace this with a real mutation
import { useExampleMutation } from "@gusto/embedded-api-v2025-11-15/react-query/example.js";
...
import { GustoEmbeddedCore } from "@gusto/embedded-api-v2025-11-15";
import { GustoEmbeddedProvider } from "@gusto/embedded-api-v2025-11-15/react-query";
import { useIntrospectionGetInfoSuspense } from "@gusto/embedded-api-v2025-11-15/react-query/introspectionGetInfo.js";
...
import { GustoEmbeddedCore } from "@gusto/embedded-api-v2025-11-15";
import { prefetchIntrospectionGetInfo } from "@gusto/embedded-api-v2025-11-15/react-query/introspectionGetInfo.js";
