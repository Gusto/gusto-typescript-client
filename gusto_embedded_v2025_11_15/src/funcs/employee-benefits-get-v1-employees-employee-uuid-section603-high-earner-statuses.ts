 ...
 */
export function employeeBenefitsGetV1EmployeesEmployeeUuidSection603HighEarnerStatuses(
  client: SDKCore,
  request:
  ...
  Result<
    Array<models.EmployeeSection603HighEarnerStatus>,
...
> {
  ...
  const context = {
    ...
    operationID:
      "get-v1-employees-employee_uuid-section603_high_earner_statuses",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      z.array(models.EmployeeSection603HighEarnerStatus$inboundSchema),
    ),
