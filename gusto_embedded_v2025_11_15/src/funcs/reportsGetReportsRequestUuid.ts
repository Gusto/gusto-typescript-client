...
import {
  ...
  GetReportsRequestUuidRequest$outboundSchema,
  GetReportsRequestUuidResponse,
  GetReportsRequestUuidResponse$inboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetReportsRequestUuidRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetReportsRequestUuidResponse$inboundSchema, { key: "Report" }),
    M.fail([404, "4XX"]),
    M.fail("5XX"),
