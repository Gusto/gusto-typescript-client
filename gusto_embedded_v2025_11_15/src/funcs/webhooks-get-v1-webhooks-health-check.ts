...
export function webhooksGetV1WebhooksHealthCheck(
  ...
  Result<
    models.WebhooksHealthCheckStatus,
    | SDKError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.GetV1WebhooksHealthCheckRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.WebhooksHealthCheckStatus$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
