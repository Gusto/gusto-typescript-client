 ...
 */
export function employeeAddressesRetrieveHomeAddress(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetV1HomeAddressesHomeAddressUuidRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.EmployeeAddress$inboundSchema),
