...
export function reimbursementsPutV1RecurringReimbursements(
  ...
  Result<
    operations.PutV1RecurringReimbursementsResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.PutV1RecurringReimbursementsRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PutV1RecurringReimbursementsResponse$inboundSchema),
    M.jsonErr([404, 409, 422], errors.NotFoundErrorObject$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
