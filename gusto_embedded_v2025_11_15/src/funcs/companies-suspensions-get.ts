...
export function companiesSuspensionsGet(
  ...
  Result<
    Array<models.CompanySuspension>,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetCompaniesCompanyUuidSuspensionsRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.CompanySuspension$inboundSchema)),
