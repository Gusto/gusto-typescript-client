...
export function holidayPayPoliciesGet(
  ...
  Result<
    models.HolidayPayPolicy | undefined,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .GetV1CompaniesCompanyUuidHolidayPayPolicyRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, types$.optional(models.HolidayPayPolicy$inboundSchema)),
    M.nil(204, types$.optional(models.HolidayPayPolicy$inboundSchema)),
