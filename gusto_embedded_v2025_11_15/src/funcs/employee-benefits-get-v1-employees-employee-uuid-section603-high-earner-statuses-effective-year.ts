 ...
 */
export function employeeBenefitsGetV1EmployeesEmployeeUuidSection603HighEarnerStatusesEffectiveYear(
  client: SDKCore,
  request:
...
> {
  ...
  const context = {
    ...
    operationID:
      "get-v1-employees-employee_uuid-section603_high_earner_statuses-effective_year",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.EmployeeSection603HighEarnerStatus$inboundSchema),
