...
export function webhooksListSubscriptions(
  ...
  Result<
    Array<models.WebhookSubscription>,
    | SDKError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.GetV1WebhookSubscriptionsRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.WebhookSubscription$inboundSchema)),
    M.fail([404, "4XX"]),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
