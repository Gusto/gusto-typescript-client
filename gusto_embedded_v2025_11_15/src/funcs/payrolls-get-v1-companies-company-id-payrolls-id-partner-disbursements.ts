 ...
 */
export function payrollsGetV1CompaniesCompanyIdPayrollsIdPartnerDisbursements(
  client: SDKCore,
  request:
  ...
  Result<
    models.PayrollPartnerDisbursements,
...
> {
  ...
  const context = {
    ...
    operationID:
      "get-v1-companies-company_id-payrolls-id-partner_disbursements",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PayrollPartnerDisbursements$inboundSchema),
