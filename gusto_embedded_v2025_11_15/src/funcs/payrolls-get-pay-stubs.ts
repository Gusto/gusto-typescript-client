 ...
 */
export function payrollsGetPayStubs(
  client: SDKCore,
  request: operations.GetV1EmployeesEmployeeUuidPayStubsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<models.EmployeePayStubsList>,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetV1EmployeesEmployeeUuidPayStubsRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.EmployeePayStubsList$inboundSchema)),
