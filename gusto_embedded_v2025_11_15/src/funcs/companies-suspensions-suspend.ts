...
export function companiesSuspensionsSuspend(
  ...
  Result<
    ...
    | errors.CompanySuspensionCreationErrors
    | SDKError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.PostCompaniesCompanyUuidSuspensionsRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CompanySuspension$inboundSchema),
    M.jsonErr(422, errors.CompanySuspensionCreationErrors$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
