 ...
 */
export function employeeAddressesUpdateWorkAddress(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.PutV1WorkAddressesWorkAddressUuidRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.EmployeeWorkAddress$inboundSchema),
