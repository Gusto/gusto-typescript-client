...
> {
  ...
  if (isBlobLike(payload.body.document)) {
    appendForm(body, "document", payload.body.document);
    ...
    appendForm(body, "document", blob, payload.body.document.fileName);
  } else {
    const contentType =
      getContentTypeFromFileName(payload.body.document.fileName)
      || "application/octet-stream";
    appendForm(
      body,
      "document",
      new Blob([payload.body.document.content], { type: contentType }),
