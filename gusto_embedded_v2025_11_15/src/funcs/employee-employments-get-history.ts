...
export function employeeEmploymentsGetHistory(
  ...
  Result<
    Array<models.EmploymentHistoryList>,
...
> {
  ...
  const path = pathToFunc("/v1/employees/{employee_id}/employment_history")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.EmploymentHistoryList$inboundSchema)),
