 ...
 */
export function contractorPaymentGroupsGetV1ContractorPaymentGroupsIdPartnerDisbursements(
  client: SDKCore,
  request: operations.GetV1ContractorPaymentGroupsIdPartnerDisbursementsRequest,
...
> {
  ...
  >(
    M.json(
      200,
      models.ContractorPaymentGroupPartnerDisbursements$inboundSchema,
    ),
