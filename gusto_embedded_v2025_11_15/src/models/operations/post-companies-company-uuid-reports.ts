...
export type PostCompaniesCompanyUuidReportsRequest = {
  ...
  body: PostCompaniesCompanyUuidReportsRequestBody;
};
...
export const PostCompaniesCompanyUuidReportsPaymentMethod$outboundSchema:
  z.ZodMiniEnum<typeof PostCompaniesCompanyUuidReportsPaymentMethod> = z.enum(
...
export const PostCompaniesCompanyUuidReportsEmploymentStatus$outboundSchema:
  z.ZodMiniEnum<typeof PostCompaniesCompanyUuidReportsEmploymentStatus> = z
    .enum(PostCompaniesCompanyUuidReportsEmploymentStatus);
...
export type PostCompaniesCompanyUuidReportsRequest$Outbound = {
  ...
  body: PostCompaniesCompanyUuidReportsRequestBody$Outbound;
};
