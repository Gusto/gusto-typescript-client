...
import { i9VerificationCreateDocuments } from "../funcs/i9-verification-create-documents.js";
import { i9VerificationDeleteDocument } from "../funcs/i9-verification-delete-document.js";
import { i9VerificationEmployerSign } from "../funcs/i9-verification-employer-sign.js";
import { i9VerificationGetAuthorization } from "../funcs/i9-verification-get-authorization.js";
import { i9VerificationGetDocumentOptions } from "../funcs/i9-verification-get-document-options.js";
import { i9VerificationGetDocuments } from "../funcs/i9-verification-get-documents.js";
import { i9VerificationUpdate } from "../funcs/i9-verification-update.js";
...
export class I9Verification extends ClientSDK {
  ...
  ): Promise<models.I9Authorization> {
  ...
  async getDocumentOptions(
    ...
    options?: RequestOptions,
  ): Promise<Array<models.I9AuthorizationDocumentOption>> {
  ...
  async getDocuments(
    ...
    options?: RequestOptions,
  ): Promise<Array<models.I9AuthorizationDocument>> {
