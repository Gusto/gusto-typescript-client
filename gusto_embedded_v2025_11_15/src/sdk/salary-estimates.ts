...
import { salaryEstimatesGetV1SalaryEstimatesId } from "../funcs/salary-estimates-get-v1-salary-estimates-id.js";
import { salaryEstimatesGetV1SalaryEstimatesOccupations } from "../funcs/salary-estimates-get-v1-salary-estimates-occupations.js";
import { salaryEstimatesPostV1EmployeesEmployeeIdSalaryEstimates } from "../funcs/salary-estimates-post-v1-employees-employee-id-salary-estimates.js";
import { salaryEstimatesPostV1SalaryEstimatesUuidAccept } from "../funcs/salary-estimates-post-v1-salary-estimates-uuid-accept.js";
import { salaryEstimatesPutV1SalaryEstimatesId } from "../funcs/salary-estimates-put-v1-salary-estimates-id.js";
...
export class SalaryEstimates extends ClientSDK {
  ...
  async postV1EmployeesEmployeeIdSalaryEstimates(
    request: operations.PostV1EmployeesEmployeeIdSalaryEstimatesRequest,
    options?: RequestOptions,
  ): Promise<models.SalaryEstimate> {
  ...
  async getV1SalaryEstimatesId(
    request: operations.GetV1SalaryEstimatesIdRequest,
    options?: RequestOptions,
  ): Promise<models.SalaryEstimate> {
  ...
  async putV1SalaryEstimatesId(
    request: operations.PutV1SalaryEstimatesIdRequest,
    options?: RequestOptions,
  ): Promise<models.SalaryEstimate> {
  ...
  async postV1SalaryEstimatesUuidAccept(
    request: operations.PostV1SalaryEstimatesUuidAcceptRequest,
    options?: RequestOptions,
  ): Promise<models.SalaryEstimate> {
  ...
  async getV1SalaryEstimatesOccupations(
    security: operations.GetV1SalaryEstimatesOccupationsSecurity,
    request: operations.GetV1SalaryEstimatesOccupationsRequest,
    options?: RequestOptions,
  ): Promise<Array<models.BLSOccupation>> {
