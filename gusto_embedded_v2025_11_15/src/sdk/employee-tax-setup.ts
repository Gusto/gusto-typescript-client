...
import { employeeTaxSetupGetFederalTaxes } from "../funcs/employee-tax-setup-get-federal-taxes.js";
import { employeeTaxSetupGetStateTaxes } from "../funcs/employee-tax-setup-get-state-taxes.js";
import { employeeTaxSetupUpdateFederalTaxes } from "../funcs/employee-tax-setup-update-federal-taxes.js";
import { employeeTaxSetupUpdateStateTaxes } from "../funcs/employee-tax-setup-update-state-taxes.js";
...
export class EmployeeTaxSetup extends ClientSDK {
  ...
  ): Promise<models.EmployeeFederalTax> {
  ...
  async getStateTaxes(
    ...
    options?: RequestOptions,
  ): Promise<Array<models.EmployeeStateTaxesList>> {
