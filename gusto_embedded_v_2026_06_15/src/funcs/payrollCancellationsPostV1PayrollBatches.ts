...
import {
  ...
  PayrollBatchConflictError$inboundSchema,
} from "../models/errors/payrollbatchconflicterror.js";
...
import {
  ...
  PostV1PayrollBatchesRequest$outboundSchema,
  PostV1PayrollBatchesResponse,
  PostV1PayrollBatchesResponse$inboundSchema,
 ...
 */
export function payrollCancellationsPostV1PayrollBatches(
...
> {
  const parsed = safeParse(
    request,
    (value) => PostV1PayrollBatchesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/payroll_batches")();
  ...
  const context = {
    ...
    operationID: "post-v1-payroll_batches",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, PostV1PayrollBatchesResponse$inboundSchema, {
      key: "Payroll-Batch",
    }),
    M.jsonErr(409, PayrollBatchConflictError$inboundSchema),
