...
import {
  ...
  GetReverseWireTransactionsRequest$outboundSchema,
  GetReverseWireTransactionsResponse,
  GetReverseWireTransactionsResponse$inboundSchema,
 ...
 */
export function reverseWireTransactionsGetReverseWireTransactions(
...
> {
  const parsed = safeParse(
    request,
    (value) => GetReverseWireTransactionsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetReverseWireTransactionsResponse$inboundSchema, {
      key: "Reverse-Wire-Transaction-List",
    }),
