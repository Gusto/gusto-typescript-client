...
import {
  ...
  PostV1ContractorsContractorUuidTerminationRequest$outboundSchema,
  PostV1ContractorsContractorUuidTerminationResponse,
  PostV1ContractorsContractorUuidTerminationResponse$inboundSchema,
 ...
 */
export function contractorsPostV1ContractorsContractorUuidTermination(
...
> {
  ...
  const path = pathToFunc("/v1/contractors/{contractor_uuid}/termination")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "post-v1-contractors-contractor_uuid-termination",
    oAuth2Scopes: null,
