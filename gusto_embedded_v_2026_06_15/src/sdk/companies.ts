...
export class Companies extends ClientSDK {
   ...
   * scope: `terms_of_services:read`
   */
  async getV1PartnerManagedCompaniesCompanyUuidTermsOfService(
    request: GetV1PartnerManagedCompaniesCompanyUuidTermsOfServiceRequest,
    options?: RequestOptions,
  ): Promise<GetV1PartnerManagedCompaniesCompanyUuidTermsOfServiceResponse> {
    return unwrapAsync(
   ...
   * scope: `terms_of_services:read`
   */
  async putV1PartnerManagedCompaniesCompanyUuidTermsOfService(
    request: PutV1PartnerManagedCompaniesCompanyUuidTermsOfServiceRequest,
    options?: RequestOptions,
  ): Promise<PutV1PartnerManagedCompaniesCompanyUuidTermsOfServiceResponse> {
    return unwrapAsync(
   ...
   * scope: `terms_of_services:write`
   */
  async postV1PartnerManagedCompaniesCompanyUuidTermsOfService(
    request: PostV1PartnerManagedCompaniesCompanyUuidTermsOfServiceRequest,
    options?: RequestOptions,
  ): Promise<PostV1PartnerManagedCompaniesCompanyUuidTermsOfServiceResponse> {
    return unwrapAsync(
