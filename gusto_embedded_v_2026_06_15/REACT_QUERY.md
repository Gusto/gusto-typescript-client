...
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15";
import { GustoEmbeddedProvider } from "@gusto/embedded-api-v-2026-06-15/react-query";
...
queryClient.setQueryDefaults(["@gusto/embedded-api-v-2026-06-15"], { retry: false });
queryClient.setMutationDefaults(["@gusto/embedded-api-v-2026-06-15"], { retry: false });
...
```tsx
import { useAchTransactionsGetAll } from "@gusto/embedded-api-v-2026-06-15/react-query/achTransactionsGetAll.js";
...
```tsx
import { useCompaniesCreateAdminMutation } from "@gusto/embedded-api-v-2026-06-15/react-query/companiesCreateAdmin.js";
...
import { invalidateAchTransactionsGetAll, invalidateAllAchTransactionsGetAll } from "@gusto/embedded-api-v-2026-06-15/react-query/achTransactionsGetAll.js";
// Replace this with a real mutation
import { useExampleMutation } from "@gusto/embedded-api-v-2026-06-15/react-query/example.js";
...
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15";
import { GustoEmbeddedProvider } from "@gusto/embedded-api-v-2026-06-15/react-query";
import { useAchTransactionsGetAllSuspense } from "@gusto/embedded-api-v-2026-06-15/react-query/achTransactionsGetAll.js";
...
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15";
import { prefetchAchTransactionsGetAll } from "@gusto/embedded-api-v-2026-06-15/react-query/achTransactionsGetAll.js";
