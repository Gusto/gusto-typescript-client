...
import { departmentsGet } from "@gusto/embedded-api-v-2026-06-15/funcs/departmentsGet.js";
...
async function run() {
  const res = await departmentsGet(gustoEmbedded, {
    departmentUuid: "<id>",
  });
  if (res.ok) {
    ...
    console.log("departmentsGet failed:", res.error);
  }
}
...
import {
  ...
  invalidateDepartmentsGet,
  invalidateAllDepartmentsGet,
} from "@gusto/embedded-api-v-2026-06-15/react-query/departmentsGet.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15/core.js";
import { departmentsUpdate } from "@gusto/embedded-api-v-2026-06-15/funcs/departmentsUpdate.js";
...
} from "@gusto/embedded-api-v-2026-06-15/react-query/departmentsUpdate.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15/core.js";
import { departmentsDelete } from "@gusto/embedded-api-v-2026-06-15/funcs/departmentsDelete.js";
...
async function run() {
  const res = await departmentsDelete(gustoEmbedded, {
    departmentUuid: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("departmentsDelete failed:", res.error);
  }
}
...
} from "@gusto/embedded-api-v-2026-06-15/react-query/departmentsDelete.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15/core.js";
import { departmentsAddPeople } from "@gusto/embedded-api-v-2026-06-15/funcs/departmentsAddPeople.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("departmentsAddPeople failed:", res.error);
  }
}
...
} from "@gusto/embedded-api-v-2026-06-15/react-query/departmentsAddPeople.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15/core.js";
import { departmentsRemovePeople } from "@gusto/embedded-api-v-2026-06-15/funcs/departmentsRemovePeople.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("departmentsRemovePeople failed:", res.error);
  }
}
...
} from "@gusto/embedded-api-v-2026-06-15/react-query/departmentsRemovePeople.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15/core.js";
import { departmentsGetAll } from "@gusto/embedded-api-v-2026-06-15/funcs/departmentsGetAll.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("departmentsGetAll failed:", res.error);
  }
}
...
} from "@gusto/embedded-api-v-2026-06-15/react-query/departmentsGetAll.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15/core.js";
import { departmentsCreate } from "@gusto/embedded-api-v-2026-06-15/funcs/departmentsCreate.js";
...
} from "@gusto/embedded-api-v-2026-06-15/react-query/departmentsCreate.js";
```
