...
* [~~acceptTermsOfService~~](#accepttermsofservice) - Accept terms of service for an admin :warning: **Deprecated**
* [~~retrieveTermsOfService~~](#retrievetermsofservice) - Retrieve terms of service status for an admin :warning: **Deprecated**
* [getV1PartnerManagedCompaniesCompanyUuidTermsOfService](#getv1partnermanagedcompaniescompanyuuidtermsofservice) - Get the terms of service status for a company
* [putV1PartnerManagedCompaniesCompanyUuidTermsOfService](#putv1partnermanagedcompaniescompanyuuidtermsofservice) - Check terms of service status for a specific user
* [postV1PartnerManagedCompaniesCompanyUuidTermsOfService](#postv1partnermanagedcompaniescompanyuuidtermsofservice) - Accept terms of service for a specific user
...
import { companiesListAdmins } from "@gusto/embedded-api-v-2026-06-15/funcs/companiesListAdmins.js";
...
} from "@gusto/embedded-api-v-2026-06-15/react-query/companiesListAdmins.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15/core.js";
import { companiesCreateAdmin } from "@gusto/embedded-api-v-2026-06-15/funcs/companiesCreateAdmin.js";
...
} from "@gusto/embedded-api-v-2026-06-15/react-query/companiesCreateAdmin.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15/core.js";
import { companiesGet } from "@gusto/embedded-api-v-2026-06-15/funcs/companiesGet.js";
...
} from "@gusto/embedded-api-v-2026-06-15/react-query/companiesGet.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15/core.js";
import { companiesUpdate } from "@gusto/embedded-api-v-2026-06-15/funcs/companiesUpdate.js";
...
} from "@gusto/embedded-api-v-2026-06-15/react-query/companiesUpdate.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15/core.js";
import { companiesGetCustomFields } from "@gusto/embedded-api-v-2026-06-15/funcs/companiesGetCustomFields.js";
...
} from "@gusto/embedded-api-v-2026-06-15/react-query/companiesGetCustomFields.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15/core.js";
import { companiesGetOnboardingStatus } from "@gusto/embedded-api-v-2026-06-15/funcs/companiesGetOnboardingStatus.js";
...
} from "@gusto/embedded-api-v-2026-06-15/react-query/companiesGetOnboardingStatus.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15/core.js";
import { companiesFinishOnboarding } from "@gusto/embedded-api-v-2026-06-15/funcs/companiesFinishOnboarding.js";
...
} from "@gusto/embedded-api-v-2026-06-15/react-query/companiesFinishOnboarding.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15/core.js";
import { companiesPutV1PartnerManagedCompaniesCompanyUuidDisassociate } from "@gusto/embedded-api-v-2026-06-15/funcs/companiesPutV1PartnerManagedCompaniesCompanyUuidDisassociate.js";
...
} from "@gusto/embedded-api-v-2026-06-15/react-query/companiesPutV1PartnerManagedCompaniesCompanyUuidDisassociate.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15/core.js";
import { companiesMigrate } from "@gusto/embedded-api-v-2026-06-15/funcs/companiesMigrate.js";
...
} from "@gusto/embedded-api-v-2026-06-15/react-query/companiesMigrate.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15/core.js";
import { companiesCreatePartnerManaged } from "@gusto/embedded-api-v-2026-06-15/funcs/companiesCreatePartnerManaged.js";
...
} from "@gusto/embedded-api-v-2026-06-15/react-query/companiesCreatePartnerManaged.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15/core.js";
import { companiesGetV1PartnerManagedCompaniesCompanyUuidMigrationReadiness } from "@gusto/embedded-api-v-2026-06-15/funcs/companiesGetV1PartnerManagedCompaniesCompanyUuidMigrationReadiness.js";
...
} from "@gusto/embedded-api-v-2026-06-15/react-query/companiesGetV1PartnerManagedCompaniesCompanyUuidMigrationReadiness.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15/core.js";
import { companiesAcceptTermsOfService } from "@gusto/embedded-api-v-2026-06-15/funcs/companiesAcceptTermsOfService.js";
...
} from "@gusto/embedded-api-v-2026-06-15/react-query/companiesAcceptTermsOfService.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15/core.js";
import { companiesRetrieveTermsOfService } from "@gusto/embedded-api-v-2026-06-15/funcs/companiesRetrieveTermsOfService.js";
...
} from "@gusto/embedded-api-v-2026-06-15/react-query/companiesRetrieveTermsOfService.js";
```
...
<!-- UsageSnippet language="typescript" operationID="get-v1-partner-managed-companies-company-uuid-terms_of_service" method="get" path="/v1/partner_managed_companies/{company_uuid}/terms_of_service" -->
```typescript
import { GustoEmbedded } from "@gusto/embedded-api-v-2026-06-15";
...
async function run() {
  const result = await gustoEmbedded.companies.getV1PartnerManagedCompaniesCompanyUuidTermsOfService({
    companyUuid: "<id>",
  });
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15/core.js";
import { companiesGetV1PartnerManagedCompaniesCompanyUuidTermsOfService } from "@gusto/embedded-api-v-2026-06-15/funcs/companiesGetV1PartnerManagedCompaniesCompanyUuidTermsOfService.js";
...
async function run() {
  const res = await companiesGetV1PartnerManagedCompaniesCompanyUuidTermsOfService(gustoEmbedded, {
    companyUuid: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("companiesGetV1PartnerManagedCompaniesCompanyUuidTermsOfService failed:", res.error);
  }
}
...
import {
  // Query hooks for fetching data.
  useCompaniesGetV1PartnerManagedCompaniesCompanyUuidTermsOfService,
  useCompaniesGetV1PartnerManagedCompaniesCompanyUuidTermsOfServiceSuspense,
  ...
  // Utilities to invalidate the query cache for this query in response to
  // mutations and other user actions.
  invalidateCompaniesGetV1PartnerManagedCompaniesCompanyUuidTermsOfService,
  invalidateAllCompaniesGetV1PartnerManagedCompaniesCompanyUuidTermsOfService,
} from "@gusto/embedded-api-v-2026-06-15/react-query/companiesGetV1PartnerManagedCompaniesCompanyUuidTermsOfService.js";
```
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetV1PartnerManagedCompaniesCompanyUuidTermsOfServiceRequest](../../models/operations/getv1partnermanagedcompaniescompanyuuidtermsofservicerequest.md)             | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.GetV1PartnerManagedCompaniesCompanyUuidTermsOfServiceResponse](../../models/operations/getv1partnermanagedcompaniescompanyuuidtermsofserviceresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="put-v1-partner-managed-companies-company-uuid-terms_of_service" method="put" path="/v1/partner_managed_companies/{company_uuid}/terms_of_service" -->
```typescript
import { GustoEmbedded } from "@gusto/embedded-api-v-2026-06-15";
...
async function run() {
  const result = await gustoEmbedded.companies.putV1PartnerManagedCompaniesCompanyUuidTermsOfService({
    companyUuid: "<id>",
    partnerManagedCompanyRetrieveTermsOfServiceRequest: {
      email: "Marie.Bartoletti8@hotmail.com",
    },
  });
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15/core.js";
import { companiesPutV1PartnerManagedCompaniesCompanyUuidTermsOfService } from "@gusto/embedded-api-v-2026-06-15/funcs/companiesPutV1PartnerManagedCompaniesCompanyUuidTermsOfService.js";
...
async function run() {
  const res = await companiesPutV1PartnerManagedCompaniesCompanyUuidTermsOfService(gustoEmbedded, {
    companyUuid: "<id>",
    partnerManagedCompanyRetrieveTermsOfServiceRequest: {
      email: "Marie.Bartoletti8@hotmail.com",
    },
  ...
  if (res.ok) {
    ...
    console.log("companiesPutV1PartnerManagedCompaniesCompanyUuidTermsOfService failed:", res.error);
  }
}
...
import {
  // Mutation hook for triggering the API call.
  useCompaniesPutV1PartnerManagedCompaniesCompanyUuidTermsOfServiceMutation
} from "@gusto/embedded-api-v-2026-06-15/react-query/companiesPutV1PartnerManagedCompaniesCompanyUuidTermsOfService.js";
```
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.PutV1PartnerManagedCompaniesCompanyUuidTermsOfServiceRequest](../../models/operations/putv1partnermanagedcompaniescompanyuuidtermsofservicerequest.md)             | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.PutV1PartnerManagedCompaniesCompanyUuidTermsOfServiceResponse](../../models/operations/putv1partnermanagedcompaniescompanyuuidtermsofserviceresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="post-v1-partner-managed-companies-company-uuid-terms_of_service" method="post" path="/v1/partner_managed_companies/{company_uuid}/terms_of_service" -->
```typescript
import { GustoEmbedded } from "@gusto/embedded-api-v-2026-06-15";
...
async function run() {
  const result = await gustoEmbedded.companies.postV1PartnerManagedCompaniesCompanyUuidTermsOfService({
    companyUuid: "<id>",
    partnerManagedCompanyAcceptTermsOfServiceRequest: {
      email: "Colin.Mitchell@hotmail.com",
      ipAddress: "7.218.200.162",
      externalUserId: "<id>",
    },
  });
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2026-06-15/core.js";
import { companiesPostV1PartnerManagedCompaniesCompanyUuidTermsOfService } from "@gusto/embedded-api-v-2026-06-15/funcs/companiesPostV1PartnerManagedCompaniesCompanyUuidTermsOfService.js";
...
async function run() {
  const res = await companiesPostV1PartnerManagedCompaniesCompanyUuidTermsOfService(gustoEmbedded, {
    companyUuid: "<id>",
    partnerManagedCompanyAcceptTermsOfServiceRequest: {
      email: "Colin.Mitchell@hotmail.com",
      ipAddress: "7.218.200.162",
  ...
  if (res.ok) {
    ...
    console.log("companiesPostV1PartnerManagedCompaniesCompanyUuidTermsOfService failed:", res.error);
  }
}
...
import {
  // Mutation hook for triggering the API call.
  useCompaniesPostV1PartnerManagedCompaniesCompanyUuidTermsOfServiceMutation
} from "@gusto/embedded-api-v-2026-06-15/react-query/companiesPostV1PartnerManagedCompaniesCompanyUuidTermsOfService.js";
```
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.PostV1PartnerManagedCompaniesCompanyUuidTermsOfServiceRequest](../../models/operations/postv1partnermanagedcompaniescompanyuuidtermsofservicerequest.md)           | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.PostV1PartnerManagedCompaniesCompanyUuidTermsOfServiceResponse](../../models/operations/postv1partnermanagedcompaniescompanyuuidtermsofserviceresponse.md)\>**
