...
```typescript
import { PartnerManagedCompanyMigrateRequest } from "@gusto/embedded-api-v-2026-06-15/models/components/partnermanagedcompanymigraterequest.js";

let value: PartnerManagedCompanyMigrateRequest = {};
```
