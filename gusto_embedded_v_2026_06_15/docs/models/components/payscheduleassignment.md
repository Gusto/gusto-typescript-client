...
```typescript
import { PayScheduleAssignment } from "@gusto/embedded-api-v-2026-06-15/models/components/payscheduleassignment.js";
...
| ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| `type`                                                                                                     | [components.PayScheduleAssignmentType](../../models/components/payscheduleassignmenttype.md)               | :heavy_minus_sign:                                                                                         | The pay schedule assignment type.                                                                          |
