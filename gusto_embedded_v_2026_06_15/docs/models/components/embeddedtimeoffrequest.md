...
```typescript
import { EmbeddedTimeOffRequest } from "@gusto/embedded-api-v-2026-06-15/models/components/embeddedtimeoffrequest.js";
...
| `employerNote`                                                                                                              | *string*                                                                                                                    | :heavy_check_mark:                                                                                                          | A note about the time off request, from the employer to the employee.                                                       | null                                                                                                                        |
