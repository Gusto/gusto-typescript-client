...
```typescript
import { EmployeeStateTaxInputQuestionFormatOptions } from "@gusto/embedded-api-v-2026-06-15/models/components/employeestatetaxinputquestionformat.js";

let value: EmployeeStateTaxInputQuestionFormatOptions = {
  label: "<value>",
};
```
