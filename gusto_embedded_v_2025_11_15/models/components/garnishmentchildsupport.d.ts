 ...
 */
export declare namespace PaymentPeriod$ {
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace GarnishmentChildSupport$ {
    /** @deprecated use `GarnishmentChildSupport$inboundSchema` instead. */
    const inboundSchema: z.ZodType<GarnishmentChildSupport, z.ZodTypeDef, unknown>;
    /** @deprecated use `GarnishmentChildSupport$outboundSchema` instead. */
    const outboundSchema: z.ZodType<GarnishmentChildSupport$Outbound, z.ZodTypeDef, GarnishmentChildSupport>;
    /** @deprecated use `GarnishmentChildSupport$Outbound` instead. */
    type Outbound = GarnishmentChildSupport$Outbound;
}
