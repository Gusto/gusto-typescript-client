...
/** @internal */
export declare const PaymentSpeedRequiredBody$inboundSchema: z.ZodType<PaymentSpeedRequiredBody, z.ZodTypeDef, unknown>;
/** @internal */
 ...
 */
export declare namespace PaymentSpeedRequiredBody$ {
    /** @deprecated use `PaymentSpeedRequiredBody$inboundSchema` instead. */
    const inboundSchema: z.ZodType<PaymentSpeedRequiredBody, z.ZodTypeDef, unknown>;
    /** @deprecated use `PaymentSpeedRequiredBody$outboundSchema` instead. */
    const outboundSchema: z.ZodType<PaymentSpeedRequiredBody$Outbound, z.ZodTypeDef, PaymentSpeedRequiredBody>;
    /** @deprecated use `PaymentSpeedRequiredBody$Outbound` instead. */
    type Outbound = PaymentSpeedRequiredBody$Outbound;
}
export declare function paymentSpeedRequiredBodyToJSON(paymentSpeedRequiredBody: PaymentSpeedRequiredBody): string;
export declare function paymentSpeedRequiredBodyFromJSON(jsonString: string): SafeParseResult<PaymentSpeedRequiredBody, SDKValidationError>;
