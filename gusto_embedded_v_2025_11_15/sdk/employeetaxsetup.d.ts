...
export declare class EmployeeTaxSetup extends ClientSDK {
     ...
     */
    getFederalTaxes(request: operations.GetV1EmployeesEmployeeIdFederalTaxesRequest, options?: RequestOptions): Promise<operations.GetV1EmployeesEmployeeIdFederalTaxesResponse>;
    /**
     ...
     */
    updateFederalTaxes(request: operations.PutV1EmployeesEmployeeIdFederalTaxesRequest, options?: RequestOptions): Promise<operations.PutV1EmployeesEmployeeIdFederalTaxesResponse>;
    /**
     ...
     */
    getStateTaxes(request: operations.GetV1EmployeesEmployeeIdStateTaxesRequest, options?: RequestOptions): Promise<operations.GetV1EmployeesEmployeeIdStateTaxesResponse>;
    /**
     ...
     */
    updateStateTaxes(request: operations.PutV1EmployeesEmployeeIdStateTaxesRequest, options?: RequestOptions): Promise<operations.PutV1EmployeesEmployeeIdStateTaxesResponse>;
}
