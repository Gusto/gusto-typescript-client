...
export declare class I9Verification extends ClientSDK {
     ...
     */
    getAuthorization(request: operations.GetV1EmployeesEmployeeIdI9AuthorizationRequest, options?: RequestOptions): Promise<operations.GetV1EmployeesEmployeeIdI9AuthorizationResponse>;
    /**
     ...
     */
    update(request: operations.PutV1EmployeesEmployeeIdI9AuthorizationRequest, options?: RequestOptions): Promise<operations.PutV1EmployeesEmployeeIdI9AuthorizationResponse>;
    /**
     ...
     * scope: `i9_authorizations:read`
     */
    getDocumentOptions(request: operations.GetV1EmployeesEmployeeIdI9AuthorizationDocumentOptionsRequest, options?: RequestOptions): Promise<operations.GetV1EmployeesEmployeeIdI9AuthorizationDocumentOptionsResponse>;
    /**
     ...
     * scope: `i9_authorizations:read`
     */
    getDocuments(request: operations.GetV1EmployeesEmployeeIdI9AuthorizationDocumentsRequest, options?: RequestOptions): Promise<operations.GetV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse>;
    /**
     ...
     */
    createDocuments(request: operations.PutV1EmployeesEmployeeIdI9AuthorizationDocumentsRequest, options?: RequestOptions): Promise<operations.PutV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse>;
    /**
     ...
     * scope: `i9_authorizations:manage`
     */
    deleteDocument(request: operations.DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdRequest, options?: RequestOptions): Promise<operations.DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdResponse>;
    /**
     ...
     * scope: `i9_authorizations:manage`
     */
    employerSign(request: operations.PutV1EmployeesEmployeeIdI9AuthorizationEmployerSignRequest, options?: RequestOptions): Promise<operations.PutV1EmployeesEmployeeIdI9AuthorizationEmployerSignResponse>;
}
