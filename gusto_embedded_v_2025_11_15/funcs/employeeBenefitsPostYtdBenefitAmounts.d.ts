 ...
 */
export declare function employeeBenefitsPostYtdBenefitAmounts(client: GustoEmbeddedCore, request: operations.PostEmployeeYtdBenefitAmountsFromDifferentCompanyRequest, options?: RequestOptions): Promise<Result<void, errors.UnprocessableEntityErrorObject | APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
