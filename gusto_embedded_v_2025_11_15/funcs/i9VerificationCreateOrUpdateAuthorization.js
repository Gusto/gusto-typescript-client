...
exports.i9VerificationCreateOrUpdateAuthorization = i9VerificationCreateOrUpdateAuthorization;
 ...
 */
async function i9VerificationCreateOrUpdateAuthorization(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.PutV1EmployeesEmployeeIdI9AuthorizationRequest$outboundSchema
    ...
    const path = (0, url_js_1.pathToFunc)("/v1/employees/{employee_id}/i9_authorization")(pathParams);
    ...
    const [result] = await M.match(M.json(200, components.I9Authorization$inboundSchema), M.jsonErr(422, errors.UnprocessableEntityErrorObject$inboundSchema), M.fail([404, "4XX"]), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
        return result;
    }
    return result;
