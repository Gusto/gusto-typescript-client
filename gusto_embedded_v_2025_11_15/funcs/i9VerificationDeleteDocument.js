...
exports.i9VerificationDeleteDocument = i9VerificationDeleteDocument;
 ...
 */
function i9VerificationDeleteDocument(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const path = (0, url_js_1.pathToFunc)("/v1/employees/{employee_id}/i9_authorization/documents/{document_id}")(pathParams);
    ...
    const [result] = await M.match(M.nil(204, operations
        .DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdResponse$inboundSchema), M.fail([404, "4XX"]), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
