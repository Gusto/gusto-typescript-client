 ...
 */
export declare function signatoriesCreate(client: GustoEmbeddedCore, request: operations.PostV1CompanySignatoriesRequest, options?: RequestOptions): APIPromise<Result<operations.PostV1CompanySignatoriesResponse, errors.UnprocessableEntityErrorObject | APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
