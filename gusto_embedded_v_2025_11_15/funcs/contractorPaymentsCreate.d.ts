 ...
 * scope: `payrolls:run`
 */
export declare function contractorPaymentsCreate(client: GustoEmbeddedCore, request: operations.PostV1CompaniesCompanyIdContractorPaymentsRequest, options?: RequestOptions): APIPromise<Result<operations.PostV1CompaniesCompanyIdContractorPaymentsResponse, errors.UnprocessableEntityErrorObject | APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
