 ...
 * scope: `payrolls:read`
 */
export declare function paySchedulesGetTerminationPayPeriods(client: GustoEmbeddedCore, request: operations.GetV1CompaniesCompanyIdUnprocessedTerminationPayPeriodsRequest, options?: RequestOptions): Promise<Result<Array<components.UnprocessedTerminationPayPeriod>, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
