 ...
 */
export declare function bankAccountsGetCompanyAccounts(client: GustoEmbeddedCore, request: operations.GetV1CompaniesCompanyIdBankAccountsRequest, options?: RequestOptions): Promise<Result<Array<components.CompanyBankAccount>, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
