 ...
 * scope: `invoices:read`
 */
export declare function invoicesGet(client: GustoEmbeddedCore, security: operations.GetInvoicesInvoicePeriodSecurity, request: operations.GetInvoicesInvoicePeriodRequest, options?: RequestOptions): APIPromise<Result<operations.GetInvoicesInvoicePeriodResponse, errors.UnprocessableEntityErrorObject | APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
