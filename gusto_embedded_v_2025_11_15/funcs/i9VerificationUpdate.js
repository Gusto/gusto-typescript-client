...
exports.i9VerificationUpdate = i9VerificationUpdate;
 ...
 */
function i9VerificationUpdate(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, operations.PutV1EmployeesEmployeeIdI9AuthorizationResponse$inboundSchema, { key: "I9-Authorization" }), M.jsonErr(422, errors.UnprocessableEntityErrorObject$inboundSchema), M.fail([404, "4XX"]), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
