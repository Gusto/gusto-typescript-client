 ...
 */
export declare function contractorsAddBankAccount(client: GustoEmbeddedCore, request: operations.PostV1ContractorsContractorUuidBankAccountsRequest, options?: RequestOptions): Promise<Result<components.ContractorBankAccount, errors.UnprocessableEntityErrorObject | APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
