...
exports.payrollsPrepareForUpdate = payrollsPrepareForUpdate;
 ...
 */
async function payrollsPrepareForUpdate(client, request, options) {
    ...
    const path = (0, url_js_1.pathToFunc)("/v1/companies/{company_id}/payrolls/{payroll_id}/prepare")(pathParams);
    ...
    const [result] = await M.match(M.json(200, components.PayrollPrepared$inboundSchema), M.fail([404, "4XX"]), M.fail("5XX"))(response);
    if (!result.ok) {
        return result;
    }
    return result;
