 ...
 */
export declare function holidayPayPoliciesDelete(client: GustoEmbeddedCore, request: operations.DeleteCompaniesCompanyUuidHolidayPayPolicyRequest, options?: RequestOptions): APIPromise<Result<operations.DeleteCompaniesCompanyUuidHolidayPayPolicyResponse, errors.UnprocessableEntityErrorObject | APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
