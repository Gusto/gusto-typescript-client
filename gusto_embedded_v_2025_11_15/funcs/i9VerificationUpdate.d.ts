 ...
 */
export declare function i9VerificationUpdate(client: GustoEmbeddedCore, request: operations.PutV1EmployeesEmployeeIdI9AuthorizationRequest, options?: RequestOptions): APIPromise<Result<operations.PutV1EmployeesEmployeeIdI9AuthorizationResponse, errors.UnprocessableEntityErrorObject | APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
