...
exports.i9VerificationCreateDocuments = i9VerificationCreateDocuments;
 ...
 */
function i9VerificationCreateDocuments(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const path = (0, url_js_1.pathToFunc)("/v1/employees/{employee_id}/i9_authorization/documents")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations
        .PutV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse$inboundSchema, { key: "I9-Authorization-Documents-Object" }), M.jsonErr(422, errors.UnprocessableEntityErrorObject$inboundSchema), M.fail([404, "4XX"]), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
