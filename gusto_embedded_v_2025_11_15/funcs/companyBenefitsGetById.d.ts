 ...
 * scope: `benefits:read`
 */
export declare function companyBenefitsGetById(client: GustoEmbeddedCore, request: operations.GetV1BenefitsBenefitIdRequest, options?: RequestOptions): Promise<Result<components.SupportedBenefit, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
