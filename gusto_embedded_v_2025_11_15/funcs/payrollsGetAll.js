...
exports.payrollsGetAll = payrollsGetAll;
 ...
 * scope: `payrolls:read`
 */
async function payrollsGetAll(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, z.array(components.PayrollMinimal$inboundSchema)), M.fail([404, "4XX"]), M.fail("5XX"))(response);
    if (!result.ok) {
        return result;
    }
    return result;
