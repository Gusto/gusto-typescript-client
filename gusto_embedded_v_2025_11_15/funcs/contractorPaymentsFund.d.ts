 ...
 * scope: `payrolls:run`
 */
export declare function contractorPaymentsFund(client: GustoEmbeddedCore, request: operations.GetV1ContractorPaymentsContractorPaymentUuidFundRequest, options?: RequestOptions): APIPromise<Result<operations.GetV1ContractorPaymentsContractorPaymentUuidFundResponse, errors.UnprocessableEntityErrorObject | APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
