 ...
 * scope: `payrolls:read`
 */
export declare function payrollsList(client: GustoEmbeddedCore, request: operations.GetV1CompaniesCompanyIdPayrollsRequest, options?: RequestOptions): APIPromise<Result<operations.GetV1CompaniesCompanyIdPayrollsResponse, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
