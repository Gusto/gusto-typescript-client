...
exports.payrollsPrepare = payrollsPrepare;
 ...
 */
function payrollsPrepare(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, operations
        .PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareResponse$inboundSchema, { key: "Payroll-Prepared" }), M.fail([404, "4XX"]), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
