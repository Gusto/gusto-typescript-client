 ...
 */
export declare function employeeFormsSign(client: GustoEmbeddedCore, request: operations.PutV1EmployeeFormSignRequest, options?: RequestOptions): APIPromise<Result<operations.PutV1EmployeeFormSignResponse, errors.UnprocessableEntityErrorObject | APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
