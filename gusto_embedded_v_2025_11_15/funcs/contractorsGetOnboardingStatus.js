...
exports.contractorsGetOnboardingStatus = contractorsGetOnboardingStatus;
 ...
 */
function contractorsGetOnboardingStatus(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, operations
        .GetV1ContractorsContractorUuidOnboardingStatusResponse$inboundSchema, { key: "Contractor-Onboarding-Status" }), M.fail([404, "4XX"]), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
