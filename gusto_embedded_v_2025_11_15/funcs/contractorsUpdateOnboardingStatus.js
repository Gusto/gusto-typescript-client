...
exports.contractorsUpdateOnboardingStatus = contractorsUpdateOnboardingStatus;
 ...
 */
function contractorsUpdateOnboardingStatus(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const path = (0, url_js_1.pathToFunc)("/v1/contractors/{contractor_uuid}/onboarding_status")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations
        .PutV1ContractorsContractorUuidOnboardingStatusResponse$inboundSchema, { key: "Contractor-Onboarding-Status" }), M.jsonErr(422, errors.UnprocessableEntityErrorObject$inboundSchema), M.fail([404, "4XX"]), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
