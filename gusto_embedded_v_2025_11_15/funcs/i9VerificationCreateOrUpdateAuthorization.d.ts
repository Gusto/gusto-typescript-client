 ...
 */
export declare function i9VerificationCreateOrUpdateAuthorization(client: GustoEmbeddedCore, request: operations.PutV1EmployeesEmployeeIdI9AuthorizationRequest, options?: RequestOptions): Promise<Result<components.I9Authorization, errors.UnprocessableEntityErrorObject | APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
