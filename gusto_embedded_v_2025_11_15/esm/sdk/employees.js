...
export class Employees extends ClientSDK {
    ...
    async list(request, options) {
        return unwrapAsync(employeesList(this, request, options));
    }
    /**
     * Create an employee
     *
    ...
    async create(request, options) {
        return unwrapAsync(employeesCreate(this, request, options));
    }
    /**
     ...
     */
    async getV1CompaniesCompanyIdEmployeesPaymentDetails(request, options) {
        return unwrapAsync(employeesGetV1CompaniesCompanyIdEmployeesPaymentDetails(this, request, options));
    }
    /**
    ...
    async createHistorical(request, options) {
        return unwrapAsync(employeesCreateHistorical(this, request, options));
    }
    /**
     * Get an employee
     *
    ...
    async get(request, options) {
        return unwrapAsync(employeesGet(this, request, options));
    }
    /**
     * Update an employee.
     *
    ...
    async update(request, options) {
        return unwrapAsync(employeesUpdate(this, request, options));
    }
    /**
    ...
    async delete(request, options) {
        return unwrapAsync(employeesDelete(this, request, options));
    }
    /**
    ...
    async getCustomFields(request, options) {
        return unwrapAsync(employeesGetCustomFields(this, request, options));
    }
    /**
    ...
    async updateOnboardingDocumentsConfig(request, options) {
        return unwrapAsync(employeesUpdateOnboardingDocumentsConfig(this, request, options));
    }
    /**
    ...
    async getOnboardingStatus(request, options) {
        return unwrapAsync(employeesGetOnboardingStatus(this, request, options));
    }
    /**
    ...
    async updateOnboardingStatus(request, options) {
        return unwrapAsync(employeesUpdateOnboardingStatus(this, request, options));
    }
    /**
