...
export class EmployeeEmployments extends ClientSDK {
    ...
    async createTermination(request, options) {
        return unwrapAsync(employeeEmploymentsCreateTermination(this, request, options));
    }
    /**
    ...
    async getTerminations(request, options) {
        return unwrapAsync(employeeEmploymentsGetTerminations(this, request, options));
    }
    /**
    ...
    async deleteTermination(request, options) {
        return unwrapAsync(employeeEmploymentsDeleteTermination(this, request, options));
    }
    /**
    ...
    async updateTermination(request, options) {
        return unwrapAsync(employeeEmploymentsUpdateTermination(this, request, options));
    }
    /**
    ...
    async createRehire(request, options) {
        return unwrapAsync(employeeEmploymentsCreateRehire(this, request, options));
    }
    /**
    ...
    async rehire(request, options) {
        return unwrapAsync(employeeEmploymentsRehire(this, request, options));
    }
    /**
    ...
    async getRehire(request, options) {
        return unwrapAsync(employeeEmploymentsGetRehire(this, request, options));
    }
    /**
    ...
    async deleteRehire(request, options) {
        return unwrapAsync(employeeEmploymentsDeleteRehire(this, request, options));
    }
    /**
    ...
    async getHistory(request, options) {
        return unwrapAsync(employeeEmploymentsGetHistory(this, request, options));
    }
}
