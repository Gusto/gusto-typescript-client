...
export class EmployeeTaxSetup extends ClientSDK {
    ...
    async getFederalTaxes(request, options) {
        return unwrapAsync(employeeTaxSetupGetFederalTaxes(this, request, options));
    }
    /**
    ...
    async updateFederalTaxes(request, options) {
        return unwrapAsync(employeeTaxSetupUpdateFederalTaxes(this, request, options));
    }
    /**
    ...
    async getStateTaxes(request, options) {
        return unwrapAsync(employeeTaxSetupGetStateTaxes(this, request, options));
    }
    /**
