...
export class Payrolls extends ClientSDK {
    ...
    async list(request, options) {
        return unwrapAsync(payrollsList(this, request, options));
    }
    /**
    ...
    async createOffCycle(request, options) {
        return unwrapAsync(payrollsCreateOffCycle(this, request, options));
    }
    /**
    ...
    async getApprovedReversals(request, options) {
        return unwrapAsync(payrollsGetApprovedReversals(this, request, options));
    }
    /**
    ...
    async get(request, options) {
        return unwrapAsync(payrollsGet(this, request, options));
    }
    /**
    ...
    async update(request, options) {
        return unwrapAsync(payrollsUpdate(this, request, options));
    }
    /**
     * Delete a payroll
     *
    ...
    async delete(request, options) {
        return unwrapAsync(payrollsDelete(this, request, options));
    }
    /**
    ...
    async prepare(request, options) {
        return unwrapAsync(payrollsPrepare(this, request, options));
    }
    /**
    ...
    async getReceipt(request, options) {
        return unwrapAsync(payrollsGetReceipt(this, request, options));
    }
    /**
    ...
    async getBlockers(request, options) {
        return unwrapAsync(payrollsGetBlockers(this, request, options));
    }
    /**
     * Skip a payroll
     *
    ...
    async skip(request, options) {
        return unwrapAsync(payrollsSkip(this, request, options));
    }
    /**
    ...
    async calculateGrossUp(request, options) {
        return unwrapAsync(payrollsCalculateGrossUp(this, request, options));
    }
    /**
     * Calculate a payroll
     *
    ...
    async calculate(request, options) {
        return unwrapAsync(payrollsCalculate(this, request, options));
    }
    /**
     * Submit payroll
     *
    ...
    async submit(request, options) {
        return unwrapAsync(payrollsSubmit(this, request, options));
    }
    /**
     * Cancel a payroll
     *
    ...
    async cancel(request, options) {
        return unwrapAsync(payrollsCancel(this, request, options));
    }
    /**
    ...
    async getPayStub(request, options) {
        return unwrapAsync(payrollsGetPayStub(this, request, options));
    }
    /**
    ...
    async getPayStubs(request, options) {
        return unwrapAsync(payrollsGetPayStubs(this, request, options));
    }
    /**
    ...
    async generatePrintableChecks(request, options) {
        return unwrapAsync(payrollsGeneratePrintableChecks(this, request, options));
    }
    /**
     ...
     */
    async getV1CompaniesCompanyIdPayrollsIdPartnerDisbursements(request, options) {
        return unwrapAsync(payrollsGetV1CompaniesCompanyIdPayrollsIdPartnerDisbursements(this, request, options));
    }
    /**
     ...
     */
    async patchV1CompaniesCompanyIdPayrollsIdPartnerDisbursements(request, options) {
        return unwrapAsync(payrollsPatchV1CompaniesCompanyIdPayrollsIdPartnerDisbursements(this, request, options));
    }
}
