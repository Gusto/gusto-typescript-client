...
export class Notifications extends ClientSDK {
    ...
    async getDetails(request, options) {
        return unwrapAsync(notificationsGetDetails(this, request, options));
    }
    /**
     ...
     * scope: `notifications:read`
     */
    async getCompanyNotifications(request, options) {
        return unwrapAsync(notificationsGetCompanyNotifications(this, request, options));
    }
}
