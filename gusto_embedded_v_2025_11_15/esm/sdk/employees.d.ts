...
export declare class Employees extends ClientSDK {
     ...
     */
    list(request: GetV1CompaniesCompanyIdEmployeesRequest, options?: RequestOptions): Promise<GetV1CompaniesCompanyIdEmployeesResponse>;
    /**
     * Create an employee
     *
     * @remarks
     ...
     */
    create(request: PostV1EmployeesRequest, options?: RequestOptions): Promise<PostV1EmployeesResponse>;
    /**
     ...
     */
    getV1CompaniesCompanyIdEmployeesPaymentDetails(request: GetV1CompaniesCompanyIdEmployeesPaymentDetailsRequest, options?: RequestOptions): Promise<GetV1CompaniesCompanyIdEmployeesPaymentDetailsResponse>;
    /**
     ...
     * scope: `employees:manage`
     */
    createHistorical(request: PostV1HistoricalEmployeesRequest, options?: RequestOptions): Promise<PostV1HistoricalEmployeesResponse>;
    /**
     * Get an employee
     *
     * @remarks
     ...
     * scope: `employees:read`
     */
    get(request: GetV1EmployeesRequest, options?: RequestOptions): Promise<GetV1EmployeesResponse>;
    /**
     * Update an employee.
     *
     * @remarks
     ...
     */
    update(request: PutV1EmployeesRequest, options?: RequestOptions): Promise<PutV1EmployeesResponse>;
    /**
     ...
     * scope: `employees:manage`
     */
    delete(request: DeleteV1EmployeeRequest, options?: RequestOptions): Promise<DeleteV1EmployeeResponse>;
    /**
     ...
     * scope: `employees:read`
     */
    getCustomFields(request: GetV1EmployeesEmployeeIdCustomFieldsRequest, options?: RequestOptions): Promise<GetV1EmployeesEmployeeIdCustomFieldsResponse>;
    /**
     ...
     * scope: `employees:manage`
     */
    updateOnboardingDocumentsConfig(request: PutV1EmployeesEmployeeIdOnboardingDocumentsConfigRequest, options?: RequestOptions): Promise<PutV1EmployeesEmployeeIdOnboardingDocumentsConfigResponse>;
    /**
     ...
     * scope: `employees:read`
     */
    getOnboardingStatus(request: GetV1EmployeesEmployeeIdOnboardingStatusRequest, options?: RequestOptions): Promise<GetV1EmployeesEmployeeIdOnboardingStatusResponse>;
    /**
     ...
     * scope: `employees:manage`
     */
    updateOnboardingStatus(request: PutV1EmployeesEmployeeIdOnboardingStatusRequest, options?: RequestOptions): Promise<PutV1EmployeesEmployeeIdOnboardingStatusResponse>;
    /**
     ...
     */
    getTimeOffActivities(request: GetVersionEmployeesTimeOffActivitiesRequest, options?: RequestOptions): Promise<GetVersionEmployeesTimeOffActivitiesResponse>;
}
