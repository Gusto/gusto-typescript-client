...
export class SalaryEstimates extends ClientSDK {
     ...
     */
    async postV1EmployeesEmployeeIdSalaryEstimates(request, options) {
        return unwrapAsync(salaryEstimatesPostV1EmployeesEmployeeIdSalaryEstimates(this, request, options));
    }
    /**
     ...
     */
    async getV1SalaryEstimatesId(request, options) {
        return unwrapAsync(salaryEstimatesGetV1SalaryEstimatesId(this, request, options));
    }
    /**
     ...
     * scope: `salary_estimates:write`
     */
    async putV1SalaryEstimatesId(request, options) {
        return unwrapAsync(salaryEstimatesPutV1SalaryEstimatesId(this, request, options));
    }
    /**
     ...
     * scope: `salary_estimates:write`
     */
    async postV1SalaryEstimatesUuidAccept(request, options) {
        return unwrapAsync(salaryEstimatesPostV1SalaryEstimatesUuidAccept(this, request, options));
    }
    /**
     ...
     * scope: `salary_estimates:read`
     */
    async getV1SalaryEstimatesOccupations(security, request, options) {
        return unwrapAsync(salaryEstimatesGetV1SalaryEstimatesOccupations(this, security, request, options));
    }
}
//# sourceMappingURL=salaryestimates.js.map