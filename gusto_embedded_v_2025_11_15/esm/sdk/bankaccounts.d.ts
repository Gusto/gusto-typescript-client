...
export declare class BankAccounts extends ClientSDK {
    /**
     ...
     */
    get(request: GetV1CompaniesCompanyIdBankAccountsRequest, options?: RequestOptions): Promise<GetV1CompaniesCompanyIdBankAccountsResponse>;
    /**
     ...
     */
    create(request: PostV1CompaniesCompanyIdBankAccountsRequest, options?: RequestOptions): Promise<PostV1CompaniesCompanyIdBankAccountsResponse>;
    /**
     ...
     * scope: `company_bank_accounts:write`
     */
    verify(request: PutV1CompaniesCompanyIdBankAccountsVerifyRequest, options?: RequestOptions): Promise<PutV1CompaniesCompanyIdBankAccountsVerifyResponse>;
    /**
     ...
     */
    createFromPlaidToken(request: PostV1PlaidProcessorTokenRequest, options?: RequestOptions): Promise<PostV1PlaidProcessorTokenResponse>;
    /**
     ...
     * scope: `company_bank_accounts:write`
     */
    deleteV1CompaniesCompanyIdBankAccountsBankAccountId(request: DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdRequest, options?: RequestOptions): Promise<DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdResponse>;
}
