...
export class Reports extends ClientSDK {
    ...
    async createCustom(request, options) {
        return unwrapAsync(reportsCreateCustom(this, request, options));
    }
    /**
     ...
     */
    async postPayrollsPayrollUuidReportsGeneralLedger(request, options) {
        return unwrapAsync(reportsPostPayrollsPayrollUuidReportsGeneralLedger(this, request, options));
    }
    /**
     * Get a report
     *
     ...
     */
    async getReportsRequestUuid(request, options) {
        return unwrapAsync(reportsGetReportsRequestUuid(this, request, options));
    }
    /**
    ...
    async getTemplate(request, options) {
        return unwrapAsync(reportsGetTemplate(this, request, options));
    }
    /**
     ...
     * scope: `company_reports:write`
     */
    async postV1CompaniesCompanyIdReportsEmployeesAnnualFicaWage(request, options) {
        return unwrapAsync(reportsPostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWage(this, request, options));
    }
}
