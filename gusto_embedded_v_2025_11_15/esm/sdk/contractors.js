...
export class Contractors extends ClientSDK {
    ...
    async create(request, options) {
        return unwrapAsync(contractorsCreate(this, request, options));
    }
    /**
    ...
    async list(request, options) {
        return unwrapAsync(contractorsList(this, request, options));
    }
    /**
     * Get a contractor
     *
    ...
    async get(request, options) {
        return unwrapAsync(contractorsGet(this, request, options));
    }
    /**
     * Update a contractor
     *
    ...
    async update(request, options) {
        return unwrapAsync(contractorsUpdate(this, request, options));
    }
    /**
     * Delete a contractor
     *
    ...
    async delete(request, options) {
        return unwrapAsync(contractorsDelete(this, request, options));
    }
    /**
    ...
    async getOnboardingStatus(request, options) {
        return unwrapAsync(contractorsGetOnboardingStatus(this, request, options));
    }
    /**
    ...
    async updateOnboardingStatus(request, options) {
        return unwrapAsync(contractorsUpdateOnboardingStatus(this, request, options));
    }
    /**
    ...
    async getAddress(request, options) {
        return unwrapAsync(contractorsGetAddress(this, request, options));
    }
    /**
    ...
    async updateAddress(request, options) {
        return unwrapAsync(contractorsUpdateAddress(this, request, options));
    }
    /**
     ...
     */
    async getV1CompaniesCompanyIdContractorsPaymentDetails(request, options) {
        return unwrapAsync(contractorsGetV1CompaniesCompanyIdContractorsPaymentDetails(this, request, options));
    }
}
