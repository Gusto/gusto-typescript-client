...
export class EarningTypes extends ClientSDK {
    ...
    async create(request, options) {
        return unwrapAsync(earningTypesCreate(this, request, options));
    }
    /**
    ...
    async list(request, options) {
        return unwrapAsync(earningTypesList(this, request, options));
    }
    /**
    ...
    async update(request, options) {
        return unwrapAsync(earningTypesUpdate(this, request, options));
    }
    /**
