...
export class Reimbursements extends ClientSDK {
     ...
     */
    async getV1EmployeesEmployeeIdRecurringReimbursements(request, options) {
        return unwrapAsync(reimbursementsGetV1EmployeesEmployeeIdRecurringReimbursements(this, request, options));
    }
    /**
     ...
     */
    async postV1EmployeesEmployeeIdRecurringReimbursements(request, options) {
        return unwrapAsync(reimbursementsPostV1EmployeesEmployeeIdRecurringReimbursements(this, request, options));
    }
    /**
     ...
     * scope: `reimbursements:read`
     */
    async getV1RecurringReimbursements(request, options) {
        return unwrapAsync(reimbursementsGetV1RecurringReimbursements(this, request, options));
    }
    /**
     ...
     * scope: `reimbursements:write`
     */
    async putV1RecurringReimbursements(request, options) {
        return unwrapAsync(reimbursementsPutV1RecurringReimbursements(this, request, options));
    }
    /**
     ...
     * scope: `reimbursements:write`
     */
    async deleteV1RecurringReimbursements(request, options) {
        return unwrapAsync(reimbursementsDeleteV1RecurringReimbursements(this, request, options));
    }
}
