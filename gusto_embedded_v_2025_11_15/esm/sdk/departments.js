...
export class Departments extends ClientSDK {
    ...
    async create(request, options) {
        return unwrapAsync(departmentsCreate(this, request, options));
    }
    /**
    ...
    async getAll(request, options) {
        return unwrapAsync(departmentsGetAll(this, request, options));
    }
    /**
     * Get a department
     *
    ...
    async get(request, options) {
        return unwrapAsync(departmentsGet(this, request, options));
    }
    /**
     * Update a department
     *
    ...
    async update(request, options) {
        return unwrapAsync(departmentsUpdate(this, request, options));
    }
    /**
     * Delete a department
     *
    ...
    async delete(request, options) {
        return unwrapAsync(departmentsDelete(this, request, options));
    }
    /**
    ...
    async addPeople(request, options) {
        return unwrapAsync(departmentsAddPeople(this, request, options));
    }
    /**
