...
export class BankAccounts extends ClientSDK {
    ...
    async get(request, options) {
        return unwrapAsync(bankAccountsGet(this, request, options));
    }
    /**
    ...
    async verify(request, options) {
        return unwrapAsync(bankAccountsVerify(this, request, options));
    }
    /**
    ...
    async createFromPlaidToken(request, options) {
        return unwrapAsync(bankAccountsCreateFromPlaidToken(this, request, options));
    }
    /**
     ...
     * scope: `company_bank_accounts:write`
     */
    async deleteV1CompaniesCompanyIdBankAccountsBankAccountId(request, options) {
        return unwrapAsync(bankAccountsDeleteV1CompaniesCompanyIdBankAccountsBankAccountId(this, request, options));
    }
}
