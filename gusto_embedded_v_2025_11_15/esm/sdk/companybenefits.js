...
export class CompanyBenefits extends ClientSDK {
    ...
    async create(request, options) {
        return unwrapAsync(companyBenefitsCreate(this, request, options));
    }
    /**
    ...
    async list(request, options) {
        return unwrapAsync(companyBenefitsList(this, request, options));
    }
    /**
    ...
    async get(request, options) {
        return unwrapAsync(companyBenefitsGet(this, request, options));
    }
    /**
    ...
    async update(request, options) {
        return unwrapAsync(companyBenefitsUpdate(this, request, options));
    }
    /**
    ...
    async delete(request, options) {
        return unwrapAsync(companyBenefitsDelete(this, request, options));
    }
    /**
    ...
    async getAll(request, options) {
        return unwrapAsync(companyBenefitsGetAll(this, request, options));
    }
    /**
    ...
    async getSupported(request, options) {
        return unwrapAsync(companyBenefitsGetSupported(this, request, options));
    }
    /**
    ...
    async getSummary(request, options) {
        return unwrapAsync(companyBenefitsGetSummary(this, request, options));
    }
    /**
    ...
    async getEmployeeBenefits(request, options) {
        return unwrapAsync(companyBenefitsGetEmployeeBenefits(this, request, options));
    }
    /**
    ...
    async updateEmployeeBenefits(request, options) {
        return unwrapAsync(companyBenefitsUpdateEmployeeBenefits(this, request, options));
    }
    /**
    ...
    async getRequirements(request, options) {
        return unwrapAsync(companyBenefitsGetRequirements(this, request, options));
    }
    /**
     ...
     * scope: `company_benefits:read`
     */
    async getV1CompanyBenefitsCompanyBenefitIdContributionExclusions(request, options) {
        return unwrapAsync(companyBenefitsGetV1CompanyBenefitsCompanyBenefitIdContributionExclusions(this, request, options));
    }
    /**
     ...
     * scope: `company_benefits:write`
     */
    async putV1CompanyBenefitsCompanyBenefitIdContributionExclusions(request, options) {
        return unwrapAsync(companyBenefitsPutV1CompanyBenefitsCompanyBenefitIdContributionExclusions(this, request, options));
    }
}
