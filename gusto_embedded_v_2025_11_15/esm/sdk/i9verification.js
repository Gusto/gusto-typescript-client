...
export class I9Verification extends ClientSDK {
    ...
    async getAuthorization(request, options) {
        return unwrapAsync(i9VerificationGetAuthorization(this, request, options));
    }
    /**
    ...
    async update(request, options) {
        return unwrapAsync(i9VerificationUpdate(this, request, options));
    }
    /**
    ...
    async getDocumentOptions(request, options) {
        return unwrapAsync(i9VerificationGetDocumentOptions(this, request, options));
    }
    /**
    ...
    async getDocuments(request, options) {
        return unwrapAsync(i9VerificationGetDocuments(this, request, options));
    }
    /**
    ...
    async createDocuments(request, options) {
        return unwrapAsync(i9VerificationCreateDocuments(this, request, options));
    }
    /**
    ...
    async deleteDocument(request, options) {
        return unwrapAsync(i9VerificationDeleteDocument(this, request, options));
    }
    /**
    ...
    async employerSign(request, options) {
        return unwrapAsync(i9VerificationEmployerSign(this, request, options));
    }
}
