...
export class Companies extends ClientSDK {
    get suspensions() {
        return (this._suspensions ?? (this._suspensions = new Suspensions(this._options)));
    }
    /**
    ...
    async createPartnerManaged(security, request, options) {
        return unwrapAsync(companiesCreatePartnerManaged(this, security, request, options));
    }
    /**
     * Get a company
     *
    ...
    async get(request, options) {
        return unwrapAsync(companiesGet(this, request, options));
    }
    /**
     * Update a company
     *
    ...
    async update(request, options) {
        return unwrapAsync(companiesUpdate(this, request, options));
    }
    /**
    ...
    async migrate(request, options) {
        return unwrapAsync(companiesMigrate(this, request, options));
    }
    /**
     ...
     */
    async getV1PartnerManagedCompaniesCompanyUuidMigrationReadiness(request, options) {
        return unwrapAsync(companiesGetV1PartnerManagedCompaniesCompanyUuidMigrationReadiness(this, request, options));
    }
    /**
    ...
    async acceptTermsOfService(request, options) {
        return unwrapAsync(companiesAcceptTermsOfService(this, request, options));
    }
    /**
    ...
    async retrieveTermsOfService(request, options) {
        return unwrapAsync(companiesRetrieveTermsOfService(this, request, options));
    }
    /**
    ...
    async createAdmin(request, options) {
        return unwrapAsync(companiesCreateAdmin(this, request, options));
    }
    /**
    ...
    async listAdmins(request, options) {
        return unwrapAsync(companiesListAdmins(this, request, options));
    }
    /**
    ...
    async getOnboardingStatus(request, options) {
        return unwrapAsync(companiesGetOnboardingStatus(this, request, options));
    }
    /**
    ...
    async finishOnboarding(request, options) {
        return unwrapAsync(companiesFinishOnboarding(this, request, options));
    }
    /**
