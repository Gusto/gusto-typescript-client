...
export class TimeOffPolicies extends ClientSDK {
    ...
    async calculateAccruingTimeOffHours(request, options) {
        return unwrapAsync(timeOffPoliciesCalculateAccruingTimeOffHours(this, request, options));
    }
    /**
    ...
    async get(request, options) {
        return unwrapAsync(timeOffPoliciesGet(this, request, options));
    }
    /**
    ...
    async update(request, options) {
        return unwrapAsync(timeOffPoliciesUpdate(this, request, options));
    }
    /**
    ...
    async getAll(request, options) {
        return unwrapAsync(timeOffPoliciesGetAll(this, request, options));
    }
    /**
    ...
    async create(request, options) {
        return unwrapAsync(timeOffPoliciesCreate(this, request, options));
    }
    /**
    ...
    async addEmployees(request, options) {
        return unwrapAsync(timeOffPoliciesAddEmployees(this, request, options));
    }
    /**
    ...
    async removeEmployees(request, options) {
        return unwrapAsync(timeOffPoliciesRemoveEmployees(this, request, options));
    }
    /**
    ...
    async updateBalance(request, options) {
        return unwrapAsync(timeOffPoliciesUpdateBalance(this, request, options));
    }
    /**
    ...
    async deactivate(request, options) {
        return unwrapAsync(timeOffPoliciesDeactivate(this, request, options));
    }
}
