...
export declare class Signatories extends ClientSDK {
     ...
     */
    create(request: PostV1CompanySignatoriesRequest, options?: RequestOptions): Promise<PostV1CompanySignatoriesResponse>;
    /**
     ...
     */
    list(request: GetV1CompaniesCompanyUuidSignatoriesRequest, options?: RequestOptions): Promise<GetV1CompaniesCompanyUuidSignatoriesResponse>;
    /**
     * Invite a signatory
     *
     * @remarks
     ...
     * scope: `signatories:manage`
     */
    invite(request: PostV1CompaniesCompanyUuidSignatoriesInviteRequest, options?: RequestOptions): Promise<PostV1CompaniesCompanyUuidSignatoriesInviteResponse>;
    /**
     * Update a signatory
     *
     * @remarks
     ...
     */
    update(request: PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidRequest, options?: RequestOptions): Promise<PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse>;
    /**
     * Delete a signatory
     *
     * @remarks
     ...
     * scope: `signatories:manage`
     */
    delete(request: DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidRequest, options?: RequestOptions): Promise<DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse>;
}
