...
import { DeleteV1CompaniesCompanyIdPayrollsRequest, DeleteV1CompaniesCompanyIdPayrollsResponse } from "../models/operations/deletev1companiescompanyidpayrolls.js";
...
export declare class Payrolls extends ClientSDK {
     ...
     * scope: `payrolls:read`
     */
    list(request: GetV1CompaniesCompanyIdPayrollsRequest, options?: RequestOptions): Promise<GetV1CompaniesCompanyIdPayrollsResponse>;
    /**
     ...
     * scope: `payrolls:run`
     */
    createOffCycle(request: PostV1CompaniesCompanyIdPayrollsRequest, options?: RequestOptions): Promise<PostV1CompaniesCompanyIdPayrollsResponse>;
    /**
     ...
     * scope: `payrolls:read`
     */
    getApprovedReversals(request: GetV1CompaniesCompanyIdPayrollReversalsRequest, options?: RequestOptions): Promise<GetV1CompaniesCompanyIdPayrollReversalsResponse>;
    /**
     ...
     * scope: `payrolls:read`
     */
    get(request: GetV1CompaniesCompanyIdPayrollsPayrollIdRequest, options?: RequestOptions): Promise<GetV1CompaniesCompanyIdPayrollsPayrollIdResponse>;
    /**
     ...
     */
    update(request: PutV1CompaniesCompanyIdPayrollsRequest, options?: RequestOptions): Promise<PutV1CompaniesCompanyIdPayrollsResponse>;
    /**
     * Delete a payroll
     *
     * @remarks
     ...
     * scope: `payrolls:run`
     */
    delete(request: DeleteV1CompaniesCompanyIdPayrollsRequest, options?: RequestOptions): Promise<DeleteV1CompaniesCompanyIdPayrollsResponse>;
    /**
     ...
     * scope: `payrolls:write`
     */
    prepare(request: PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareRequest, options?: RequestOptions): Promise<PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareResponse>;
    /**
     ...
     * scope: `payrolls:read`
     */
    getReceipt(request: GetV1PaymentReceiptsPayrollsPayrollUuidRequest, options?: RequestOptions): Promise<GetV1PaymentReceiptsPayrollsPayrollUuidResponse>;
    /**
     ...
     * scope: `payrolls:run`
     */
    getBlockers(request: GetV1CompaniesPayrollBlockersCompanyUuidRequest, options?: RequestOptions): Promise<GetV1CompaniesPayrollBlockersCompanyUuidResponse>;
    /**
     * Skip a payroll
     *
     * @remarks
     ...
     * scope: `payrolls:run`
     */
    skip(request: PostCompaniesPayrollSkipCompanyUuidRequest, options?: RequestOptions): Promise<PostCompaniesPayrollSkipCompanyUuidResponse>;
    /**
     ...
     * scope: `payrolls:run`
     */
    calculateGrossUp(request: PostPayrollsGrossUpPayrollUuidRequest, options?: RequestOptions): Promise<PostPayrollsGrossUpPayrollUuidResponse>;
    /**
     * Calculate a payroll
     *
     * @remarks
     ...
     * If the company is blocked from running payroll due to issues like incomplete setup, missing information or other compliance issues, the response will be 422 Unprocessable Entity with a categorization of the blockers as described in the error responses.
     */
    calculate(request: PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateRequest, options?: RequestOptions): Promise<PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateResponse>;
    /**
     * Submit payroll
     *
     * @remarks
     ...
     * scope: `payrolls:run`
     */
    submit(request: PutV1CompaniesCompanyIdPayrollsPayrollIdSubmitRequest, options?: RequestOptions): Promise<PutV1CompaniesCompanyIdPayrollsPayrollIdSubmitResponse>;
    /**
     * Cancel a payroll
     *
     * @remarks
     ...
     * scope: `payrolls:run`
     */
    cancel(request: PutApiV1CompaniesCompanyIdPayrollsPayrollIdCancelRequest, options?: RequestOptions): Promise<PutApiV1CompaniesCompanyIdPayrollsPayrollIdCancelResponse>;
    /**
     ...
     */
    getPayStub(request: GetV1PayrollsPayrollUuidEmployeesEmployeeUuidPayStubRequest, options?: RequestOptions): Promise<GetV1PayrollsPayrollUuidEmployeesEmployeeUuidPayStubResponse>;
    /**
     ...
     * scope: `pay_stubs:read`
     */
    getPayStubs(request: GetV1EmployeesEmployeeUuidPayStubsRequest, options?: RequestOptions): Promise<GetV1EmployeesEmployeeUuidPayStubsResponse>;
    /**
     ...
     */
    generatePrintableChecks(request: PostV1PayrollsPayrollUuidGeneratedDocumentsPrintablePayrollChecksRequest, options?: RequestOptions): Promise<PostV1PayrollsPayrollUuidGeneratedDocumentsPrintablePayrollChecksResponse>;
    /**
     ...
     */
    getV1CompaniesCompanyIdPayrollsIdPartnerDisbursements(request: GetV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsRequest, options?: RequestOptions): Promise<GetV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsResponse>;
    /**
     ...
     */
    patchV1CompaniesCompanyIdPayrollsIdPartnerDisbursements(request: PatchV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsRequest, options?: RequestOptions): Promise<PatchV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsResponse>;
}
