...
export type I9VerificationUpdateMutationData = PutV1EmployeesEmployeeIdI9AuthorizationResponse;
export type I9VerificationUpdateMutationError = NotFoundErrorObject | UnprocessableEntityErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 ...
 */
export declare function useI9VerificationUpdateMutation(options?: MutationHookOptions<I9VerificationUpdateMutationData, I9VerificationUpdateMutationError, I9VerificationUpdateMutationVariables>): UseMutationResult<I9VerificationUpdateMutationData, I9VerificationUpdateMutationError, I9VerificationUpdateMutationVariables>;
export declare function mutationKeyI9VerificationUpdate(): MutationKey;
export declare function buildI9VerificationUpdateMutation(client$: GustoEmbeddedCore, hookOptions?: RequestOptions): {
    mutationKey: MutationKey;
    mutationFn: (variables: I9VerificationUpdateMutationVariables) => Promise<I9VerificationUpdateMutationData>;
};
