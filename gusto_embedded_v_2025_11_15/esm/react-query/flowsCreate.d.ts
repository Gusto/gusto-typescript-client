...
export type FlowsCreateMutationError = NotFoundErrorObject | UnprocessableEntityErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 * Create a flow
 *
 * @remarks
 ...
 * scope: `flows:write`
 */
export declare function useFlowsCreateMutation(options?: MutationHookOptions<FlowsCreateMutationData, FlowsCreateMutationError, FlowsCreateMutationVariables>): UseMutationResult<FlowsCreateMutationData, FlowsCreateMutationError, FlowsCreateMutationVariables>;
