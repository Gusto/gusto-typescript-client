...
export type BankAccountsVerifyMutationData = PutV1CompaniesCompanyIdBankAccountsVerifyResponse;
export type BankAccountsVerifyMutationError = NotFoundErrorObject | UnprocessableEntityErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 ...
 */
export declare function useBankAccountsVerifyMutation(options?: MutationHookOptions<BankAccountsVerifyMutationData, BankAccountsVerifyMutationError, BankAccountsVerifyMutationVariables>): UseMutationResult<BankAccountsVerifyMutationData, BankAccountsVerifyMutationError, BankAccountsVerifyMutationVariables>;
