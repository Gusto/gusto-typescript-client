...
export type EmployeeTaxSetupUpdateStateTaxesMutationData = PutV1EmployeesEmployeeIdStateTaxesResponse;
export type EmployeeTaxSetupUpdateStateTaxesMutationError = NotFoundErrorObject | UnprocessableEntityErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 ...
 */
export declare function useEmployeeTaxSetupUpdateStateTaxesMutation(options?: MutationHookOptions<EmployeeTaxSetupUpdateStateTaxesMutationData, EmployeeTaxSetupUpdateStateTaxesMutationError, EmployeeTaxSetupUpdateStateTaxesMutationVariables>): UseMutationResult<EmployeeTaxSetupUpdateStateTaxesMutationData, EmployeeTaxSetupUpdateStateTaxesMutationError, EmployeeTaxSetupUpdateStateTaxesMutationVariables>;
