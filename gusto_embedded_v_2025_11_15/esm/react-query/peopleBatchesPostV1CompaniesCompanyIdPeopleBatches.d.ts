...
export type PeopleBatchesPostV1CompaniesCompanyIdPeopleBatchesMutationData = PostV1CompaniesCompanyIdPeopleBatchesResponse;
export type PeopleBatchesPostV1CompaniesCompanyIdPeopleBatchesMutationError = NotFoundErrorObject | PeopleBatchConflictError | UnprocessableEntityErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 ...
 */
export declare function usePeopleBatchesPostV1CompaniesCompanyIdPeopleBatchesMutation(options?: MutationHookOptions<PeopleBatchesPostV1CompaniesCompanyIdPeopleBatchesMutationData, PeopleBatchesPostV1CompaniesCompanyIdPeopleBatchesMutationError, PeopleBatchesPostV1CompaniesCompanyIdPeopleBatchesMutationVariables>): UseMutationResult<PeopleBatchesPostV1CompaniesCompanyIdPeopleBatchesMutationData, PeopleBatchesPostV1CompaniesCompanyIdPeopleBatchesMutationError, PeopleBatchesPostV1CompaniesCompanyIdPeopleBatchesMutationVariables>;
export declare function mutationKeyPeopleBatchesPostV1CompaniesCompanyIdPeopleBatches(): MutationKey;
export declare function buildPeopleBatchesPostV1CompaniesCompanyIdPeopleBatchesMutation(client$: GustoEmbeddedCore, hookOptions?: RequestOptions): {
    mutationKey: MutationKey;
    mutationFn: (variables: PeopleBatchesPostV1CompaniesCompanyIdPeopleBatchesMutationVariables) => Promise<PeopleBatchesPostV1CompaniesCompanyIdPeopleBatchesMutationData>;
};
