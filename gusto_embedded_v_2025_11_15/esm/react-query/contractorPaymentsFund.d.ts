...
export type ContractorPaymentsFundMutationData = GetV1ContractorPaymentsContractorPaymentUuidFundResponse;
export type ContractorPaymentsFundMutationError = UnprocessableEntityErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 ...
 * scope: `payrolls:run`
 */
export declare function useContractorPaymentsFundMutation(options?: MutationHookOptions<ContractorPaymentsFundMutationData, ContractorPaymentsFundMutationError, ContractorPaymentsFundMutationVariables>): UseMutationResult<ContractorPaymentsFundMutationData, ContractorPaymentsFundMutationError, ContractorPaymentsFundMutationVariables>;
