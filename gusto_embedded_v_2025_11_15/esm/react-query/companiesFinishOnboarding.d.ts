...
export type CompaniesFinishOnboardingMutationData = GetV1CompanyFinishOnboardingResponse;
export type CompaniesFinishOnboardingMutationError = NotFoundErrorObject | UnprocessableEntityErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 ...
 */
export declare function useCompaniesFinishOnboardingMutation(options?: MutationHookOptions<CompaniesFinishOnboardingMutationData, CompaniesFinishOnboardingMutationError, CompaniesFinishOnboardingMutationVariables>): UseMutationResult<CompaniesFinishOnboardingMutationData, CompaniesFinishOnboardingMutationError, CompaniesFinishOnboardingMutationVariables>;
