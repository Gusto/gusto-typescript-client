...
import { GetV1EmployeesEmployeeIdStateTaxesHeaderXGustoAPIVersion, GetV1EmployeesEmployeeIdStateTaxesRequest } from "../models/operations/getv1employeesemployeeidstatetaxes.js";
import { QueryHookOptions, SuspenseQueryHookOptions, TupleToPrefixes } from "./_types.js";
import { buildEmployeeTaxSetupGetStateTaxesQuery, EmployeeTaxSetupGetStateTaxesQueryData, prefetchEmployeeTaxSetupGetStateTaxes, queryKeyEmployeeTaxSetupGetStateTaxes } from "./employeeTaxSetupGetStateTaxes.core.js";
export { buildEmployeeTaxSetupGetStateTaxesQuery, type EmployeeTaxSetupGetStateTaxesQueryData, prefetchEmployeeTaxSetupGetStateTaxes, queryKeyEmployeeTaxSetupGetStateTaxes, };
export type EmployeeTaxSetupGetStateTaxesQueryError = NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 ...
 */
export declare function useEmployeeTaxSetupGetStateTaxes(request: GetV1EmployeesEmployeeIdStateTaxesRequest, options?: QueryHookOptions<EmployeeTaxSetupGetStateTaxesQueryData, EmployeeTaxSetupGetStateTaxesQueryError>): UseQueryResult<EmployeeTaxSetupGetStateTaxesQueryData, EmployeeTaxSetupGetStateTaxesQueryError>;
/**
 * Get an employee's state taxes
 *
 * @remarks
 ...
 * scope: `employee_state_taxes:read`
 */
export declare function useEmployeeTaxSetupGetStateTaxesSuspense(request: GetV1EmployeesEmployeeIdStateTaxesRequest, options?: SuspenseQueryHookOptions<EmployeeTaxSetupGetStateTaxesQueryData, EmployeeTaxSetupGetStateTaxesQueryError>): UseSuspenseQueryResult<EmployeeTaxSetupGetStateTaxesQueryData, EmployeeTaxSetupGetStateTaxesQueryError>;
