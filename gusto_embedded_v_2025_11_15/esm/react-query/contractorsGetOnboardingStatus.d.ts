...
import { buildContractorsGetOnboardingStatusQuery, ContractorsGetOnboardingStatusQueryData, prefetchContractorsGetOnboardingStatus, queryKeyContractorsGetOnboardingStatus } from "./contractorsGetOnboardingStatus.core.js";
export { buildContractorsGetOnboardingStatusQuery, type ContractorsGetOnboardingStatusQueryData, prefetchContractorsGetOnboardingStatus, queryKeyContractorsGetOnboardingStatus, };
export type ContractorsGetOnboardingStatusQueryError = GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
