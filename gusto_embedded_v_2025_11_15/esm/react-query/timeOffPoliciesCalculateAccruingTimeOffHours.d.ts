...
export type TimeOffPoliciesCalculateAccruingTimeOffHoursMutationData = PostV1PayrollsPayrollIdCalculateAccruingTimeOffHoursResponse;
export type TimeOffPoliciesCalculateAccruingTimeOffHoursMutationError = NotFoundErrorObject | UnprocessableEntityErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 ...
 * scope: `payrolls:read`
 */
export declare function useTimeOffPoliciesCalculateAccruingTimeOffHoursMutation(options?: MutationHookOptions<TimeOffPoliciesCalculateAccruingTimeOffHoursMutationData, TimeOffPoliciesCalculateAccruingTimeOffHoursMutationError, TimeOffPoliciesCalculateAccruingTimeOffHoursMutationVariables>): UseMutationResult<TimeOffPoliciesCalculateAccruingTimeOffHoursMutationData, TimeOffPoliciesCalculateAccruingTimeOffHoursMutationError, TimeOffPoliciesCalculateAccruingTimeOffHoursMutationVariables>;
