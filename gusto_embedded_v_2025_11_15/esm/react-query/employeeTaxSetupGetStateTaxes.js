...
import { buildEmployeeTaxSetupGetStateTaxesQuery, prefetchEmployeeTaxSetupGetStateTaxes, queryKeyEmployeeTaxSetupGetStateTaxes, } from "./employeeTaxSetupGetStateTaxes.core.js";
export { buildEmployeeTaxSetupGetStateTaxesQuery, prefetchEmployeeTaxSetupGetStateTaxes, queryKeyEmployeeTaxSetupGetStateTaxes, };
/**
 ...
 */
export function useEmployeeTaxSetupGetStateTaxes(request, options) {
 ...
 * scope: `employee_state_taxes:read`
 */
export function useEmployeeTaxSetupGetStateTaxesSuspense(request, options) {
    const client = useGustoEmbeddedContext();
...
export function setEmployeeTaxSetupGetStateTaxesData(client, queryKeyBase, data) {
    const key = queryKeyEmployeeTaxSetupGetStateTaxes(...queryKeyBase);
    return client.setQueryData(key, data);
}
export function invalidateEmployeeTaxSetupGetStateTaxes(client, queryKeyBase, filters) {
...
export function invalidateAllEmployeeTaxSetupGetStateTaxes(client, filters) {
    return client.invalidateQueries({
        ...filters,
