...
export type PayrollsUpdateMutationData = PutV1CompaniesCompanyIdPayrollsResponse;
export type PayrollsUpdateMutationError = NotFoundErrorObject | UnprocessableEntityErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 ...
 */
export declare function usePayrollsUpdateMutation(options?: MutationHookOptions<PayrollsUpdateMutationData, PayrollsUpdateMutationError, PayrollsUpdateMutationVariables>): UseMutationResult<PayrollsUpdateMutationData, PayrollsUpdateMutationError, PayrollsUpdateMutationVariables>;
