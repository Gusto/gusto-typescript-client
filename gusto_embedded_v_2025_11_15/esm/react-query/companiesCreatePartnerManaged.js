 ...
 */
export function useCompaniesCreatePartnerManagedMutation(options) {
...
export function mutationKeyCompaniesCreatePartnerManaged() {
    return ["@gusto/embedded-api", "Companies", "createPartnerManaged"];
}
export function buildCompaniesCreatePartnerManagedMutation(client$, hookOptions) {
    return {
        ...
        mutationFn: function companiesCreatePartnerManagedMutationFn({ security, request, options, }) {
            ...
            return unwrapAsync(companiesCreatePartnerManaged(client$, security, request, mergedOptions));
        },
    };
}
