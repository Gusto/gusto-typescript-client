...
/** @internal */
export const PayScheduleList$inboundSchema = z.object({
    uuid: z.string(),
...
export function payScheduleListFromJSON(jsonString) {
    return safeParse(jsonString, (x) => PayScheduleList$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'PayScheduleList' from JSON`);
}
