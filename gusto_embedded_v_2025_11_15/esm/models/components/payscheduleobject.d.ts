...
/** @internal */
export declare const PayScheduleObject$inboundSchema: z.ZodType<PayScheduleObject, z.ZodTypeDef, unknown>;
export declare function payScheduleObjectFromJSON(jsonString: string): SafeParseResult<PayScheduleObject, SDKValidationError>;
//# sourceMappingURL=payscheduleobject.d.ts.map