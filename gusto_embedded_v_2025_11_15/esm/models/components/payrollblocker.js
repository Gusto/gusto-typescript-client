...
/** @internal */
export const PayrollBlocker$inboundSchema = z.object({
    key: Key$inboundSchema,
    message: z.string(),
});
export function payrollBlockerFromJSON(jsonString) {
    return safeParse(jsonString, (x) => PayrollBlocker$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'PayrollBlocker' from JSON`);
}
