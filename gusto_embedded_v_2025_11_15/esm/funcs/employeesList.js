...
import { GetV1CompaniesCompanyIdEmployeesRequest$outboundSchema, GetV1CompaniesCompanyIdEmployeesResponse$inboundSchema, } from "../models/operations/getv1companiescompanyidemployees.js";
 ...
 */
export function employeesList(client, request, options) {
    return new APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = safeParse(request, (value) => GetV1CompaniesCompanyIdEmployeesRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result] = await M.match(M.json(200, GetV1CompaniesCompanyIdEmployeesResponse$inboundSchema, {
        key: "Show-Employees",
