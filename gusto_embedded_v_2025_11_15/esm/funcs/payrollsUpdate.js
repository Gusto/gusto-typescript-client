...
import { PutV1CompaniesCompanyIdPayrollsRequest$outboundSchema, PutV1CompaniesCompanyIdPayrollsResponse$inboundSchema, } from "../models/operations/putv1companiescompanyidpayrolls.js";
 ...
 */
export function payrollsUpdate(client, request, options) {
    return new APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = safeParse(request, (value) => PutV1CompaniesCompanyIdPayrollsRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const path = pathToFunc("/v1/companies/{company_id}/payrolls/{payroll_id}")(pathParams);
    ...
    const [result] = await M.match(M.json(200, PutV1CompaniesCompanyIdPayrollsResponse$inboundSchema, {
