...
import { GetV1CompaniesCompanyIdPayrollsRequest$outboundSchema, GetV1CompaniesCompanyIdPayrollsResponse$inboundSchema, } from "../models/operations/getv1companiescompanyidpayrolls.js";
 ...
 * scope: `payrolls:read`
 */
export function payrollsList(client, request, options) {
    return new APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = safeParse(request, (value) => GetV1CompaniesCompanyIdPayrollsRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result] = await M.match(M.json(200, GetV1CompaniesCompanyIdPayrollsResponse$inboundSchema, {
        key: "Payroll-List",
