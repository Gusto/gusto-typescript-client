 ...
 */
export declare function contractorsGet(client: GustoEmbeddedCore, request: GetV1ContractorsContractorUuidRequest, options?: RequestOptions): APIPromise<Result<GetV1ContractorsContractorUuidResponse, NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
