 ...
 * scope: `payrolls:run`
 */
export declare function payrollsDelete(client: GustoEmbeddedCore, request: DeleteV1CompaniesCompanyIdPayrollsRequest, options?: RequestOptions): APIPromise<Result<DeleteV1CompaniesCompanyIdPayrollsResponse, NotFoundErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
