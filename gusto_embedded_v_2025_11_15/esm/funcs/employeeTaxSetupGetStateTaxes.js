...
import { GetV1EmployeesEmployeeIdStateTaxesRequest$outboundSchema, GetV1EmployeesEmployeeIdStateTaxesResponse$inboundSchema, } from "../models/operations/getv1employeesemployeeidstatetaxes.js";
 ...
 */
export function employeeTaxSetupGetStateTaxes(client, request, options) {
    return new APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = safeParse(request, (value) => GetV1EmployeesEmployeeIdStateTaxesRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result] = await M.match(M.json(200, GetV1EmployeesEmployeeIdStateTaxesResponse$inboundSchema, {
