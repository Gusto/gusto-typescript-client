...
import { GetV1ContractorsContractorUuidOnboardingStatusRequest$outboundSchema, GetV1ContractorsContractorUuidOnboardingStatusResponse$inboundSchema, } from "../models/operations/getv1contractorscontractoruuidonboardingstatus.js";
 ...
 */
export function contractorsGetOnboardingStatus(client, request, options) {
    return new APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = safeParse(request, (value) => GetV1ContractorsContractorUuidOnboardingStatusRequest$outboundSchema
    ...
    const [result] = await M.match(M.json(200, GetV1ContractorsContractorUuidOnboardingStatusResponse$inboundSchema, { key: "Contractor-Onboarding-Status" }), M.fail([404, "4XX"]), M.fail("5XX"))(response, req, { extraFields: responseFields });
    if (!result.ok) {
