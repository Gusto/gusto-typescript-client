 ...
 */
export declare function holidayPayPoliciesAddEmployees(client: GustoEmbeddedCore, request: PutV1CompaniesCompanyUuidHolidayPayPolicyAddRequest, options?: RequestOptions): APIPromise<Result<PutV1CompaniesCompanyUuidHolidayPayPolicyAddResponse, NotFoundErrorObject | UnprocessableEntityErrorObject | GustoEmbeddedError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
