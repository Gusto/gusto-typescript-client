...
import { PutV1EmployeesEmployeeIdI9AuthorizationRequest$outboundSchema, PutV1EmployeesEmployeeIdI9AuthorizationResponse$inboundSchema, } from "../models/operations/putv1employeesemployeeidi9authorization.js";
 ...
 */
export function i9VerificationUpdate(client, request, options) {
    return new APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = safeParse(request, (value) => PutV1EmployeesEmployeeIdI9AuthorizationRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return [parsed, { status: "invalid" }];
    }
    const payload = parsed.value;
    const body = encodeJSON("body", payload["I9-Authorization-Request-Body"], {
        explode: true,
    });
    const pathParams = {
    ...
    const path = pathToFunc("/v1/employees/{employee_id}/i9_authorization")(pathParams);
    ...
    const [result] = await M.match(M.json(200, PutV1EmployeesEmployeeIdI9AuthorizationResponse$inboundSchema, {
