...
class ClientCredentialsHook {
    ...
    async getCredentials(source) {
        ...
        return {
            clientID: out?.SystemAccessAuth?.clientId ?? (0, env_js_1.env)().GUSTOEMBEDDED_CLIENT_ID ?? "",
            clientSecret: out?.SystemAccessAuth?.clientSecret ??
                (0, env_js_1.env)().GUSTOEMBEDDED_CLIENT_SECRET ??
                "",
        };
    }
