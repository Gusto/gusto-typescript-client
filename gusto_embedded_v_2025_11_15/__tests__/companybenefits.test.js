...
(0, vitest_1.test)("Companybenefits Post V1 Companies Company Id Company Benefits Example", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("post-v1-companies-company_id-company_benefits-Example"),
...
(0, vitest_1.test)("Companybenefits Post V1 Companies Company Id Company Benefits Basic", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("post-v1-companies-company_id-company_benefits-Basic"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
    const result = await gustoEmbedded.companyBenefits.create({
        companyId: "<id>",
...
(0, vitest_1.test)("Companybenefits Post V1 Companies Company Id Company Benefits Resource", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("post-v1-companies-company_id-company_benefits-Resource"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
    const result = await gustoEmbedded.companyBenefits.create({
        companyId: "<id>",
...
(0, vitest_1.test)("Companybenefits Post V1 Companies Company Id Company Benefits Nested", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("post-v1-companies-company_id-company_benefits-Nested"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
    const result = await gustoEmbedded.companyBenefits.create({
        companyId: "<id>",
...
(0, vitest_1.test)("Companybenefits Get V1 Company Benefits Company Benefit Id Example", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("get-v1-company_benefits-company_benefit_id-Example"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
...
(0, vitest_1.test)("Companybenefits Put V1 Company Benefits Company Benefit Id Example", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("put-v1-company_benefits-company_benefit_id-Example"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
...
(0, vitest_1.test)("Companybenefits Put V1 Company Benefits Company Benefit Id Basic", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("put-v1-company_benefits-company_benefit_id-Basic"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
    const result = await gustoEmbedded.companyBenefits.update({
        companyBenefitId: "<id>",
...
(0, vitest_1.test)("Companybenefits Put V1 Company Benefits Company Benefit Id Resource", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("put-v1-company_benefits-company_benefit_id-Resource"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
    const result = await gustoEmbedded.companyBenefits.update({
        companyBenefitId: "<id>",
...
(0, vitest_1.test)("Companybenefits Put V1 Company Benefits Company Benefit Id Nested", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("put-v1-company_benefits-company_benefit_id-Nested"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
    const result = await gustoEmbedded.companyBenefits.update({
        companyBenefitId: "<id>",
...
(0, vitest_1.test)("Companybenefits Delete V1 Company Benefits Company Benefit Id Example", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("delete-v1-company_benefits-company_benefit_id-Example"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
...
(0, vitest_1.test)("Companybenefits Get V1 Benefits Supported Benefits", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("get-v1-benefits-Supported Benefits"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
...
(0, vitest_1.test)("Companybenefits Get V1 Benefits Benefit Id Example", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("get-v1-benefits-benefit_id-Example"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
...
(0, vitest_1.test)("Companybenefits Get V1 Benefits Company Benefit Id Summary Example", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("get-v1-benefits-company_benefit_id-summary-Example"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
...
(0, vitest_1.test)("Companybenefits Get V1 Company Benefits Company Benefit Id Employee Benefits Example", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("get-v1-company_benefits-company_benefit_id-employee_benefits-Example"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
...
(0, vitest_1.test)("Companybenefits Put V1 Company Benefits Company Benefit Id Employee Benefits Example", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("put-v1-company_benefits-company_benefit_id-employee_benefits-Example"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
...
(0, vitest_1.test)("Companybenefits Put V1 Company Benefits Company Benefit Id Employee Benefits Basic", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("put-v1-company_benefits-company_benefit_id-employee_benefits-Basic"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
    const result = await gustoEmbedded.companyBenefits.bulkUpdateEmployeeBenefits({
        companyBenefitId: "<id>",
...
(0, vitest_1.test)("Companybenefits Put V1 Company Benefits Company Benefit Id Employee Benefits Resource", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("put-v1-company_benefits-company_benefit_id-employee_benefits-Resource"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
    const result = await gustoEmbedded.companyBenefits.bulkUpdateEmployeeBenefits({
        companyBenefitId: "<id>",
...
(0, vitest_1.test)("Companybenefits Put V1 Company Benefits Company Benefit Id Employee Benefits Nested", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("put-v1-company_benefits-company_benefit_id-employee_benefits-Nested"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
    const result = await gustoEmbedded.companyBenefits.bulkUpdateEmployeeBenefits({
        companyBenefitId: "<id>",
...
(0, vitest_1.test)("Companybenefits Get V1 Benefits Benefits Id Requirements Example", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("get-v1-benefits-benefits_id-requirements-Example"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
...
//# sourceMappingURL=companybenefits.test.js.map