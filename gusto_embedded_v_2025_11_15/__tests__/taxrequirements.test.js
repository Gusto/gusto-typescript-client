...
(0, vitest_1.test)("Taxrequirements Get V1 Companies Company Uuid Tax Requirements State Example Tax Requirements For Ga", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("get-v1-companies-company_uuid-tax_requirements-state-Example Tax Requirements for GA"),
...
(0, vitest_1.test)("Taxrequirements Put V1 Companies Company Uuid Tax Requirements State Example", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("put-v1-companies-company_uuid-tax_requirements-state-Example"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
...
(0, vitest_1.test)("Taxrequirements Put V1 Companies Company Uuid Tax Requirements State Basic", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("put-v1-companies-company_uuid-tax_requirements-state-Basic"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
    await gustoEmbedded.taxRequirements.update({
        companyUuid: "<id>",
...
(0, vitest_1.test)("Taxrequirements Put V1 Companies Company Uuid Tax Requirements State Resource", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("put-v1-companies-company_uuid-tax_requirements-state-Resource"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
    await gustoEmbedded.taxRequirements.update({
        companyUuid: "<id>",
...
(0, vitest_1.test)("Taxrequirements Put V1 Companies Company Uuid Tax Requirements State Nested", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("put-v1-companies-company_uuid-tax_requirements-state-Nested"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
    await gustoEmbedded.taxRequirements.update({
        companyUuid: "<id>",
...
(0, vitest_1.test)("Taxrequirements Get V1 Companies Company Uuid Tax Requirements Company With Requirements In Ca And Ga", async () => {
    const gustoEmbedded = new index_js_1.GustoEmbedded({
        httpClient: (0, testclient_js_1.createTestHTTPClient)("get-v1-companies-company_uuid-tax_requirements-Company with requirements in CA and GA"),
        companyAccessAuth: process.env["GUSTOEMBEDDED_COMPANY_ACCESS_AUTH"] ?? "",
    });
...
//# sourceMappingURL=taxrequirements.test.js.map