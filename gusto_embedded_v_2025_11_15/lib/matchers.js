...
const apierror_js_1 = require("../models/errors/apierror.js");
...
function match(...matchers) {
    return async function matchFunc(response, options) {
        ...
        if (!matcher) {
            ...
            return [{
                    ok: false,
                    error: new apierror_js_1.APIError("Unexpected API response status or content-type", response, responseBody),
                }, responseBody];
        }
        ...
        if (matcher.enc === "fail") {
            return [{
                    ok: false,
                    error: new apierror_js_1.APIError("API error occurred", response, typeof raw === "string" ? raw : ""),
                }, raw];
        }
