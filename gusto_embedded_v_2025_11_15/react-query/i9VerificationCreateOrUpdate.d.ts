...
export type I9VerificationCreateOrUpdateMutationData = components.I9Authorization;
/**
 ...
 */
export declare function useI9VerificationCreateOrUpdateMutation(options?: MutationHookOptions<I9VerificationCreateOrUpdateMutationData, Error, I9VerificationCreateOrUpdateMutationVariables>): UseMutationResult<I9VerificationCreateOrUpdateMutationData, Error, I9VerificationCreateOrUpdateMutationVariables>;
export declare function mutationKeyI9VerificationCreateOrUpdate(): MutationKey;
export declare function buildI9VerificationCreateOrUpdateMutation(client$: GustoEmbeddedCore, hookOptions?: RequestOptions): {
    mutationKey: MutationKey;
    mutationFn: (variables: I9VerificationCreateOrUpdateMutationVariables) => Promise<I9VerificationCreateOrUpdateMutationData>;
};
//# sourceMappingURL=i9VerificationCreateOrUpdate.d.ts.map