...
export type I9VerificationCreateOrUpdateAuthorizationMutationVariables = {
    request: operations.PutV1EmployeesEmployeeIdI9AuthorizationRequest;
    options?: RequestOptions;
};
export type I9VerificationCreateOrUpdateAuthorizationMutationData = components.I9Authorization;
/**
 ...
 */
export declare function useI9VerificationCreateOrUpdateAuthorizationMutation(options?: MutationHookOptions<I9VerificationCreateOrUpdateAuthorizationMutationData, Error, I9VerificationCreateOrUpdateAuthorizationMutationVariables>): UseMutationResult<I9VerificationCreateOrUpdateAuthorizationMutationData, Error, I9VerificationCreateOrUpdateAuthorizationMutationVariables>;
export declare function mutationKeyI9VerificationCreateOrUpdateAuthorization(): MutationKey;
export declare function buildI9VerificationCreateOrUpdateAuthorizationMutation(client$: GustoEmbeddedCore, hookOptions?: RequestOptions): {
    mutationKey: MutationKey;
    mutationFn: (variables: I9VerificationCreateOrUpdateAuthorizationMutationVariables) => Promise<I9VerificationCreateOrUpdateAuthorizationMutationData>;
};
//# sourceMappingURL=i9VerificationCreateOrUpdateAuthorization.d.ts.map