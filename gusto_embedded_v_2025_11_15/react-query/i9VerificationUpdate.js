...
exports.useI9VerificationUpdateMutation = useI9VerificationUpdateMutation;
exports.mutationKeyI9VerificationUpdate = mutationKeyI9VerificationUpdate;
exports.buildI9VerificationUpdateMutation = buildI9VerificationUpdateMutation;
 ...
 */
function useI9VerificationUpdateMutation(options) {
...
function mutationKeyI9VerificationUpdate() {
    return ["@gusto/embedded-api", "i9Verification", "update"];
}
function buildI9VerificationUpdateMutation(client$, hookOptions) {
    return {
        ...
        mutationFn: function i9VerificationUpdateMutationFn({ request, options, }) {
            ...
            return (0, fp_js_1.unwrapAsync)((0, i9VerificationUpdate_js_1.i9VerificationUpdate)(client$, request, mergedOptions));
        },
    };
}
