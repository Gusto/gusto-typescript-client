...
exports.useI9VerificationCreateOrUpdateAuthorizationMutation = useI9VerificationCreateOrUpdateAuthorizationMutation;
exports.mutationKeyI9VerificationCreateOrUpdateAuthorization = mutationKeyI9VerificationCreateOrUpdateAuthorization;
exports.buildI9VerificationCreateOrUpdateAuthorizationMutation = buildI9VerificationCreateOrUpdateAuthorizationMutation;
const react_query_1 = require("@tanstack/react-query");
const i9VerificationCreateOrUpdateAuthorization_js_1 = require("../funcs/i9VerificationCreateOrUpdateAuthorization.js");
 ...
 */
function useI9VerificationCreateOrUpdateAuthorizationMutation(options) {
    const client = (0, _context_js_1.useGustoEmbeddedContext)();
    return (0, react_query_1.useMutation)({
        ...buildI9VerificationCreateOrUpdateAuthorizationMutation(client, options),
        ...options,
    });
}
function mutationKeyI9VerificationCreateOrUpdateAuthorization() {
    return [
        "@gusto/embedded-api",
        "i9Verification",
...
function buildI9VerificationCreateOrUpdateAuthorizationMutation(client$, hookOptions) {
    return {
        mutationKey: mutationKeyI9VerificationCreateOrUpdateAuthorization(),
        mutationFn: function i9VerificationCreateOrUpdateAuthorizationMutationFn({ request, options, }) {
            const mergedOptions = {
                ...hookOptions,
                ...options,
                fetchOptions: {
            ...
            return (0, fp_js_1.unwrapAsync)((0, i9VerificationCreateOrUpdateAuthorization_js_1.i9VerificationCreateOrUpdateAuthorization)(client$, request, mergedOptions));
        },
    };
}
//# sourceMappingURL=i9VerificationCreateOrUpdateAuthorization.js.map