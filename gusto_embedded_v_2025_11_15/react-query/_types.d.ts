...
import type { InfiniteData, QueryKey, UseInfiniteQueryOptions, UseMutationOptions, UseQueryOptions, UseSuspenseInfiniteQueryOptions, UseSuspenseQueryOptions } from "@tanstack/react-query";
...
export type InfiniteQueryHookOptions<Data extends PageIterator<unknown, unknown>> = Omit<UseInfiniteQueryOptions<Data, Error, InfiniteData<Data, Data["~next"]>, Data, QueryKey, Data["~next"]>, "queryKey" | "queryFn" | "select" | "getNextPageParam" | "getPreviousPageParam" | "initialPageParam" | keyof RequestOptions> & RequestOptions & {
    initialPageParam?: Data["~next"];
};
export type SuspenseInfiniteQueryHookOptions<Data extends PageIterator<unknown, unknown>> = Omit<UseSuspenseInfiniteQueryOptions<Data, Error, InfiniteData<Data, Data["~next"]>, Data, QueryKey, Data["~next"]>, "queryKey" | "queryFn" | "select" | "getNextPageParam" | "getPreviousPageParam" | "initialPageParam" | keyof RequestOptions> & RequestOptions & {
    initialPageParam?: Data["~next"];
};
