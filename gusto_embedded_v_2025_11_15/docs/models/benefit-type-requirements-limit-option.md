...
```typescript
import { BenefitTypeRequirementsLimitOption } from "openapi/models";

let value: BenefitTypeRequirementsLimitOption = {};
```
...
| `defaultValue`                                                            | [models.LimitOptionDefaultValue](../models/limit-option-default-value.md) | :heavy_minus_sign:                                                        | N/A                                                                       |
