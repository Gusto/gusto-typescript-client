...
```typescript
import { PeopleBatch } from "openapi/models";
...
| `status`                                                     | [models.PeopleBatchStatus](../models/people-batch-status.md) | :heavy_check_mark:                                           | The current status of the batch processing.                  |
