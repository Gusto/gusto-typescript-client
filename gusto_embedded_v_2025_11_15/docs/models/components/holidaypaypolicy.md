...
```typescript
import { HolidayPayPolicy } from "@gusto/embedded-api-v-2025-11-15/models/components/holidaypaypolicy.js";
...
| `employees`                                                                                                                                                                   | [components.HolidayPayPolicyEmployees](../../models/components/holidaypaypolicyemployees.md)[]                                                                                | :heavy_check_mark:                                                                                                                                                            | List of employee uuids under a holiday pay policy                                                                                                                             |