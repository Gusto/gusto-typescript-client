...
```typescript
import { TaxRequirementMetadataType } from "@gusto/embedded-api-v-2025-11-15/models/components/taxrequirementmetadata.js";

let value: TaxRequirementMetadataType = "tax_rate";
```
