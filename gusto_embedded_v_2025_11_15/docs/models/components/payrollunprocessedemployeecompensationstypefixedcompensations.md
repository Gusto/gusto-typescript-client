...
```typescript
import { PayrollUnprocessedEmployeeCompensationsTypeFixedCompensations } from "@gusto/embedded-api-v-2025-11-15/models/components/payrollunprocessedemployeecompensationstype.js";

let value: PayrollUnprocessedEmployeeCompensationsTypeFixedCompensations = {};
```
