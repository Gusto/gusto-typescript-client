...
```typescript
import { GarnishmentRequestGarnishmentType } from "@gusto/embedded-api-v-2025-11-15/models/components/garnishmentrequest.js";

let value: GarnishmentRequestGarnishmentType = "student_loan";
```
