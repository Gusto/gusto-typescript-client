...
```typescript
import { PayrollEmployeeCompensationsTypeFixedCompensations } from "@gusto/embedded-api-v-2025-11-15/models/components/payrollemployeecompensationstype.js";

let value: PayrollEmployeeCompensationsTypeFixedCompensations = {};
```
