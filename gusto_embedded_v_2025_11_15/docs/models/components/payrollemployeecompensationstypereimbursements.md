...
```typescript
import { PayrollEmployeeCompensationsTypeReimbursements } from "@gusto/embedded-api-v-2025-11-15/models/components/payrollemployeecompensationstype.js";

let value: PayrollEmployeeCompensationsTypeReimbursements = {
  amount: "214.19",
  description: null,
};
```
