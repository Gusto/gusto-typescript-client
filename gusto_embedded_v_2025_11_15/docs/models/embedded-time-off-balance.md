...
```typescript
import { EmbeddedTimeOffBalance } from "openapi/models";
...
| `balances`                                              | [models.Balance](../models/balance.md)[]                | :heavy_minus_sign:                                      | The employee's time off balances, one entry per policy. |                                                         |