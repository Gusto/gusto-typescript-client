...
```typescript
import { EmployeeMemberPortalInvitationStatus } from "openapi/models";
...
| ----------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| `status`                                                                                                          | [models.EmployeeMemberPortalInvitationStatusStatus](../models/employee-member-portal-invitation-status-status.md) | :heavy_minus_sign:                                                                                                | The current status of the member portal invitation.                                                               |
