...
```typescript
import { PayrollUnprocessedEmployeeCompensationsTypeFixedCompensation } from "openapi/models";

let value: PayrollUnprocessedEmployeeCompensationsTypeFixedCompensation = {};
```
