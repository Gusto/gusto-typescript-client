...
```typescript
import { SignatoryInviteRequest } from "openapi/models";
...
| `birthday`                                                                                     | [Date](../types/rfcdate.md)                                                                    | :heavy_minus_sign:                                                                             | The signatory's date of birth.                                                                 |
...
| `homeAddress`                                                                                  | [models.SignatoryInviteRequestHomeAddress](../models/signatory-invite-request-home-address.md) | :heavy_minus_sign:                                                                             | The signatory's home address.                                                                  |