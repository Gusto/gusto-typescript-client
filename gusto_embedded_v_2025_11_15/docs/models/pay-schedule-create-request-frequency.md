# PayScheduleCreateRequestFrequency
...
```typescript
import { PayScheduleCreateRequestFrequency } from "openapi/models";

let value: PayScheduleCreateRequestFrequency = "Twice per month";
```
