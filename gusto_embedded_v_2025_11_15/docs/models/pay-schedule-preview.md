...
```typescript
import { PaySchedulePreview } from "openapi/models";
...
| ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------ |
| `payPeriods`                                                                                                                   | [models.PaySchedulePreviewPayPeriod](../models/pay-schedule-preview-pay-period.md)[]                                           | :heavy_minus_sign:                                                                                                             | A list of pay periods for the previewed pay schedule (default range is 18 months from today, or up to end_date when provided). |
| `holidays`                                                                                                                     | [Date](../types/rfcdate.md)[]                                                                                                  | :heavy_minus_sign:                                                                                                             | A list of dates for bank closures (ISO date strings); may affect payroll processing.                                           |