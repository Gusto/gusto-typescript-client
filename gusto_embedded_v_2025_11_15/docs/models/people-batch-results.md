...
```typescript
import { PeopleBatchResults } from "openapi/models";
...
| `status`                                                                                      | [models.PeopleBatchResultsStatus](../models/people-batch-results-status.md)                   | :heavy_check_mark:                                                                            | The current status of the batch processing.                                                   |
...
| `results`                                                                                     | [models.Result](../models/result.md)[]                                                        | :heavy_minus_sign:                                                                            | The results for each batch item.                                                              |
| `exclusions`                                                                                  | [models.Exclusion](../models/exclusion.md)[]                                                  | :heavy_minus_sign:                                                                            | Items excluded from processing due to validation errors.                                      |