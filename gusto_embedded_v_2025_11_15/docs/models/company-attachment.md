...
| `category`                                                                                                                                                    | [models.CompanyAttachmentCategory](../models/company-attachment-category.md)                                                                                  | :heavy_check_mark:                                                                                                                                            | The category of the company attachment.<br/>- `gep_notice`: A tax notice attachment<br/>- `compliance`: A compliance attachment<br/>- `other`: Any other attachment type<br/> |
