...
import { employeePaymentMethodsGetBankAccounts } from "@gusto/embedded-api-v-2025-11-15/funcs/employeePaymentMethodsGetBankAccounts.js";
...
async function run() {
  const res = await employeePaymentMethodsGetBankAccounts(gustoEmbedded, {
    employeeId: "<id>",
  });
  if (res.ok) {
...
import {
  ...
  invalidateEmployeePaymentMethodsGetBankAccounts,
  invalidateAllEmployeePaymentMethodsGetBankAccounts,
} from "@gusto/embedded-api-v-2025-11-15/react-query/employeePaymentMethodsGetBankAccounts.js";
```
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetV1EmployeesEmployeeIdBankAccountsRequest](../../models/operations/getv1employeesemployeeidbankaccountsrequest.md)                                               | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
