...
async function run() {
  const result = await sdk.notifications.getDetails({
    notificationUuid: "<id>",
  });
...
import { notificationsGetDetails } from "openapi/funcs/notifications-get-details.js";
...
async function run() {
  const res = await notificationsGetDetails(sdk, {
    notificationUuid: "<id>",
  });
  if (res.ok) {
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetNotificationsNotificationUuidRequest](../../models/operations/get-notifications-notification-uuid-request.md)                                                   | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[models.Notification](../../models/notification.md)\>**
...
async function run() {
  const result = await sdk.notifications.getCompanyNotifications({
    companyUuid: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { notificationsGetCompanyNotifications } from "openapi/funcs/notifications-get-company-notifications.js";
...
async function run() {
  const res = await notificationsGetCompanyNotifications(sdk, {
    companyUuid: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetCompanyNotificationsRequest](../../models/operations/get-company-notifications-request.md)                                                                      | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[models.Notification[]](../../models/.md)\>**
