...
import { employeeEmploymentsCreateTermination } from "@gusto/embedded-api-v-2025-11-15/funcs/employeeEmploymentsCreateTermination.js";
...
} from "@gusto/embedded-api-v-2025-11-15/react-query/employeeEmploymentsCreateTermination.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2025-11-15/core.js";
import { employeeEmploymentsGetTerminations } from "@gusto/embedded-api-v-2025-11-15/funcs/employeeEmploymentsGetTerminations.js";
...
} from "@gusto/embedded-api-v-2025-11-15/react-query/employeeEmploymentsGetTerminations.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2025-11-15/core.js";
import { employeeEmploymentsDeleteTermination } from "@gusto/embedded-api-v-2025-11-15/funcs/employeeEmploymentsDeleteTermination.js";
...
} from "@gusto/embedded-api-v-2025-11-15/react-query/employeeEmploymentsDeleteTermination.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2025-11-15/core.js";
import { employeeEmploymentsUpdateTermination } from "@gusto/embedded-api-v-2025-11-15/funcs/employeeEmploymentsUpdateTermination.js";
...
} from "@gusto/embedded-api-v-2025-11-15/react-query/employeeEmploymentsUpdateTermination.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2025-11-15/core.js";
import { employeeEmploymentsCreateRehire } from "@gusto/embedded-api-v-2025-11-15/funcs/employeeEmploymentsCreateRehire.js";
...
} from "@gusto/embedded-api-v-2025-11-15/react-query/employeeEmploymentsCreateRehire.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2025-11-15/core.js";
import { employeeEmploymentsRehire } from "@gusto/embedded-api-v-2025-11-15/funcs/employeeEmploymentsRehire.js";
...
} from "@gusto/embedded-api-v-2025-11-15/react-query/employeeEmploymentsRehire.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2025-11-15/core.js";
import { employeeEmploymentsGetRehire } from "@gusto/embedded-api-v-2025-11-15/funcs/employeeEmploymentsGetRehire.js";
...
} from "@gusto/embedded-api-v-2025-11-15/react-query/employeeEmploymentsGetRehire.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2025-11-15/core.js";
import { employeeEmploymentsDeleteRehire } from "@gusto/embedded-api-v-2025-11-15/funcs/employeeEmploymentsDeleteRehire.js";
...
} from "@gusto/embedded-api-v-2025-11-15/react-query/employeeEmploymentsDeleteRehire.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2025-11-15/core.js";
import { employeeEmploymentsGetHistory } from "@gusto/embedded-api-v-2025-11-15/funcs/employeeEmploymentsGetHistory.js";
...
} from "@gusto/embedded-api-v-2025-11-15/react-query/employeeEmploymentsGetHistory.js";
```
...
<!-- UsageSnippet language="typescript" operationID="get-v1-terminations-employee_id" method="get" path="/v1/terminations/{employee_id}" -->
```typescript
import { GustoEmbedded } from "@gusto/embedded-api-v-2025-11-15";
...
async function run() {
  const result = await gustoEmbedded.employeeEmployments.getV1TerminationsEmployeeId({
    employeeId: "<id>",
  });
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2025-11-15/core.js";
import { employeeEmploymentsGetV1TerminationsEmployeeId } from "@gusto/embedded-api-v-2025-11-15/funcs/employeeEmploymentsGetV1TerminationsEmployeeId.js";
...
async function run() {
  const res = await employeeEmploymentsGetV1TerminationsEmployeeId(gustoEmbedded, {
    employeeId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("employeeEmploymentsGetV1TerminationsEmployeeId failed:", res.error);
  }
}
...
import {
  // Query hooks for fetching data.
  useEmployeeEmploymentsGetV1TerminationsEmployeeId,
  useEmployeeEmploymentsGetV1TerminationsEmployeeIdSuspense,
  ...
  // Utilities to invalidate the query cache for this query in response to
  // mutations and other user actions.
  invalidateEmployeeEmploymentsGetV1TerminationsEmployeeId,
  invalidateAllEmployeeEmploymentsGetV1TerminationsEmployeeId,
} from "@gusto/embedded-api-v-2025-11-15/react-query/employeeEmploymentsGetV1TerminationsEmployeeId.js";
```
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetV1TerminationsEmployeeIdRequest](../../models/operations/getv1terminationsemployeeidrequest.md)                                                                 | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.GetV1TerminationsEmployeeIdResponse](../../models/operations/getv1terminationsemployeeidresponse.md)\>**
