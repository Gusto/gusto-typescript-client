...
async function run() {
  const result = await gustoEmbedded.reports.postV1BulkReports({
...
import { reportsPostV1BulkReports } from "@gusto/embedded-api-v-2025-11-15/funcs/reportsPostV1BulkReports.js";
import { RFCDate } from "@gusto/embedded-api-v-2025-11-15/types/rfcdate.js";
...
async function run() {
  const res = await reportsPostV1BulkReports(gustoEmbedded, {
    systemAccessAuth: process.env["GUSTOEMBEDDED_SYSTEM_ACCESS_AUTH"] ?? "",
  }, {
    bulkReportBody: {
      batch: [
  ...
  if (res.ok) {
    ...
    console.log("reportsPostV1BulkReports failed:", res.error);
  }
}
...
import {
  ...
  useReportsPostV1BulkReportsMutation
} from "@gusto/embedded-api-v-2025-11-15/react-query/reportsPostV1BulkReports.js";
```
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.PostV1BulkReportsRequest](../../models/operations/postv1bulkreportsrequest.md)                                                                                     | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `security`                                                                                                                                                                     | [operations.PostV1BulkReportsSecurity](../../models/operations/postv1bulkreportssecurity.md)                                                                                   | :heavy_check_mark:                                                                                                                                                             | The security requirements to use for the request.                                                                                                                              |
...
**Promise\<[operations.PostV1BulkReportsResponse](../../models/operations/postv1bulkreportsresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="get-v1-bulk_reports-request_uuid" method="get" path="/v1/bulk_reports/{request_uuid}" -->
```typescript
import { GustoEmbedded } from "@gusto/embedded-api-v-2025-11-15";
...
async function run() {
  const result = await gustoEmbedded.reports.getV1BulkReportsRequestUuid({
    systemAccessAuth: process.env["GUSTOEMBEDDED_SYSTEM_ACCESS_AUTH"] ?? "",
  }, {
    requestUuid: "<id>",
  });
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2025-11-15/core.js";
import { reportsGetV1BulkReportsRequestUuid } from "@gusto/embedded-api-v-2025-11-15/funcs/reportsGetV1BulkReportsRequestUuid.js";
...
async function run() {
  const res = await reportsGetV1BulkReportsRequestUuid(gustoEmbedded, {
    systemAccessAuth: process.env["GUSTOEMBEDDED_SYSTEM_ACCESS_AUTH"] ?? "",
  }, {
    requestUuid: "<id>",
  });
  if (res.ok) {
    ...
    console.log("reportsGetV1BulkReportsRequestUuid failed:", res.error);
  }
}
...
import {
  ...
  useReportsGetV1BulkReportsRequestUuid,
  useReportsGetV1BulkReportsRequestUuidSuspense,
  ...
  invalidateReportsGetV1BulkReportsRequestUuid,
  invalidateAllReportsGetV1BulkReportsRequestUuid,
} from "@gusto/embedded-api-v-2025-11-15/react-query/reportsGetV1BulkReportsRequestUuid.js";
```
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetV1BulkReportsRequestUuidRequest](../../models/operations/getv1bulkreportsrequestuuidrequest.md)                                                                 | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `security`                                                                                                                                                                     | [operations.GetV1BulkReportsRequestUuidSecurity](../../models/operations/getv1bulkreportsrequestuuidsecurity.md)                                                               | :heavy_check_mark:                                                                                                                                                             | The security requirements to use for the request.                                                                                                                              |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.GetV1BulkReportsRequestUuidResponse](../../models/operations/getv1bulkreportsrequestuuidresponse.md)\>**
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2025-11-15/core.js";
import { reportsPostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWage } from "@gusto/embedded-api-v-2025-11-15/funcs/reportsPostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWage.js";
...
} from "@gusto/embedded-api-v-2025-11-15/react-query/reportsPostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWage.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2025-11-15/core.js";
import { reportsCreateCustom } from "@gusto/embedded-api-v-2025-11-15/funcs/reportsCreateCustom.js";
import { RFCDate } from "@gusto/embedded-api-v-2025-11-15/types/rfcdate.js";
...
} from "@gusto/embedded-api-v-2025-11-15/react-query/reportsCreateCustom.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2025-11-15/core.js";
import { reportsPostPayrollsPayrollUuidReportsGeneralLedger } from "@gusto/embedded-api-v-2025-11-15/funcs/reportsPostPayrollsPayrollUuidReportsGeneralLedger.js";
...
} from "@gusto/embedded-api-v-2025-11-15/react-query/reportsPostPayrollsPayrollUuidReportsGeneralLedger.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2025-11-15/core.js";
import { reportsGetReportsRequestUuid } from "@gusto/embedded-api-v-2025-11-15/funcs/reportsGetReportsRequestUuid.js";
...
} from "@gusto/embedded-api-v-2025-11-15/react-query/reportsGetReportsRequestUuid.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api-v-2025-11-15/core.js";
import { reportsGetTemplate } from "@gusto/embedded-api-v-2025-11-15/funcs/reportsGetTemplate.js";
...
} from "@gusto/embedded-api-v-2025-11-15/react-query/reportsGetTemplate.js";
```
