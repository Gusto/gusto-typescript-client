...
async function run() {
  const result = await sdk.informationRequests.getInformationRequests({
    companyUuid: "<id>",
  });
...
import { informationRequestsGetInformationRequests } from "openapi/funcs/information-requests-get-information-requests.js";
...
async function run() {
  const res = await informationRequestsGetInformationRequests(sdk, {
    companyUuid: "<id>",
  });
  if (res.ok) {
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetInformationRequestsRequest](../../models/operations/get-information-requests-request.md)                                                                        | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[models.InformationRequest[]](../../models/.md)\>**
...
async function run() {
  const result = await sdk.informationRequests.submit({
...
```typescript
import { SDKCore } from "openapi/core.js";
import { informationRequestsSubmit } from "openapi/funcs/information-requests-submit.js";
...
async function run() {
  const res = await informationRequestsSubmit(sdk, {
    informationRequestUuid: "<id>",
    body: {},
  });
  if (res.ok) {
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.SubmitInformationRequestRequest](../../models/operations/submit-information-request-request.md)                                                                    | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[models.InformationRequest](../../models/information-request.md)\>**
