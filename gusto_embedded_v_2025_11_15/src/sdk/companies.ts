...
export class Companies extends ClientSDK {
  ...
  ): Promise<models.PartnerManagedCompany> {
  ...
  async migrate(
    ...
    options?: RequestOptions,
  ): Promise<models.PartnerManagedCompanyMigrateResponse> {
  ...
  async getV1PartnerManagedCompaniesCompanyUuidMigrationReadiness(
    ...
    options?: RequestOptions,
  ): Promise<models.PartnerManagedCompanyMigrationReadinessResponse> {
    return unwrapAsync(
  ...
  async acceptTermsOfService(
    ...
    options?: RequestOptions,
  ): Promise<models.PartnerManagedCompanyTermsOfServiceResponse> {
