...
import { contractorPaymentsCreate } from "../funcs/contractor-payments-create.js";
import { contractorPaymentsDelete } from "../funcs/contractor-payments-delete.js";
import { contractorPaymentsFund } from "../funcs/contractor-payments-fund.js";
import { contractorPaymentsGetReceipt } from "../funcs/contractor-payments-get-receipt.js";
import { contractorPaymentsGetV1ContractorPaymentsContractorPaymentIdPdf } from "../funcs/contractor-payments-get-v1-contractor-payments-contractor-payment-id-pdf.js";
import { contractorPaymentsGet } from "../funcs/contractor-payments-get.js";
import { contractorPaymentsList } from "../funcs/contractor-payments-list.js";
...
export class ContractorPayments extends ClientSDK {
  ...
  ): Promise<models.ContractorPaymentReceipt> {
  ...
  async fund(
    ...
    options?: RequestOptions,
  ): Promise<models.ContractorPayment> {
  ...
  async getV1ContractorPaymentsContractorPaymentIdPdf(
    request: operations.GetV1ContractorPaymentsContractorPaymentIdPdfRequest,
    options?: RequestOptions,
  ): Promise<void> {
    return unwrapAsync(
