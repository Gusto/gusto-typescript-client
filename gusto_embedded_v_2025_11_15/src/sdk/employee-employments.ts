...
import { employeeEmploymentsGetV1TerminationsEmployeeId } from "../funcs/employee-employments-get-v1-terminations-employee-id.js";
...
export class EmployeeEmployments extends ClientSDK {
  ...
  async getV1TerminationsEmployeeId(
    request: operations.GetV1TerminationsEmployeeIdRequest,
    options?: RequestOptions,
  ): Promise<models.Termination> {
