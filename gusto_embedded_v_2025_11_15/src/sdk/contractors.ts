...
import { contractorsCreate } from "../funcs/contractors-create.js";
import { contractorsDeleteV1ContractorsContractorUuidRehire } from "../funcs/contractors-delete-v1-contractors-contractor-uuid-rehire.js";
import { contractorsDeleteV1ContractorsContractorUuidTermination } from "../funcs/contractors-delete-v1-contractors-contractor-uuid-termination.js";
import { contractorsDelete } from "../funcs/contractors-delete.js";
import { contractorsGetAddress } from "../funcs/contractors-get-address.js";
import { contractorsGetOnboardingStatus } from "../funcs/contractors-get-onboarding-status.js";
import { contractorsGetV1CompaniesCompanyIdContractorsPaymentDetails } from "../funcs/contractors-get-v1-companies-company-id-contractors-payment-details.js";
import { contractorsGet } from "../funcs/contractors-get.js";
import { contractorsList } from "../funcs/contractors-list.js";
import { contractorsPostV1ContractorsContractorUuidRehire } from "../funcs/contractors-post-v1-contractors-contractor-uuid-rehire.js";
import { contractorsPostV1ContractorsContractorUuidTermination } from "../funcs/contractors-post-v1-contractors-contractor-uuid-termination.js";
import { contractorsUpdateAddress } from "../funcs/contractors-update-address.js";
import { contractorsUpdateOnboardingStatus } from "../funcs/contractors-update-onboarding-status.js";
import { contractorsUpdate } from "../funcs/contractors-update.js";
...
export class Contractors extends ClientSDK {
  ...
  async list(
    ...
    options?: RequestOptions,
  ): Promise<Array<models.Contractor>> {
  ...
  async getOnboardingStatus(
    ...
    options?: RequestOptions,
  ): Promise<models.ContractorOnboardingStatus> {
  ...
  async getAddress(
    ...
    options?: RequestOptions,
  ): Promise<models.ContractorAddress> {
  ...
  async getV1CompaniesCompanyIdContractorsPaymentDetails(
    request: operations.GetV1CompaniesCompanyIdContractorsPaymentDetailsRequest,
    options?: RequestOptions,
  ): Promise<Array<models.ContractorPaymentDetailsList>> {
    return unwrapAsync(
  ...
  async postV1ContractorsContractorUuidRehire(
    request: operations.PostV1ContractorsContractorUuidRehireRequest,
    options?: RequestOptions,
  ): Promise<void> {
  ...
  async deleteV1ContractorsContractorUuidRehire(
    request: operations.DeleteV1ContractorsContractorUuidRehireRequest,
    options?: RequestOptions,
  ): Promise<void> {
  ...
  async postV1ContractorsContractorUuidTermination(
    request: operations.PostV1ContractorsContractorUuidTerminationRequest,
    options?: RequestOptions,
  ): Promise<void> {
  ...
  async deleteV1ContractorsContractorUuidTermination(
    request: operations.DeleteV1ContractorsContractorUuidTerminationRequest,
    options?: RequestOptions,
  ): Promise<void> {
