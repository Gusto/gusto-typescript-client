...
export function externalPayrollsCalculateTaxes(
  ...
  Result<
    Array<models.ExternalPayrollTaxSuggestions>,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetV1ExternalPayrollCalculateTaxesRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.ExternalPayrollTaxSuggestions$inboundSchema)),
