...
export function companyAttachmentGetDownloadUrl(
  ...
  Result<
    models.CompanyAttachmentDownloadUrl,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetV1CompaniesAttachmentUrlRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CompanyAttachmentDownloadUrl$inboundSchema),
