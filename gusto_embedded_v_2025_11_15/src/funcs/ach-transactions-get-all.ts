...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetAchTransactionsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/companies/{company_uuid}/ach_transactions")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.AchTransaction$inboundSchema)),
