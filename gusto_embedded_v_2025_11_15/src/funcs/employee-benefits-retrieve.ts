 ...
 */
export function employeeBenefitsRetrieve(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetV1EmployeeBenefitsEmployeeBenefitIdRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.EmployeeBenefit$inboundSchema),
