 ...
 */
export function memberPortalInvitationsPostV1EmployeesEmployeeIdMemberPortalInvitations(
...
> {
  ...
  const context = {
    ...
    operationID: "post-v1-employees-employee_id-member_portal_invitations",
    oAuth2Scopes: null,
