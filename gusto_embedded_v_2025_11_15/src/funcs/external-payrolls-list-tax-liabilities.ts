...
export function externalPayrollsListTaxLiabilities(
  ...
  Result<
    Array<models.TaxLiabilitiesSelections>,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetV1TaxLiabilitiesRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.TaxLiabilitiesSelections$inboundSchema)),
