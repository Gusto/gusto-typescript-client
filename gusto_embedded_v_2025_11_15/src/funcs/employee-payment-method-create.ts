...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.PostV1EmployeesEmployeeIdBankAccountsRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v1/employees/{employee_id}/bank_accounts")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.EmployeeBankAccount$inboundSchema),
