 ...
 */
export function employeeEmploymentsGetTerminations(
  client: SDKCore,
  request: operations.GetV1EmployeesEmployeeIdTerminationsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<models.Termination>,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetV1EmployeesEmployeeIdTerminationsRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v1/employees/{employee_id}/terminations")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.Termination$inboundSchema)),
