...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetV1ContractorFormsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/contractors/{contractor_uuid}/forms")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.Form1099$inboundSchema)),
