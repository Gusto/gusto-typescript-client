 ...
 */
export function externalPayrollsGet(
  client: SDKCore,
  request: operations.GetV1CompanyExternalPayrollsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<models.ExternalPayrollBasic>,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetV1CompanyExternalPayrollsRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.ExternalPayrollBasic$inboundSchema)),
