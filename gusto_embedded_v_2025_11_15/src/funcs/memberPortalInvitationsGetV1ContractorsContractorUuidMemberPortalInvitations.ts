 ...
 */
export function memberPortalInvitationsGetV1ContractorsContractorUuidMemberPortalInvitations(
...
> {
  ...
  const context = {
    ...
    operationID: "get-v1-contractors-contractor_uuid-member_portal_invitations",
    oAuth2Scopes: null,
