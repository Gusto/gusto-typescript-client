 ...
 */
export function memberPortalInvitationsDeleteV1EmployeesEmployeeIdMemberPortalInvitations(
...
> {
  ...
  const context = {
    ...
    operationID: "delete-v1-employees-employee_id-member_portal_invitations",
    oAuth2Scopes: null,
