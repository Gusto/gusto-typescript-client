 ...
 */
export function employeesGetCustomFields(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetV1EmployeesEmployeeIdCustomFieldsRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v1/employees/{employee_id}/custom_fields")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.EmployeeCustomFieldList$inboundSchema),
