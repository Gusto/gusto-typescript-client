...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetV1ContractorFormRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/contractors/{contractor_uuid}/forms/{form_id}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.Form1099$inboundSchema),
