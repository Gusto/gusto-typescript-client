...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetRecoveryCasesRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/companies/{company_uuid}/recovery_cases")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.RecoveryCase$inboundSchema)),
