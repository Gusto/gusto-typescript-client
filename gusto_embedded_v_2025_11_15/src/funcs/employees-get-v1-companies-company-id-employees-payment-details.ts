 ...
 */
export function employeesGetV1CompaniesCompanyIdEmployeesPaymentDetails(
  client: SDKCore,
  request: operations.GetV1CompaniesCompanyIdEmployeesPaymentDetailsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<models.EmployeePaymentDetailsList>,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.EmployeePaymentDetailsList$inboundSchema)),
