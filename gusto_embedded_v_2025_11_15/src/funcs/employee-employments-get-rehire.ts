...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetV1EmployeesEmployeeIdRehireRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, types$.optional(models.Rehire$inboundSchema)),
    M.nil(204, types$.optional(models.Rehire$inboundSchema)),
