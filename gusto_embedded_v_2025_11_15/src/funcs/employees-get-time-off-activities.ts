...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetVersionEmployeesTimeOffActivitiesRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v1/employees/{employee_uuid}/time_off_activities")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.TimeOffActivity$inboundSchema)),
