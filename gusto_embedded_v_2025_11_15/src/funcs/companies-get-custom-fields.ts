 ...
 */
export function companiesGetCustomFields(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetV1CompaniesCompanyIdCustomFieldsRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v1/companies/{company_id}/custom_fields")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CompanyCustomFieldList$inboundSchema),
