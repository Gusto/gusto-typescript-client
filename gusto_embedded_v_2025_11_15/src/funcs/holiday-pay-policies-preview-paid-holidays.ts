 ...
 */
export function holidayPayPoliciesPreviewPaidHolidays(
  client: SDKCore,
  request: operations.GetCompaniesCompanyUuidPaidHolidaysRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<models.PaidHoliday>,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetCompaniesCompanyUuidPaidHolidaysRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v1/companies/{company_uuid}/paid_holidays")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.PaidHoliday$inboundSchema)),
