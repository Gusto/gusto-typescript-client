...
import {
  ...
  PostV1ContractorsContractorUuidRehireRequest$outboundSchema,
  PostV1ContractorsContractorUuidRehireResponse,
  PostV1ContractorsContractorUuidRehireResponse$inboundSchema,
 ...
 */
export function contractorsPostV1ContractorsContractorUuidRehire(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      PostV1ContractorsContractorUuidRehireRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "post-v1-contractors-contractor_uuid-rehire",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, PostV1ContractorsContractorUuidRehireResponse$inboundSchema),
    M.fail([422, "4XX"]),
    M.fail("5XX"),
