...
} from "./pay-schedule-auto-payroll-enablement-blocker.js";
import {
...
/** @internal */
export const PayScheduleShow$inboundSchema: z.ZodMiniType<
  PayScheduleShow,
  unknown
> = z.pipe(
  z.object({
    ...
    auto_payroll_enablement_blockers: z.optional(
      z.nullable(
