...
export const PaymentConfigsUpdateRequestPaymentSpeed$outboundSchema:
  z.ZodMiniEnum<typeof PaymentConfigsUpdateRequestPaymentSpeed> = z.enum(
...
export const PaymentConfigsUpdateRequestPaymentConfigs$outboundSchema:
  ...
  > = z.pipe(
    z.object({
      paymentSpeed: z.optional(
        PaymentConfigsUpdateRequestPaymentSpeed$outboundSchema,
      ),
      fastPaymentLimit: z.optional(z.nullable(z.number())),
      partnerOwnedDisbursement: z.optional(z.boolean()),
    }),
    z.transform((v) => {
      return remap$(v, {
...
/** @internal */
export const PaymentConfigsUpdateRequest$outboundSchema: z.ZodMiniType<
  PaymentConfigsUpdateRequest$Outbound,
  PaymentConfigsUpdateRequest
> = z.pipe(
  z.object({
    paymentConfigs: z.optional(
      z.lazy(() => PaymentConfigsUpdateRequestPaymentConfigs$outboundSchema),
    ),
  }),
  z.transform((v) => {
    return remap$(v, {
