...
export const EmployeeOnboardingStatusEnum = {
...
export type EmployeeOnboardingStatusEnum = OpenEnum<
  typeof EmployeeOnboardingStatusEnum
>;
 ...
 */
export const EmployeePaymentMethodEnum = {
 ...
 * The employee's payment method
 */
export type EmployeePaymentMethodEnum = OpenEnum<
  typeof EmployeePaymentMethodEnum
>;
...
export type EmployeeCurrentEmploymentStatus = OpenEnum<
 ...
 * The current status of the member portal invitation.
 */
export type EmployeeMemberPortalInvitationStatusStatus = OpenEnum<
  typeof EmployeeMemberPortalInvitationStatusStatus
>;
...
export type EmployeeMemberPortalInvitationStatus = {
   ...
   * The current status of the member portal invitation.
   */
  status?: EmployeeMemberPortalInvitationStatusStatus | undefined;
  /**
...
export type Employee = {
   ...
   */
  onboardingStatus?: EmployeeOnboardingStatusEnum | null | undefined;
  /**
   * Configuration for an employee onboarding documents during onboarding
   */
...
/** @internal */
export const EmployeeOnboardingStatusEnum$inboundSchema: z.ZodMiniType<
  EmployeeOnboardingStatusEnum,
  unknown
> = openEnums.inboundSchema(EmployeeOnboardingStatusEnum);

/** @internal */
export const EmployeeOnboardingDocumentsConfig$inboundSchema: z.ZodMiniType<
...
/** @internal */
export const EmployeePaymentMethodEnum$inboundSchema: z.ZodMiniType<
  EmployeePaymentMethodEnum,
  unknown
> = openEnums.inboundSchema(EmployeePaymentMethodEnum);

/** @internal */
export const EmployeeCurrentEmploymentStatus$inboundSchema: z.ZodMiniType<
  EmployeeCurrentEmploymentStatus,
  unknown
> = openEnums.inboundSchema(EmployeeCurrentEmploymentStatus);

/** @internal */
export const EmployeeMemberPortalInvitationStatusStatus$inboundSchema:
  z.ZodMiniType<EmployeeMemberPortalInvitationStatusStatus, unknown> = openEnums
    .inboundSchema(EmployeeMemberPortalInvitationStatusStatus);

/** @internal */
export const EmployeeMemberPortalInvitationStatus$inboundSchema: z.ZodMiniType<
  EmployeeMemberPortalInvitationStatus,
  unknown
> = z.pipe(
  z.object({
    status: types.optional(
      EmployeeMemberPortalInvitationStatusStatus$inboundSchema,
    ),
...
/** @internal */
export const Employee$inboundSchema: z.ZodMiniType<Employee, unknown> = z.pipe(
  z.object({
    uuid: types.string(),
    ...
    onboarding_status: z.optional(
      z.nullable(EmployeeOnboardingStatusEnum$inboundSchema),
    ),
    onboarding_documents_config: types.optional(z.lazy(() =>
    ...
    payment_method: z._default(
      EmployeePaymentMethodEnum$inboundSchema,
      "Check",
    ),
    current_employment_status: z.optional(
      z.nullable(EmployeeCurrentEmploymentStatus$inboundSchema),
    ),
