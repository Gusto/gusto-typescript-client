...
export const GarnishmentGarnishmentType = {
...
export type GarnishmentGarnishmentType = OpenEnum<
  typeof GarnishmentGarnishmentType
>;
...
export type Garnishment = {
   ...
   */
  garnishmentType?: GarnishmentGarnishmentType | null | undefined;
  /**
...
/** @internal */
export const GarnishmentGarnishmentType$inboundSchema: z.ZodMiniType<
  GarnishmentGarnishmentType,
  unknown
> = openEnums.inboundSchema(GarnishmentGarnishmentType);
...
export const Garnishment$inboundSchema: z.ZodMiniType<Garnishment, unknown> = z
  .pipe(
    z.object({
      ...
      garnishment_type: z.optional(
        z.nullable(GarnishmentGarnishmentType$inboundSchema),
      ),
