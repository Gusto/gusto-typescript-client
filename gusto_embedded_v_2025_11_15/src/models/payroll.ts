...
} from "./payroll-unprocessed-employee-compensations-type.js";
...
export const Payroll$inboundSchema: z.ZodMiniType<Payroll, unknown> = z.pipe(
  z.object({
    ...
    withholding_pay_period: z.optional(
      z.nullable(PayrollWithholdingPayPeriodType$inboundSchema),
    ),
...
/** @internal */
export const PayrollUnprocessed$inboundSchema: z.ZodMiniType<
  PayrollUnprocessed,
  unknown
> = z.pipe(
  z.object({
...
export function payrollUnprocessedFromJSON(
  jsonString: string,
): SafeParseResult<PayrollUnprocessed, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => PayrollUnprocessed$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'PayrollUnprocessed' from JSON`,
  );
}
  ...
  z.catchall(
    z.object({
      ...
      taxes: types.optional(
        z.array(z.lazy(() => PayrollShowTax$inboundSchema)),
      ),
