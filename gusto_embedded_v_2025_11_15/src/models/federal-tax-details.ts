...
export const FederalTaxDetailsTaxPayerType = {
...
export type FederalTaxDetailsTaxPayerType = OpenEnum<
  typeof FederalTaxDetailsTaxPayerType
>;
 ...
 */
export const FederalTaxDetailsFilingForm = {
 ...
 * - 944 (Annual federal tax return form)
 */
export type FederalTaxDetailsFilingForm = OpenEnum<
  typeof FederalTaxDetailsFilingForm
>;
...
export type FederalTaxDetails = {
   ...
   * - Non-Profit
   */
  taxPayerType?: FederalTaxDetailsTaxPayerType | null | undefined;
  /**
   ...
   * - 944 (Annual federal tax return form)
   */
  filingForm?: FederalTaxDetailsFilingForm | undefined;
  /**
...
/** @internal */
export const FederalTaxDetailsTaxPayerType$inboundSchema: z.ZodMiniType<
  FederalTaxDetailsTaxPayerType,
  unknown
> = openEnums.inboundSchema(FederalTaxDetailsTaxPayerType);

/** @internal */
export const FederalTaxDetailsFilingForm$inboundSchema: z.ZodMiniType<
  FederalTaxDetailsFilingForm,
  unknown
> = openEnums.inboundSchema(FederalTaxDetailsFilingForm);

/** @internal */
export const FederalTaxDetailsStatus$inboundSchema: z.ZodMiniType<
  FederalTaxDetailsStatus,
  unknown
> = openEnums.inboundSchema(FederalTaxDetailsStatus);

/** @internal */
export const EinVerification$inboundSchema: z.ZodMiniType<
  EinVerification,
  unknown
> = z.object({
...
/** @internal */
export const FederalTaxDetails$inboundSchema: z.ZodMiniType<
  FederalTaxDetails,
  unknown
> = z.pipe(
  z.object({
    version: types.optional(types.string()),
    tax_payer_type: z.optional(
      z.nullable(FederalTaxDetailsTaxPayerType$inboundSchema),
    ),
    taxable_as_scorp: types.optional(types.boolean()),
    filing_form: types.optional(FederalTaxDetailsFilingForm$inboundSchema),
    has_ein: types.optional(types.boolean()),
    ein_verified: types.optional(types.boolean()),
    ein_verification: types.optional(
      z.lazy(() => EinVerification$inboundSchema),
    ),
