...
/** @internal */
export const PayrollReversal$inboundSchema: z.ZodMiniType<
  PayrollReversal,
  unknown
> = z.pipe(
  z.object({
    reversed_payroll_uuid: types.optional(types.string()),
    reversal_payroll_uuid: z.optional(z.nullable(types.string())),
    reason: types.optional(types.string()),
    approved_at: z.optional(z.nullable(types.string())),
