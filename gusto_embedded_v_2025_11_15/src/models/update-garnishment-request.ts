...
export const UpdateGarnishmentRequestGarnishmentType$outboundSchema:
  z.ZodMiniEnum<typeof UpdateGarnishmentRequestGarnishmentType> = z.enum(
...
/** @internal */
export const UpdateGarnishmentRequest$outboundSchema: z.ZodMiniType<
...
> = z.pipe(
  z.object({
    ...
    garnishmentType: z.optional(
      z.nullable(UpdateGarnishmentRequestGarnishmentType$outboundSchema),
    ),
