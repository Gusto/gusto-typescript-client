...
export type EmployeeDeduction = {
  ...
  defaultValue?: EmployeeDeductionDefaultValue | null | undefined;
...
export type BenefitTypeRequirementsContribution = {
  required?: boolean | undefined;
  editable?: boolean | undefined;
  defaultValue?: ContributionDefaultValue | null | undefined;
  choices?: Array<string> | null | undefined;
};
...
export type DeductAsPercentage = {
  required?: boolean | undefined;
  editable?: boolean | undefined;
  defaultValue?: DeductAsPercentageDefaultValue | null | undefined;
  choices?: Array<string> | null | undefined;
};
...
export type CatchUp = {
  required?: boolean | undefined;
  editable?: boolean | undefined;
  defaultValue?: CatchUpDefaultValue | null | undefined;
  choices?: Array<string> | null | undefined;
};
 ...
 */
export type BenefitTypeRequirementsLimitOption = {
  required?: boolean | undefined;
  editable?: boolean | undefined;
  defaultValue?: LimitOptionDefaultValue | null | undefined;
  choices?: Array<string> | null | undefined;
};
...
export type CoverageSalaryMultiplier = {
  required?: boolean | undefined;
  editable?: boolean | undefined;
  defaultValue?: CoverageSalaryMultiplierDefaultValue | null | undefined;
  choices?: Array<string> | null | undefined;
};
...
export type CoverageAmount = {
  required?: boolean | undefined;
  editable?: boolean | undefined;
  defaultValue?: CoverageAmountDefaultValue | null | undefined;
  choices?: Array<string> | null | undefined;
};
...
export type BenefitTypeRequirements = {
   ...
   * Some benefits require additional information to determine their limit. For example, for an HSA benefit, the limit option should be either 'Family' or 'Individual'. For a Dependent Care FSA benefit, the limit option should be either 'Joint Filing or Single' or 'Married and Filing Separately'.
   */
  limitOption?: BenefitTypeRequirementsLimitOption | undefined;
  /**
   * The maximum company contribution amount per year. A null value signifies no limit.
   */
...
> = z.pipe(
  z.object({
    ...
    default_value: z.optional(
      z.nullable(z.lazy(() => EmployeeDeductionDefaultValue$inboundSchema)),
    ),
...
> = z.pipe(
  z.object({
    ...
    editable: types.optional(types.boolean()),
    default_value: z.optional(
      z.nullable(z.lazy(() => ContributionDefaultValue$inboundSchema)),
    ),
    choices: z.optional(z.nullable(z.array(types.string()))),
  }),
  z.transform((v) => {
...
> = z.pipe(
  z.object({
    ...
    editable: types.optional(types.boolean()),
    default_value: z.optional(
      z.nullable(z.lazy(() => DeductAsPercentageDefaultValue$inboundSchema)),
    ),
    choices: z.optional(z.nullable(z.array(types.string()))),
  }),
  z.transform((v) => {
...
export const CatchUp$inboundSchema: z.ZodMiniType<CatchUp, unknown> = z.pipe(
  z.object({
    required: types.optional(types.boolean()),
    editable: types.optional(types.boolean()),
    default_value: z.optional(z.nullable(z.lazy(() =>
...
/** @internal */
export const BenefitTypeRequirementsLimitOption$inboundSchema: z.ZodMiniType<
...
> = z.pipe(
  z.object({
    ...
    editable: types.optional(types.boolean()),
    default_value: z.optional(
      z.nullable(z.lazy(() => LimitOptionDefaultValue$inboundSchema)),
    ),
    choices: z.optional(z.nullable(z.array(types.string()))),
  }),
  z.transform((v) => {
...
export function benefitTypeRequirementsLimitOptionFromJSON(
  jsonString: string,
): SafeParseResult<BenefitTypeRequirementsLimitOption, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      BenefitTypeRequirementsLimitOption$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'BenefitTypeRequirementsLimitOption' from JSON`,
  );
}
...
> = z.pipe(
  z.object({
    ...
    editable: types.optional(types.boolean()),
    default_value: z.optional(z.nullable(z.lazy(() =>
      CompanyContributionAnnualMaximumDefaultValue$inboundSchema
    ))),
    choices: z.optional(z.nullable(z.array(types.string()))),
  }),
  z.transform((v) => {
...
> = z.pipe(
  z.object({
    ...
    editable: types.optional(types.boolean()),
    default_value: z.optional(z.nullable(z.lazy(() =>
      CoverageSalaryMultiplierDefaultValue$inboundSchema
    ))),
    choices: z.optional(z.nullable(z.array(types.string()))),
  }),
  z.transform((v) => {
...
> = z.pipe(
  z.object({
    ...
    editable: types.optional(types.boolean()),
    default_value: z.optional(
      z.nullable(z.lazy(() => CoverageAmountDefaultValue$inboundSchema)),
    ),
    choices: z.optional(z.nullable(z.array(types.string()))),
  }),
  z.transform((v) => {
...
> = z.pipe(
  z.object({
    ...
    limit_option: types.optional(
      z.lazy(() => BenefitTypeRequirementsLimitOption$inboundSchema),
    ),
