 ...
 */
export const PutV1EmployeeFormSignXGustoAPIVersion = {
  TwoThousandAndTwentyFiveMinus11Minus15: "2025-11-15",
} as const;
/**
 * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
 */
export type PutV1EmployeeFormSignXGustoAPIVersion = ClosedEnum<
  typeof PutV1EmployeeFormSignXGustoAPIVersion
>;
...
export type PutV1EmployeeFormSignRequest = {
   ...
   * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
   */
  xGustoAPIVersion?: PutV1EmployeeFormSignXGustoAPIVersion | undefined;
  /**
...
/** @internal */
export const PutV1EmployeeFormSignXGustoAPIVersion$outboundSchema:
  z.ZodMiniEnum<typeof PutV1EmployeeFormSignXGustoAPIVersion> = z.enum(
    PutV1EmployeeFormSignXGustoAPIVersion,
  );
...
> = z.pipe(
  z.object({
    xGustoAPIVersion: z._default(
      PutV1EmployeeFormSignXGustoAPIVersion$outboundSchema,
      "2025-11-15",
    ),
    employeeId: z.string(),
    formId: z.string(),
