 ...
 */
export const GetV1WebhookSubscriptionUuidXGustoAPIVersion = {
  TwoThousandAndTwentyFiveMinus11Minus15: "2025-11-15",
} as const;
/**
 * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
 */
export type GetV1WebhookSubscriptionUuidXGustoAPIVersion = ClosedEnum<
  typeof GetV1WebhookSubscriptionUuidXGustoAPIVersion
>;
...
export type GetV1WebhookSubscriptionUuidRequest = {
   ...
   * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
   */
  xGustoAPIVersion?: GetV1WebhookSubscriptionUuidXGustoAPIVersion | undefined;
};
...
/** @internal */
export const GetV1WebhookSubscriptionUuidXGustoAPIVersion$outboundSchema:
  z.ZodMiniEnum<typeof GetV1WebhookSubscriptionUuidXGustoAPIVersion> = z.enum(
...
> = z.pipe(
  z.object({
    ...
    xGustoAPIVersion: z._default(
      GetV1WebhookSubscriptionUuidXGustoAPIVersion$outboundSchema,
      "2025-11-15",
    ),
  }),
  z.transform((v) => {
