 ...
 */
export const GetV1WebhookSubscriptionVerificationTokenUuidXGustoAPIVersion = {
  TwoThousandAndTwentyFiveMinus11Minus15: "2025-11-15",
} as const;
/**
 * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
 */
export type GetV1WebhookSubscriptionVerificationTokenUuidXGustoAPIVersion =
  ClosedEnum<
    typeof GetV1WebhookSubscriptionVerificationTokenUuidXGustoAPIVersion
  >;
...
/** @internal */
export const GetV1WebhookSubscriptionVerificationTokenUuidXGustoAPIVersion$outboundSchema:
  z.ZodMiniEnum<
    typeof GetV1WebhookSubscriptionVerificationTokenUuidXGustoAPIVersion
  > = z.enum(GetV1WebhookSubscriptionVerificationTokenUuidXGustoAPIVersion);
  ...
  > = z.pipe(
    z.object({
      ...
      xGustoAPIVersion: z._default(
        GetV1WebhookSubscriptionVerificationTokenUuidXGustoAPIVersion$outboundSchema,
        "2025-11-15",
      ),
    }),
    z.transform((v) => {
