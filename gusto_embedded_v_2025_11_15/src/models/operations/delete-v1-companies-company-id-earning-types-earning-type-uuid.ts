 ...
 */
export const DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidXGustoAPIVersion =
  {
 ...
 * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
 */
export type DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidXGustoAPIVersion =
  ClosedEnum<
    typeof DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidXGustoAPIVersion
  >;
...
/** @internal */
export const DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidXGustoAPIVersion$outboundSchema:
  z.ZodMiniEnum<
    typeof DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidXGustoAPIVersion
  > = z.enum(
    DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidXGustoAPIVersion,
  ...
  > = z.pipe(
    z.object({
      xGustoAPIVersion: z._default(
        DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidXGustoAPIVersion$outboundSchema,
        "2025-11-15",
      ),
      companyId: z.string(),
