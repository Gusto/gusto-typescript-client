 ...
 */
export const GetInvoicesInvoicePeriodXGustoAPIVersion = {
  TwoThousandAndTwentyFiveMinus11Minus15: "2025-11-15",
} as const;
/**
 * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
 */
export type GetInvoicesInvoicePeriodXGustoAPIVersion = ClosedEnum<
  typeof GetInvoicesInvoicePeriodXGustoAPIVersion
>;
...
export type GetInvoicesInvoicePeriodRequest = {
   ...
   * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
   */
  xGustoAPIVersion?: GetInvoicesInvoicePeriodXGustoAPIVersion | undefined;
  /**
...
/** @internal */
export const GetInvoicesInvoicePeriodXGustoAPIVersion$outboundSchema:
  z.ZodMiniEnum<typeof GetInvoicesInvoicePeriodXGustoAPIVersion> = z.enum(
...
> = z.pipe(
  z.object({
    xGustoAPIVersion: z._default(
      GetInvoicesInvoicePeriodXGustoAPIVersion$outboundSchema,
      "2025-11-15",
    ),
