 ...
 */
export const PostV1EmployeesEmployeeIdTerminationsXGustoAPIVersion = {
  TwoThousandAndTwentyFiveMinus11Minus15: "2025-11-15",
} as const;
/**
 * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
 */
export type PostV1EmployeesEmployeeIdTerminationsXGustoAPIVersion = ClosedEnum<
  typeof PostV1EmployeesEmployeeIdTerminationsXGustoAPIVersion
>;
...
/** @internal */
export const PostV1EmployeesEmployeeIdTerminationsXGustoAPIVersion$outboundSchema:
  z.ZodMiniEnum<typeof PostV1EmployeesEmployeeIdTerminationsXGustoAPIVersion> =
    z.enum(PostV1EmployeesEmployeeIdTerminationsXGustoAPIVersion);
  ...
  > = z.pipe(
    z.object({
      xGustoAPIVersion: z._default(
        PostV1EmployeesEmployeeIdTerminationsXGustoAPIVersion$outboundSchema,
        "2025-11-15",
      ),
      employeeId: z.string(),
      body: z.lazy(() =>
