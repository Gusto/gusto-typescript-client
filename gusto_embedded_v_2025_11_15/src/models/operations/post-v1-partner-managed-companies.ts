 ...
 */
export const PostV1PartnerManagedCompaniesXGustoAPIVersion = {
  TwoThousandAndTwentyFiveMinus11Minus15: "2025-11-15",
} as const;
/**
 * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
 */
export type PostV1PartnerManagedCompaniesXGustoAPIVersion = ClosedEnum<
  typeof PostV1PartnerManagedCompaniesXGustoAPIVersion
>;
...
export type PostV1PartnerManagedCompaniesRequest = {
   ...
   * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
   */
  xGustoAPIVersion?: PostV1PartnerManagedCompaniesXGustoAPIVersion | undefined;
...
/** @internal */
export const PostV1PartnerManagedCompaniesXGustoAPIVersion$outboundSchema:
  z.ZodMiniEnum<typeof PostV1PartnerManagedCompaniesXGustoAPIVersion> = z.enum(
...
export type PostV1PartnerManagedCompaniesRequest$Outbound = {
  ...
  body: models.PartnerManagedCompanyCreateRequest$Outbound;
};
...
> = z.pipe(
  z.object({
    xGustoAPIVersion: z._default(
      PostV1PartnerManagedCompaniesXGustoAPIVersion$outboundSchema,
      "2025-11-15",
    ),
    body: models.PartnerManagedCompanyCreateRequest$outboundSchema,
  }),
  z.transform((v) => {
    return remap$(v, {
