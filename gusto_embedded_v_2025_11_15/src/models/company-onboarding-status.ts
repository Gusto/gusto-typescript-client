...
export type RequirementEnum = OpenEnum<typeof RequirementEnum>;
...
export type CompanyOnboardingStatusOnboardingStep = {
   ...
   */
  requirements?: Array<RequirementEnum> | undefined;
};
...
/** @internal */
export const RequirementEnum$inboundSchema: z.ZodMiniType<
  RequirementEnum,
  unknown
> = openEnums.inboundSchema(RequirementEnum);
...
> = z.pipe(
  z.object({
    ...
    requirements: types.optional(z.array(RequirementEnum$inboundSchema)),
  }),
  z.transform((v) => {
    return remap$(v, {
