...
export type ContractorPaymentDetailsListSplit = {
...
export type ContractorPaymentDetailsList = {
  ...
  splits?: Array<ContractorPaymentDetailsListSplit> | null | undefined;
};
...
/** @internal */
export const ContractorPaymentDetailsListSplit$inboundSchema: z.ZodMiniType<
  ContractorPaymentDetailsListSplit,
  unknown
> = z.pipe(
  z.object({
...
export function contractorPaymentDetailsListSplitFromJSON(
  jsonString: string,
): SafeParseResult<ContractorPaymentDetailsListSplit, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ContractorPaymentDetailsListSplit$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ContractorPaymentDetailsListSplit' from JSON`,
  );
}
...
> = z.pipe(
  z.object({
    ...
    splits: z.optional(z.nullable(z.array(z.lazy(() =>
      ContractorPaymentDetailsListSplit$inboundSchema
    )))),
  }),
  z.transform((v) => {
    return remap$(v, {
