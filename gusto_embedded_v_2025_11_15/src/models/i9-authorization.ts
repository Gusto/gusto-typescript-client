 ...
 */
export const I9AuthorizationAuthorizationStatus = {
  Citizen: "citizen",
 ...
 * The employee's authorization status
 */
export type I9AuthorizationAuthorizationStatus = OpenEnum<
  typeof I9AuthorizationAuthorizationStatus
>;
...
export type I9Authorization = {
   ...
   * The employee's authorization status
   */
  authorizationStatus: I9AuthorizationAuthorizationStatus;
  /**
...
/** @internal */
export const I9AuthorizationAuthorizationStatus$inboundSchema: z.ZodMiniType<
  I9AuthorizationAuthorizationStatus,
  unknown
> = openEnums.inboundSchema(I9AuthorizationAuthorizationStatus);
...
> = z.pipe(
  z.object({
    ...
    authorization_status: I9AuthorizationAuthorizationStatus$inboundSchema,
