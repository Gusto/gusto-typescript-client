...
export type Notification = {
   ...
   */
  resources: Array<NotificationResource>;
};
...
/** @internal */
export const NotificationResource$inboundSchema: z.ZodMiniType<
...
export const Notification$inboundSchema: z.ZodMiniType<Notification, unknown> =
  z.pipe(
    z.object({
      ...
      resources: z.array(z.lazy(() => NotificationResource$inboundSchema)),
    }),
    z.transform((v) => {
      return remap$(v, {
