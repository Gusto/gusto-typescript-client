...
export type BenefitSummaryEmployee = {
  /**
   ...
   */
  imputedPay?: string | undefined;
  payrollBenefits?: Array<PayrollBenefit> | undefined;
};
...
export type BenefitSummary = {
   ...
   */
  companyBenefitContribution?: string | undefined;
  employees?: Array<BenefitSummaryEmployee> | undefined;
};
...
/** @internal */
export const PayrollBenefit$inboundSchema: z.ZodMiniType<
  PayrollBenefit,
  unknown
> = z.pipe(
  z.object({
...
export function payrollBenefitFromJSON(
  jsonString: string,
): SafeParseResult<PayrollBenefit, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => PayrollBenefit$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'PayrollBenefit' from JSON`,
  );
}

/** @internal */
export const BenefitSummaryEmployee$inboundSchema: z.ZodMiniType<
...
> = z.pipe(
  z.object({
    ...
    payroll_benefits: types.optional(
      z.array(z.lazy(() => PayrollBenefit$inboundSchema)),
    ),
  }),
  z.transform((v) => {
    return remap$(v, {
...
export function benefitSummaryEmployeeFromJSON(
  jsonString: string,
): SafeParseResult<BenefitSummaryEmployee, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => BenefitSummaryEmployee$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'BenefitSummaryEmployee' from JSON`,
  );
}
...
> = z.pipe(
  z.object({
    ...
    employees: types.optional(
      z.array(z.lazy(() => BenefitSummaryEmployee$inboundSchema)),
    ),
  }),
  z.transform((v) => {
    return remap$(v, {
