...
/** @internal */
export const ContractorCreateRequestBodyType$outboundSchema: z.ZodMiniEnum<
  typeof ContractorCreateRequestBodyType
> = z.enum(ContractorCreateRequestBodyType);

/** @internal */
export const ContractorCreateRequestBodyWageType$outboundSchema: z.ZodMiniEnum<
  typeof ContractorCreateRequestBodyWageType
> = z.enum(ContractorCreateRequestBodyWageType);
...
/** @internal */
export const ContractorCreateRequestBody$outboundSchema: z.ZodMiniType<
  ContractorCreateRequestBody$Outbound,
  ContractorCreateRequestBody
> = z.pipe(
  z.object({
    type: z._default(
      ContractorCreateRequestBodyType$outboundSchema,
      "Individual",
    ),
