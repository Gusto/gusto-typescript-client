...
export const RehireUpdateRequestBodyEmploymentStatus$outboundSchema:
  z.ZodMiniEnum<typeof RehireUpdateRequestBodyEmploymentStatus> = z.enum(
...
/** @internal */
export const RehireUpdateRequestBody$outboundSchema: z.ZodMiniType<
...
> = z.pipe(
  z.object({
    ...
    employmentStatus: z.optional(
      RehireUpdateRequestBodyEmploymentStatus$outboundSchema,
    ),
