...
} from "./contractor-payment-for-group-preview.js";
 ...
 * The status of the contractor payment group.  Will be `Funded` if all payments that should be funded (i.e. have `Direct Deposit` for payment method) are funded.  A group can have status `Funded` while having associated payments that have status `Unfunded`, i.e. payment with `Check` payment method.
 */
export type ContractorPaymentGroupPreviewStatus = OpenEnum<
...
/** @internal */
export const ContractorPaymentGroupPreviewStatus$inboundSchema: z.ZodMiniType<
  ContractorPaymentGroupPreviewStatus,
  unknown
> = openEnums.inboundSchema(ContractorPaymentGroupPreviewStatus);

/** @internal */
export const ContractorPaymentGroupPreviewTotals$inboundSchema: z.ZodMiniType<
...
/** @internal */
export const ContractorPaymentGroupPreview$inboundSchema: z.ZodMiniType<
...
> = z.pipe(
  z.object({
    ...
    status: types.optional(ContractorPaymentGroupPreviewStatus$inboundSchema),
    ...
    totals: types.optional(
      z.lazy(() => ContractorPaymentGroupPreviewTotals$inboundSchema),
    ),
    contractor_payments: types.optional(
      z.array(ContractorPaymentForGroupPreview$inboundSchema),
    ),
  }),
  z.transform((v) => {
    return remap$(v, {
