...
export const CompanyBenefitUpdateRequestCatchUpType$outboundSchema:
  z.ZodMiniEnum<typeof CompanyBenefitUpdateRequestCatchUpType> = z.enum(
...
/** @internal */
export const CompanyBenefitUpdateRequest$outboundSchema: z.ZodMiniType<
...
> = z.pipe(
  z.object({
    ...
    catchUpType: z.optional(
      z.nullable(CompanyBenefitUpdateRequestCatchUpType$outboundSchema),
    ),
  }),
  z.transform((v) => {
    return remap$(v, {
