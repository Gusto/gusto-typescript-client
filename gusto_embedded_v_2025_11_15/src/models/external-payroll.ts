...
export type ExternalPayrollEarning = {
...
export type ExternalPayrollExternalPayrollItem = {
  employeeUuid?: string | undefined;
  earnings?: Array<ExternalPayrollEarning> | undefined;
...
export type ExternalPayroll = {
   ...
   */
  externalPayrollItems?: Array<ExternalPayrollExternalPayrollItem> | undefined;
  /**
...
/** @internal */
export const ExternalPayrollEarning$inboundSchema: z.ZodMiniType<
  ExternalPayrollEarning,
  unknown
> = z.pipe(
  z.object({
...
export function externalPayrollEarningFromJSON(
  jsonString: string,
): SafeParseResult<ExternalPayrollEarning, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ExternalPayrollEarning$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ExternalPayrollEarning' from JSON`,
  );
}
...
/** @internal */
export const ExternalPayrollExternalPayrollItem$inboundSchema: z.ZodMiniType<
  ExternalPayrollExternalPayrollItem,
  unknown
> = z.pipe(
  z.object({
    employee_uuid: types.optional(types.string()),
    earnings: types.optional(
      z.array(z.lazy(() => ExternalPayrollEarning$inboundSchema)),
    ),
...
export function externalPayrollExternalPayrollItemFromJSON(
  jsonString: string,
): SafeParseResult<ExternalPayrollExternalPayrollItem, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      ExternalPayrollExternalPayrollItem$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ExternalPayrollExternalPayrollItem' from JSON`,
  );
}
...
> = z.pipe(
  z.object({
    ...
    external_payroll_items: types.optional(
      z.array(z.lazy(() => ExternalPayrollExternalPayrollItem$inboundSchema)),
    ),
