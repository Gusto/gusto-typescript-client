...
/** @internal */
export const TimeOffPolicyRequestPolicyType$outboundSchema: z.ZodMiniEnum<
  typeof TimeOffPolicyRequestPolicyType
> = z.enum(TimeOffPolicyRequestPolicyType);
...
/** @internal */
export const TimeOffPolicyRequest$outboundSchema: z.ZodMiniType<
