...
/** @internal */
export const ContractorUpdateRequestBodyType$outboundSchema: z.ZodMiniEnum<
  typeof ContractorUpdateRequestBodyType
> = z.enum(ContractorUpdateRequestBodyType);

/** @internal */
export const ContractorUpdateRequestBodyWageType$outboundSchema: z.ZodMiniEnum<
  typeof ContractorUpdateRequestBodyWageType
> = z.enum(ContractorUpdateRequestBodyWageType);
...
/** @internal */
export const ContractorUpdateRequestBody$outboundSchema: z.ZodMiniType<
...
> = z.pipe(
  z.object({
    version: z.string(),
    type: z._default(
      ContractorUpdateRequestBodyType$outboundSchema,
      "Individual",
    ),
    wageType: z.optional(ContractorUpdateRequestBodyWageType$outboundSchema),
