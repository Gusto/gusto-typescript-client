...
exports.tool$companiesCreateAdmin = void 0;
...
exports.tool$companiesCreateAdmin = {
...
scope: \`company_admin:write\``,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, companiesCreateAdmin_js_1.companiesCreateAdmin)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
