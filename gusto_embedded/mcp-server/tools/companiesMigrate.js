...
exports.tool$companiesMigrate = void 0;
...
scope: \`partner_managed_companies:write\``,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, companiesMigrate_js_1.companiesMigrate)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
