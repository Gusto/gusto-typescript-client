...
exports.tool$industrySelectionUpdate = void 0;
...
exports.tool$industrySelectionUpdate = {
...
scope: \`companies:write\``,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, industrySelectionUpdate_js_1.industrySelectionUpdate)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
