...
exports.tool$contractorPaymentGroupsFund = void 0;
...
exports.tool$contractorPaymentGroupsFund = {
...
scope: \`payrolls:run\``,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, contractorPaymentGroupsFund_js_1.contractorPaymentGroupsFund)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
