...
exports.tool$reportsGetTemplate = void 0;
...
exports.tool$reportsGetTemplate = {
...
scope: \`company_reports:write\``,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, reportsGetTemplate_js_1.reportsGetTemplate)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
