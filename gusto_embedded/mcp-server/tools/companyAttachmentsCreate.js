...
exports.tool$companyAttachmentsCreate = void 0;
...
exports.tool$companyAttachmentsCreate = {
...
scope: \`company_attachments:write\``,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, companyAttachmentsCreate_js_1.companyAttachmentsCreate)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
