...
exports.tool$payrollsUpdate = void 0;
...
scope: \`payrolls:write\``,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, payrollsUpdate_js_1.payrollsUpdate)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
