...
exports.tool$notificationsGetDetails = void 0;
...
exports.tool$notificationsGetDetails = {
...
scope: \`notifications:read\``,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, notificationsGetDetails_js_1.notificationsGetDetails)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
