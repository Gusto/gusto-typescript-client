...
exports.tool$payrollsCalculateGrossUp = void 0;
...
exports.tool$payrollsCalculateGrossUp = {
...
scope: \`payrolls:run\``,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, payrollsCalculateGrossUp_js_1.payrollsCalculateGrossUp)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
