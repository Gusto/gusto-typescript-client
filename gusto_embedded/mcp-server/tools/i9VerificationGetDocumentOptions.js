...
exports.tool$i9VerificationGetDocumentOptions = void 0;
...
exports.tool$i9VerificationGetDocumentOptions = {
...
scope: \`i9_authorizations:read\``,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, i9VerificationGetDocumentOptions_js_1.i9VerificationGetDocumentOptions)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
