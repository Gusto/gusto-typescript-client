...
exports.tool$payrollsCreateOffCycle = void 0;
...
exports.tool$payrollsCreateOffCycle = {
...
scope: \`payrolls:run\``,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, payrollsCreateOffCycle_js_1.payrollsCreateOffCycle)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
