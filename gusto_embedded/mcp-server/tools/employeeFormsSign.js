...
exports.tool$employeeFormsSign = void 0;
...
exports.tool$employeeFormsSign = {
...
scope: \`employee_forms:sign\``,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, employeeFormsSign_js_1.employeeFormsSign)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
