...
exports.tool$i9VerificationCreateDocuments = void 0;
...
exports.tool$i9VerificationCreateDocuments = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, i9VerificationCreateDocuments_js_1.i9VerificationCreateDocuments)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
