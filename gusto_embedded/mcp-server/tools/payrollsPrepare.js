...
exports.tool$payrollsPrepare = void 0;
...
scope: \`payrolls:write\``,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, payrollsPrepare_js_1.payrollsPrepare)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
