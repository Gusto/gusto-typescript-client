...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api/core.js";
import { locationsRetrieve } from "@gusto/embedded-api/funcs/locationsRetrieve.js";
...
} from "@gusto/embedded-api/react-query/locationsRetrieve.js";
```
...
async function run() {
  const result = await gustoEmbedded.locations.update({
    locationId: "<id>",
    requestBody: {
      version: "a580c1423802f3080d66cc28b18a4d72",
      phoneNumber: "8009360383",
