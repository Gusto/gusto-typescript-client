...
async function run() {
  await gustoEmbedded.payrolls.employees.getPayStub({
    payrollId: "<id>",
    employeeId: "<id>",
  });
...
import { payrollsEmployeesGetPayStub } from "gusto_embedded/funcs/payrollsEmployeesGetPayStub.js";
...
async function run() {
  const res = await payrollsEmployeesGetPayStub(gustoEmbedded, {
    payrollId: "<id>",
    employeeId: "<id>",
  });
