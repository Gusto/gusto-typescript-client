...
* [createBenefit](#createbenefit) - Create an employee benefit
* [getAll](#getall) - Get all benefits for an employee
* [get](#get) - Get an employee benefit
* [update](#update) - Update an employee benefit
* [delete](#delete) - Delete an employee benefit
* [createYtdAmountsFromDifferentCompany](#createytdamountsfromdifferentcompany) - Create year-to-date benefit amounts from a different company
...
import { employeeBenefitsCreateBenefit } from "@gusto/embedded-api/funcs/employeeBenefitsCreateBenefit.js";
...
async function run() {
  const res = await employeeBenefitsCreateBenefit(gustoEmbedded, {
    employeeId: "<id>",
    requestBody: {
      companyBenefitUuid: "f68abb42-431e-4392-bc3f-2795627e00f3",
      contribution: {
...
import {
  ...
  useEmployeeBenefitsCreateBenefitMutation
} from "@gusto/embedded-api/react-query/employeeBenefitsCreateBenefit.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api/core.js";
import { employeeBenefitsGetAll } from "@gusto/embedded-api/funcs/employeeBenefitsGetAll.js";
...
async function run() {
  const res = await employeeBenefitsGetAll(gustoEmbedded, {
    employeeId: "<id>",
  });
...
import {
  ...
  useEmployeeBenefitsGetAll,
  useEmployeeBenefitsGetAllSuspense,

  // Utility for prefetching data during server-side rendering and in React
  // Server Components that will be immediately available to client components
  // using the hooks.
  prefetchEmployeeBenefitsGetAll,
  
  // Utilities to invalidate the query cache for this query in response to
  // mutations and other user actions.
  invalidateEmployeeBenefitsGetAll,
  invalidateAllEmployeeBenefitsGetAll,
} from "@gusto/embedded-api/react-query/employeeBenefitsGetAll.js";
```
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api/core.js";
import { employeeBenefitsCreateYtdAmountsFromDifferentCompany } from "@gusto/embedded-api/funcs/employeeBenefitsCreateYtdAmountsFromDifferentCompany.js";
...
async function run() {
  const res = await employeeBenefitsCreateYtdAmountsFromDifferentCompany(gustoEmbedded, {
    employeeId: "<id>",
    postEmployeeYtdBenefitAmountsFromDifferentCompany: {
      taxYear: 2422.08,
    },
...
import {
  // Mutation hook for triggering the API call.
  useEmployeeBenefitsCreateYtdAmountsFromDifferentCompanyMutation
} from "@gusto/embedded-api/react-query/employeeBenefitsCreateYtdAmountsFromDifferentCompany.js";
```
...
async function run() {
  const result = await gustoEmbedded.employeeBenefits.getEmployeeYtdBenefitAmountsFromDifferentCompany({
    employeeId: "<id>",
    taxYear: 2024,
  });
...
```typescript
import { GustoEmbeddedCore } from "@gusto/embedded-api/core.js";
import { employeeBenefitsGetEmployeeYtdBenefitAmountsFromDifferentCompany } from "@gusto/embedded-api/funcs/employeeBenefitsGetEmployeeYtdBenefitAmountsFromDifferentCompany.js";
...
async function run() {
  const res = await employeeBenefitsGetEmployeeYtdBenefitAmountsFromDifferentCompany(gustoEmbedded, {
    employeeId: "<id>",
    taxYear: 2024,
  });
...
import {
  // Query hooks for fetching data.
  useEmployeeBenefitsGetEmployeeYtdBenefitAmountsFromDifferentCompany,
  useEmployeeBenefitsGetEmployeeYtdBenefitAmountsFromDifferentCompanySuspense,

  // Utility for prefetching data during server-side rendering and in React
  // Server Components that will be immediately available to client components
  // using the hooks.
  prefetchEmployeeBenefitsGetEmployeeYtdBenefitAmountsFromDifferentCompany,
  
  // Utilities to invalidate the query cache for this query in response to
  // mutations and other user actions.
  invalidateEmployeeBenefitsGetEmployeeYtdBenefitAmountsFromDifferentCompany,
  invalidateAllEmployeeBenefitsGetEmployeeYtdBenefitAmountsFromDifferentCompany,
} from "@gusto/embedded-api/react-query/employeeBenefitsGetEmployeeYtdBenefitAmountsFromDifferentCompany.js";
```
