...
async function run() {
  const result = await gustoEmbedded.jobs.updateCompensation({
    compensationId: "<id>",
    requestBody: {
...
import { jobsUpdateCompensation } from "gusto_embedded/funcs/jobsUpdateCompensation.js";
...
async function run() {
  const res = await jobsUpdateCompensation(gustoEmbedded, {
    compensationId: "<id>",
    requestBody: {
      version: "98jr3289h3298hr9329gf9egskt3kagri32qqgiqe3872",
      rate: "60000.00",
