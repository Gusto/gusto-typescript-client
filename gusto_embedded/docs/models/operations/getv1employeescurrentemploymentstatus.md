...
```typescript
import { GetV1EmployeesCurrentEmploymentStatus } from "@gusto/embedded-api/models/operations/getv1employees.js";

let value: GetV1EmployeesCurrentEmploymentStatus =
