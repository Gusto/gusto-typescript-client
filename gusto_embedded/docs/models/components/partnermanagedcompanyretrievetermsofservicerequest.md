...
```typescript
import { PartnerManagedCompanyRetrieveTermsOfServiceRequest } from "@gusto/embedded-api/models/components/partnermanagedcompanyretrievetermsofservicerequest.js";
