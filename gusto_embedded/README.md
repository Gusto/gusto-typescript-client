...
```bash
npm add https://gitpkg.now.sh/Gusto/gusto-typescript-client/gusto_embedded
```

### PNPM

```bash
pnpm add https://gitpkg.now.sh/Gusto/gusto-typescript-client/gusto_embedded
```

### Bun

```bash
bun add https://gitpkg.now.sh/Gusto/gusto-typescript-client/gusto_embedded
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/Gusto/gusto-typescript-client/gusto_embedded zod
