...
import { employeeAddressesCreateHomeAddress } from "../funcs/employeeAddressesCreateHomeAddress.js";
...
import { employeeAddressesGetHomeById } from "../funcs/employeeAddressesGetHomeById.js";
...
import { employeeAddressesRemove } from "../funcs/employeeAddressesRemove.js";
...
export class EmployeeAddresses extends ClientSDK {
  ...
  async getHomeById(
    ...
    return unwrapAsync(employeeAddressesGetHomeById(
      this,
      request,
      options,
    ));
  ...
  async remove(
    ...
    return unwrapAsync(employeeAddressesRemove(
      this,
      request,
      options,
    ));
