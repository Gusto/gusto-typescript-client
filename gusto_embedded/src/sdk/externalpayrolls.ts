...
import { externalPayrollsFinishTaxLiabilities } from "../funcs/externalPayrollsFinishTaxLiabilities.js";
...
export class ExternalPayrolls extends ClientSDK {
   ...
   * scope: `external_payrolls:write`
   */
  async finishTaxLiabilities(
    request: operations.PutV1TaxLiabilitiesFinishRequest,
    options?: RequestOptions,
  ): Promise<void> {
    return unwrapAsync(externalPayrollsFinishTaxLiabilities(
      this,
      request,
      options,
    ));
