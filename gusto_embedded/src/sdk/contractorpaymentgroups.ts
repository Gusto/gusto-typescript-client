...
import { contractorPaymentGroupsCancel } from "../funcs/contractorPaymentGroupsCancel.js";
import { contractorPaymentGroupsCreate } from "../funcs/contractorPaymentGroupsCreate.js";
import { contractorPaymentGroupsFetch } from "../funcs/contractorPaymentGroupsFetch.js";
...
export class ContractorPaymentGroups extends ClientSDK {
  ...
  async fetch(
    ...
    return unwrapAsync(contractorPaymentGroupsFetch(
      this,
      request,
      options,
    ));
  ...
  async cancel(
    ...
    return unwrapAsync(contractorPaymentGroupsCancel(
      this,
      request,
      options,
    ));
