...
import {
  ...
  GetTaxPaymentsRequest$outboundSchema,
  GetTaxPaymentsResponse,
  GetTaxPaymentsResponse$inboundSchema,
 ...
 */
export function taxPaymentsGetTaxPayments(
...
> {
  const parsed = safeParse(
    request,
    (value) => GetTaxPaymentsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/companies/{company_uuid}/tax_payments")(
    pathParams,
  );
  ...
  const query = queryJoin(
    ...
    encodeFormQuery({
      ...
      "page": payload.page,
      "payment_sent_on_from": payload.payment_sent_on_from,
      "payment_sent_on_to": payload.payment_sent_on_to,
      "per": payload.per,
      "period_end_from": payload.period_end_from,
      "period_end_to": payload.period_end_to,
      "period_start_from": payload.period_start_from,
      "period_start_to": payload.period_start_to,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetTaxPaymentsResponse$inboundSchema, {
      key: "Tax-Payment-List",
    }),
