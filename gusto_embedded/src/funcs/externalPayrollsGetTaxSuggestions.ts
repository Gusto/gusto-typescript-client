 ...
 */
export async function externalPayrollsGetTaxSuggestions(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetV1ExternalPayrollCalculateTaxesRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      z.array(components.ExternalPayrollTaxSuggestions$inboundSchema),
    ),
    M.fail([404, "4XX"]),
    M.fail("5XX"),
  )(response);
