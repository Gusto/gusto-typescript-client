 ...
 */
export async function paymentConfigsUpdate(
  client: GustoEmbeddedCore,
  request: operations.PutV1CompanyPaymentConfigsRequest,
  options?: RequestOptions,
): Promise<
  Result<
    components.PaymentConfigs,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PutV1CompanyPaymentConfigsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.PaymentConfigs$inboundSchema),
    M.fail([404, "4XX", "5XX"]),
