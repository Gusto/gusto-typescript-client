...
import {
  ...
  GetTaxPaymentRequest$outboundSchema,
  GetTaxPaymentResponse,
  GetTaxPaymentResponse$inboundSchema,
 ...
 */
export function taxPaymentsGetTaxPayment(
...
> {
  const parsed = safeParse(
    request,
    (value) => GetTaxPaymentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/companies/{company_uuid}/tax_payments/{uuid}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetTaxPaymentResponse$inboundSchema, { key: "Tax-Payment" }),
