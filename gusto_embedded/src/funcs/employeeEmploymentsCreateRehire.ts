 ...
 */
export function employeeEmploymentsCreateRehire(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostV1EmployeesEmployeeIdRehireRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      201,
      operations.PostV1EmployeesEmployeeIdRehireResponse$inboundSchema,
      { key: "Rehire" },
    ),
