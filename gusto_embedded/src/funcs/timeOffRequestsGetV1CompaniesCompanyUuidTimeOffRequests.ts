...
import {
  ...
  GetV1CompaniesCompanyUuidTimeOffRequestsRequest$outboundSchema,
  GetV1CompaniesCompanyUuidTimeOffRequestsResponse,
  GetV1CompaniesCompanyUuidTimeOffRequestsResponse$inboundSchema,
 ...
 */
export function timeOffRequestsGetV1CompaniesCompanyUuidTimeOffRequests(
...
> {
  ...
  const context = {
    ...
    operationID: "get-v1-companies-company_uuid-time_off-requests",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      GetV1CompaniesCompanyUuidTimeOffRequestsResponse$inboundSchema,
      { key: "Embedded-Time-Off-Requests" },
    ),
