...
export function flowsCreate(
  ...
  Result<
    operations.PostV1CompanyFlowsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PostV1CompanyFlowsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, operations.PostV1CompanyFlowsResponse$inboundSchema, {
      key: "Flow",
    }),
