...
export function employeesUpdate(
  ...
  Result<
    operations.PutV1EmployeesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PutV1EmployeesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.PutV1EmployeesResponse$inboundSchema, {
      key: "Employee",
    }),
