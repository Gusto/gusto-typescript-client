 ...
 */
export function memberPortalInvitationsPostV1ContractorsContractorUuidMemberPortalInvitations(
...
> {
  ...
  const context = {
    ...
    operationID:
      "post-v1-contractors-contractor_uuid-member_portal_invitations",
    oAuth2Scopes: null,
