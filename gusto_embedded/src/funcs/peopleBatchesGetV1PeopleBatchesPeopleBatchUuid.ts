...
import {
  ...
  GetV1PeopleBatchesPeopleBatchUuidRequest$outboundSchema,
  GetV1PeopleBatchesPeopleBatchUuidResponse,
  GetV1PeopleBatchesPeopleBatchUuidResponse$inboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      GetV1PeopleBatchesPeopleBatchUuidRequest$outboundSchema.parse(value),
