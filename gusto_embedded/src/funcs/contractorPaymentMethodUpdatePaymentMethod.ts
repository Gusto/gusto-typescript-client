 ...
 */
export async function contractorPaymentMethodUpdatePaymentMethod(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PutV1ContractorsContractorIdPaymentMethodRequest$outboundSchema
        .parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.ContractorPaymentMethod$inboundSchema),
