...
export function employeeAddressesCreate(
  ...
  Result<
    operations.PostV1EmployeesEmployeeIdHomeAddressesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostV1EmployeesEmployeeIdHomeAddressesRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      201,
      operations.PostV1EmployeesEmployeeIdHomeAddressesResponse$inboundSchema,
