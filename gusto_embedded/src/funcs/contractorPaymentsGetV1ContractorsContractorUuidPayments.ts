...
import {
  ...
  GetV1ContractorsContractorUuidPaymentsRequest$outboundSchema,
  GetV1ContractorsContractorUuidPaymentsResponse,
  GetV1ContractorsContractorUuidPaymentsResponse$inboundSchema,
 ...
 */
export function contractorPaymentsGetV1ContractorsContractorUuidPayments(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      GetV1ContractorsContractorUuidPaymentsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/contractors/{contractor_uuid}/payments")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "get-v1-contractors-contractor_uuid-payments",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetV1ContractorsContractorUuidPaymentsResponse$inboundSchema, {
      key: "Contractor-Payment-Listings",
    }),
