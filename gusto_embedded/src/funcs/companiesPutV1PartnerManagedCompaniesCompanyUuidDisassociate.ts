 ...
 */
export function companiesPutV1PartnerManagedCompaniesCompanyUuidDisassociate(
...
> {
  ...
  const context = {
    ...
    operationID: "put-v1-partner-managed-companies-company-uuid-disassociate",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      PutV1PartnerManagedCompaniesCompanyUuidDisassociateResponse$inboundSchema,
      { key: "Partner-Managed-Company-Disassociate-Response" },
    ),
