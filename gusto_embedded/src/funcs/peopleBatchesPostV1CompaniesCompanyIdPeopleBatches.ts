...
import {
  ...
  PostV1CompaniesCompanyIdPeopleBatchesRequest$outboundSchema,
  PostV1CompaniesCompanyIdPeopleBatchesResponse,
  PostV1CompaniesCompanyIdPeopleBatchesResponse$inboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      PostV1CompaniesCompanyIdPeopleBatchesRequest$outboundSchema.parse(value),
