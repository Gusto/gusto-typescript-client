...
import {
  ...
  GetCompaniesCompanyUuidPaidHolidaysRequest$outboundSchema,
  GetCompaniesCompanyUuidPaidHolidaysResponse,
  GetCompaniesCompanyUuidPaidHolidaysResponse$inboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      GetCompaniesCompanyUuidPaidHolidaysRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetCompaniesCompanyUuidPaidHolidaysResponse$inboundSchema, {
      key: "Paid-Holidays",
    }),
