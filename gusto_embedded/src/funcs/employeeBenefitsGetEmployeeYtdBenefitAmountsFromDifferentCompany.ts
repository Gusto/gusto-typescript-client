 ...
 */
export async function employeeBenefitsGetEmployeeYtdBenefitAmountsFromDifferentCompany(
...
> {
  ...
  >(
    M.json(
      200,
      z.array(components.YtdBenefitAmountsFromDifferentCompany$inboundSchema),
    ),
    M.fail([404, "4XX"]),
    M.fail("5XX"),
  )(response);
