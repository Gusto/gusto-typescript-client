...
import {
  ...
  SubmitInformationRequestRequest$outboundSchema,
  SubmitInformationRequestResponse,
  SubmitInformationRequestResponse$inboundSchema,
 ...
 */
export function informationRequestsSubmit(
...
> {
  const parsed = safeParse(
    request,
    (value) => SubmitInformationRequestRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    information_request_uuid: encodeSimple(
      "information_request_uuid",
      payload.information_request_uuid,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, SubmitInformationRequestResponse$inboundSchema, {
