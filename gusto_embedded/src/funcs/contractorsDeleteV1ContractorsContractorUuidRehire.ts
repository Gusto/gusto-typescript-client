...
import {
  ...
  DeleteV1ContractorsContractorUuidRehireRequest$outboundSchema,
  DeleteV1ContractorsContractorUuidRehireResponse,
  DeleteV1ContractorsContractorUuidRehireResponse$inboundSchema,
 ...
 */
export function contractorsDeleteV1ContractorsContractorUuidRehire(
...
> {
  ...
  const path = pathToFunc("/v1/contractors/{contractor_uuid}/rehire")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "delete-v1-contractors-contractor_uuid-rehire",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, DeleteV1ContractorsContractorUuidRehireResponse$inboundSchema),
    M.fail([422, "4XX"]),
    M.fail("5XX"),
