...
export function industrySelectionUpdate(
  ...
  Result<
    operations.PutV1CompanyIndustryResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PutV1CompanyIndustryRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, operations.PutV1CompanyIndustryResponse$inboundSchema, {
      key: "Industry",
    }),
