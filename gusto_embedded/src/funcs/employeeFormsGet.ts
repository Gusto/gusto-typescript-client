...
import {
  ...
  GetV1EmployeeFormRequest$outboundSchema,
  GetV1EmployeeFormResponse,
  GetV1EmployeeFormResponse$inboundSchema,
 ...
 */
export function employeeFormsGet(
...
> {
  const parsed = safeParse(
    request,
    (value) => GetV1EmployeeFormRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetV1EmployeeFormResponse$inboundSchema, { key: "Form" }),
    M.fail([404, "4XX"]),
    M.fail("5XX"),
