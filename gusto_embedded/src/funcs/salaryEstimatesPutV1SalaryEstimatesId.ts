...
import {
  ...
  PutV1SalaryEstimatesIdRequest$outboundSchema,
  PutV1SalaryEstimatesIdResponse,
  PutV1SalaryEstimatesIdResponse$inboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => PutV1SalaryEstimatesIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, PutV1SalaryEstimatesIdResponse$inboundSchema, {
      key: "Salary-Estimate",
    }),
