 ...
 * The "answer"
 */
export type TaxRequirementValue = string | boolean;
...
/** @internal */
export type TaxRequirementValue$Outbound = string | boolean;
...
> = z.object({
  ...
  value: z.nullable(z.union([z.string(), z.boolean()])).optional(),
