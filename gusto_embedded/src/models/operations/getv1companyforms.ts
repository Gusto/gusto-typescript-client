...
export type GetV1CompanyFormsRequest = {
  ...
  companyId: string;
  /**
   * Sort company forms by one or more fields. Options: created_at, name, year, quarter, draft, document_content_type. Append `:asc` or `:desc` to specify direction (e.g., `name:desc` or `name:asc,year:desc`). Defaults to ascending.
   */
