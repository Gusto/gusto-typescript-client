...
export type PutV1CompaniesRequest = {
  ...
  requestBody?: PutV1CompaniesRequestBody | undefined;
};
...
> = z.object({
  ...
  RequestBody: z.lazy(() => PutV1CompaniesRequestBody$inboundSchema).optional(),
}).transform((v) => {
  return remap$(v, {
...
export type PutV1CompaniesRequest$Outbound = {
  ...
  RequestBody?: PutV1CompaniesRequestBody$Outbound | undefined;
};
