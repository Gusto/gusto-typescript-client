...
export type GetInformationRequestsRequest = {
  ...
  companyUuid: string;
  /**
   * Sort information requests by one or more fields. Options: payroll_blocker, status, type. Append `:asc` or `:desc` to specify direction (e.g., `status:asc` or `status:asc,type:desc`). Defaults to ascending.
   */
