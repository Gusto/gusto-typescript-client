...
export type PostV1EmployeesEmployeeIdRehireRequest = {
  ...
  rehireBody?: components.RehireBody | undefined;
};
...
> = z.object({
  ...
  "Rehire-Body": components.RehireBody$inboundSchema.optional(),
}).transform((v) => {
  return remap$(v, {
...
export type PostV1EmployeesEmployeeIdRehireRequest$Outbound = {
  ...
  "Rehire-Body"?: components.RehireBody$Outbound | undefined;
};
...
> = z.object({
  ...
  rehireBody: components.RehireBody$outboundSchema.optional(),
}).transform((v) => {
  return remap$(v, {
