...
* [getAll](#getall) - Get employees of a company
* [createHistorical](#createhistorical) - Create a historical employee
* [updateHistoricalEmployee](#updatehistoricalemployee) - Update a historical employee
...
import { employeesCreate } from "openapi/funcs/employeesCreate.js";
...
async function run() {
  const result = await sdk.employees.getAll({
    companyId: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { employeesGetAll } from "openapi/funcs/employeesGetAll.js";
...
async function run() {
  const res = await employeesGetAll(sdk, {
    companyId: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { employeesCreateHistorical } from "openapi/funcs/employeesCreateHistorical.js";
import { RFCDate } from "openapi/types";
...
async function run() {
  const result = await sdk.employees.updateHistoricalEmployee({
    companyUuid: "<id>",
...
```typescript
import { SDKCore } from "openapi/core.js";
import { employeesUpdateHistoricalEmployee } from "openapi/funcs/employeesUpdateHistoricalEmployee.js";
import { RFCDate } from "openapi/types";
...
async function run() {
  const res = await employeesUpdateHistoricalEmployee(sdk, {
    companyUuid: "<id>",
    historicalEmployeeUuid: "<id>",
    requestBody: {
      version: "db0edd04aaac4506f7edab03ac855d56",
...
```typescript
import { SDKCore } from "openapi/core.js";
import { employeesGet } from "openapi/funcs/employeesGet.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { employeesUpdate } from "openapi/funcs/employeesUpdate.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { employeesDelete } from "openapi/funcs/employeesDelete.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { employeesGetCustomFields } from "openapi/funcs/employeesGetCustomFields.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { employeesUpdateOnboardingDocumentsConfig } from "openapi/funcs/employeesUpdateOnboardingDocumentsConfig.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { employeesGetOnboardingStatus } from "openapi/funcs/employeesGetOnboardingStatus.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { employeesUpdateOnboardingStatus } from "openapi/funcs/employeesUpdateOnboardingStatus.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { employeesGetTimeOffActivities } from "openapi/funcs/employeesGetTimeOffActivities.js";
