...
* [updateJob](#updatejob) - Update a job
...
import { jobsAndCompensationsCreateJob } from "openapi/funcs/jobsAndCompensationsCreateJob.js";
...
async function run() {
  const result = await sdk.jobsAndCompensations.list({
    employeeId: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { jobsAndCompensationsList } from "openapi/funcs/jobsAndCompensationsList.js";
...
async function run() {
  const res = await jobsAndCompensationsList(sdk, {
    employeeId: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { jobsAndCompensationsGetJob } from "openapi/funcs/jobsAndCompensationsGetJob.js";
...
async function run() {
  const result = await sdk.jobsAndCompensations.updateJob({
    jobId: "<id>",
    requestBody: {
...
```typescript
import { SDKCore } from "openapi/core.js";
import { jobsAndCompensationsUpdateJob } from "openapi/funcs/jobsAndCompensationsUpdateJob.js";
...
async function run() {
  const res = await jobsAndCompensationsUpdateJob(sdk, {
    jobId: "<id>",
    requestBody: {
      version: "gr78930htutrz444kuytr3s5hgxykuveb523fwl8sir",
      title: "Regional Manager",
...
async function run() {
  await sdk.jobsAndCompensations.deleteJob({
    jobId: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { jobsAndCompensationsDeleteJob } from "openapi/funcs/jobsAndCompensationsDeleteJob.js";
...
async function run() {
  const res = await jobsAndCompensationsDeleteJob(sdk, {
    jobId: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { jobsAndCompensationsGetCompensations } from "openapi/funcs/jobsAndCompensationsGetCompensations.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { jobsAndCompensationsCreateCompensation } from "openapi/funcs/jobsAndCompensationsCreateCompensation.js";
...
async function run() {
  const result = await sdk.jobsAndCompensations.get({
    compensationId: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { jobsAndCompensationsGet } from "openapi/funcs/jobsAndCompensationsGet.js";
...
async function run() {
  const res = await jobsAndCompensationsGet(sdk, {
    compensationId: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { jobsAndCompensationsDelete } from "openapi/funcs/jobsAndCompensationsDelete.js";
