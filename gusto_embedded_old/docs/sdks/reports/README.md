...
async function run() {
  const result = await sdk.reports.create({
    companyUuid: "<id>",
    requestBody: {
      columns: [
...
import { reportsCreate } from "openapi/funcs/reportsCreate.js";
import { RFCDate } from "openapi/types";
...
async function run() {
  const res = await reportsCreate(sdk, {
    companyUuid: "<id>",
    requestBody: {
      columns: [
        "employee_compensation_time_period",
...
async function run() {
  const result = await sdk.reports.get({
    reportUuid: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { reportsGet } from "openapi/funcs/reportsGet.js";
...
async function run() {
  const res = await reportsGet(sdk, {
    reportUuid: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { reportsGetTemplate } from "openapi/funcs/reportsGetTemplate.js";
