...
import { signatoriesCreate } from "openapi/funcs/signatoriesCreate.js";
...
async function run() {
  const result = await sdk.signatories.get({
    companyUuid: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { signatoriesGet } from "openapi/funcs/signatoriesGet.js";
...
async function run() {
  const res = await signatoriesGet(sdk, {
    companyUuid: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { signatoriesInvite } from "openapi/funcs/signatoriesInvite.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { signatoriesUpdate } from "openapi/funcs/signatoriesUpdate.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { signatoriesDelete } from "openapi/funcs/signatoriesDelete.js";
