...
async function run() {
  await sdk.employeePaymentMethods.delete({
    employeeId: "<id>",
    bankAccountUuid: "<id>",
  });
...
import { employeePaymentMethodsDelete } from "openapi/funcs/employeePaymentMethodsDelete.js";
...
async function run() {
  const res = await employeePaymentMethodsDelete(sdk, {
    employeeId: "<id>",
    bankAccountUuid: "<id>",
  });
...
async function run() {
  const result = await sdk.employeePaymentMethods.get({
    employeeId: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { employeePaymentMethodsGet } from "openapi/funcs/employeePaymentMethodsGet.js";
...
async function run() {
  const res = await employeePaymentMethodsGet(sdk, {
    employeeId: "<id>",
  });
