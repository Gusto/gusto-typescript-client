...
* [getAll](#getall) - Get all company bank accounts
...
import { bankAccountsCreate } from "openapi/funcs/bankAccountsCreate.js";
...
async function run() {
  const result = await sdk.bankAccounts.getAll({
    companyId: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { bankAccountsGetAll } from "openapi/funcs/bankAccountsGetAll.js";
...
async function run() {
  const res = await bankAccountsGetAll(sdk, {
    companyId: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { bankAccountsVerify } from "openapi/funcs/bankAccountsVerify.js";
...
async function run() {
  const result = await sdk.bankAccounts.createFromProcessorToken({
    requestBody: {
      ownerType: "Company",
...
```typescript
import { SDKCore } from "openapi/core.js";
import { bankAccountsCreateFromProcessorToken } from "openapi/funcs/bankAccountsCreateFromProcessorToken.js";
...
async function run() {
  const res = await bankAccountsCreateFromProcessorToken(sdk, {
    requestBody: {
      ownerType: "Company",
      ownerId: "ef279fbd-0fc6-4cf1-a977-6939d621c429",
      processorToken: "processor-sandbox-0asd1-a92nc",
