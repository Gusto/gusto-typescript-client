...
async function run() {
  const result = await sdk.timeOffPolicies.calculateAccruingHours({
    payrollId: "<id>",
    employeeId: "<id>",
    requestBody: {
...
import { timeOffPoliciesCalculateAccruingHours } from "openapi/funcs/timeOffPoliciesCalculateAccruingHours.js";
...
async function run() {
  const res = await timeOffPoliciesCalculateAccruingHours(sdk, {
    payrollId: "<id>",
    employeeId: "<id>",
    requestBody: {
      regularHoursWorked: 30.25,
...
```typescript
import { SDKCore } from "openapi/core.js";
import { timeOffPoliciesGet } from "openapi/funcs/timeOffPoliciesGet.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { timeOffPoliciesUpdate } from "openapi/funcs/timeOffPoliciesUpdate.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { timeOffPoliciesGetAll } from "openapi/funcs/timeOffPoliciesGetAll.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { timeOffPoliciesCreate } from "openapi/funcs/timeOffPoliciesCreate.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { timeOffPoliciesAddEmployees } from "openapi/funcs/timeOffPoliciesAddEmployees.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { timeOffPoliciesRemoveEmployees } from "openapi/funcs/timeOffPoliciesRemoveEmployees.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { timeOffPoliciesUpdateBalance } from "openapi/funcs/timeOffPoliciesUpdateBalance.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { timeOffPoliciesDeactivate } from "openapi/funcs/timeOffPoliciesDeactivate.js";
