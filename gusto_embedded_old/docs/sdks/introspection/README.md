...
import { introspectionGetTokenInfo } from "openapi/funcs/introspectionGetTokenInfo.js";
...
async function run() {
  const res = await introspectionGetTokenInfo(sdk, {});
...
async function run() {
  const result = await sdk.introspection.refreshToken({});
...
```typescript
import { SDKCore } from "openapi/core.js";
import { introspectionRefreshToken } from "openapi/funcs/introspectionRefreshToken.js";
...
async function run() {
  const res = await introspectionRefreshToken(sdk, {});
