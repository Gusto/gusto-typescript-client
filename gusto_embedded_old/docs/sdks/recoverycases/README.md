...
* [initiateRedebit](#initiateredebit) - Initiate a redebit for a recovery case
...
async function run() {
  const result = await sdk.recoveryCases.getAll({
    companyUuid: "<id>",
  });
...
import { recoveryCasesGetAll } from "openapi/funcs/recoveryCasesGetAll.js";
...
async function run() {
  const res = await recoveryCasesGetAll(sdk, {
    companyUuid: "<id>",
  });
...
async function run() {
  await sdk.recoveryCases.initiateRedebit({
    recoveryCaseUuid: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { recoveryCasesInitiateRedebit } from "openapi/funcs/recoveryCasesInitiateRedebit.js";
...
async function run() {
  const res = await recoveryCasesInitiateRedebit(sdk, {
    recoveryCaseUuid: "<id>",
  });
