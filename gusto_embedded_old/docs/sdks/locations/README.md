...
import { locationsCreate } from "openapi/funcs/locationsCreate.js";
...
async function run() {
  const result = await sdk.locations.getAll({
    companyId: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { locationsGetAll } from "openapi/funcs/locationsGetAll.js";
...
async function run() {
  const res = await locationsGetAll(sdk, {
    companyId: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { locationsGet } from "openapi/funcs/locationsGet.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { locationsUpdate } from "openapi/funcs/locationsUpdate.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { locationsGetMinimumWages } from "openapi/funcs/locationsGetMinimumWages.js";
