...
import { departmentsCreate } from "openapi/funcs/departmentsCreate.js";
...
async function run() {
  const result = await sdk.departments.list({
    companyUuid: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { departmentsList } from "openapi/funcs/departmentsList.js";
...
async function run() {
  const res = await departmentsList(sdk, {
    companyUuid: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { departmentsGet } from "openapi/funcs/departmentsGet.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { departmentsUpdate } from "openapi/funcs/departmentsUpdate.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { departmentsDelete } from "openapi/funcs/departmentsDelete.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { departmentsAddPeople } from "openapi/funcs/departmentsAddPeople.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { departmentsRemovePeople } from "openapi/funcs/departmentsRemovePeople.js";
