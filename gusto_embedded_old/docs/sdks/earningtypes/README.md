...
import { earningTypesCreate } from "openapi/funcs/earningTypesCreate.js";
...
async function run() {
  const result = await sdk.earningTypes.getAll({
    companyId: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { earningTypesGetAll } from "openapi/funcs/earningTypesGetAll.js";
...
async function run() {
  const res = await earningTypesGetAll(sdk, {
    companyId: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { earningTypesUpdate } from "openapi/funcs/earningTypesUpdate.js";
...
async function run() {
  await sdk.earningTypes.deactivate({
    companyId: "<id>",
    earningTypeUuid: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { earningTypesDeactivate } from "openapi/funcs/earningTypesDeactivate.js";
...
async function run() {
  const res = await earningTypesDeactivate(sdk, {
    companyId: "<id>",
    earningTypeUuid: "<id>",
  });
