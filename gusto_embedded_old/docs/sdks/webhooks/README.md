...
import { webhooksCreateSubscription } from "openapi/funcs/webhooksCreateSubscription.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { webhooksListSubscriptions } from "openapi/funcs/webhooksListSubscriptions.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { webhooksUpdateSubscription } from "openapi/funcs/webhooksUpdateSubscription.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { webhooksGetSubscription } from "openapi/funcs/webhooksGetSubscription.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { webhooksDelete } from "openapi/funcs/webhooksDelete.js";
...
async function run() {
  const res = await webhooksDelete(sdk, {
    systemAccessAuth: "<YOUR_BEARER_TOKEN_HERE>",
  }, {
    webhookSubscriptionUuid: "<id>",
  });
...
async function run() {
  const result = await sdk.webhooks.verifySubscription({
    systemAccessAuth: "<YOUR_BEARER_TOKEN_HERE>",
  }, {
    webhookSubscriptionUuid: "<id>",
    requestBody: {
...
```typescript
import { SDKCore } from "openapi/core.js";
import { webhooksVerifySubscription } from "openapi/funcs/webhooksVerifySubscription.js";
...
async function run() {
  const res = await webhooksVerifySubscription(sdk, {
    systemAccessAuth: "<YOUR_BEARER_TOKEN_HERE>",
  }, {
    webhookSubscriptionUuid: "<id>",
    requestBody: {
...
```typescript
import { SDKCore } from "openapi/core.js";
import { webhooksRequestVerificationToken } from "openapi/funcs/webhooksRequestVerificationToken.js";
