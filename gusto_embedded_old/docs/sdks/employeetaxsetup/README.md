...
* [getFederal](#getfederal) - Get an employee's federal taxes
* [updateFederal](#updatefederal) - Update an employee's federal taxes
...
async function run() {
  const result = await sdk.employeeTaxSetup.getFederal({
    employeeUuid: "<id>",
  });
...
import { employeeTaxSetupGetFederal } from "openapi/funcs/employeeTaxSetupGetFederal.js";
...
async function run() {
  const res = await employeeTaxSetupGetFederal(sdk, {
    employeeUuid: "<id>",
  });
...
async function run() {
  const result = await sdk.employeeTaxSetup.updateFederal({
    employeeUuid: "<id>",
    requestBody: {
...
```typescript
import { SDKCore } from "openapi/core.js";
import { employeeTaxSetupUpdateFederal } from "openapi/funcs/employeeTaxSetupUpdateFederal.js";
...
async function run() {
  const res = await employeeTaxSetupUpdateFederal(sdk, {
    employeeUuid: "<id>",
    requestBody: {
      version: "56a489ce86ed6c1b0f0cecc4050a0b01",
      filingStatus: "Single",
...
```typescript
import { SDKCore } from "openapi/core.js";
import { employeeTaxSetupGetStateTaxes } from "openapi/funcs/employeeTaxSetupGetStateTaxes.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { employeeTaxSetupUpdateStateTaxes } from "openapi/funcs/employeeTaxSetupUpdateStateTaxes.js";
