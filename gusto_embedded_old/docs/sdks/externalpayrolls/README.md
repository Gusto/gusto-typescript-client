...
import { externalPayrollsCreate } from "openapi/funcs/externalPayrollsCreate.js";
...
async function run() {
  const result = await sdk.externalPayrolls.list({
    companyUuid: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { externalPayrollsList } from "openapi/funcs/externalPayrollsList.js";
...
async function run() {
  const res = await externalPayrollsList(sdk, {
    companyUuid: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { externalPayrollsGet } from "openapi/funcs/externalPayrollsGet.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { externalPayrollsDelete } from "openapi/funcs/externalPayrollsDelete.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { externalPayrollsUpdate } from "openapi/funcs/externalPayrollsUpdate.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { externalPayrollsCalculateTaxes } from "openapi/funcs/externalPayrollsCalculateTaxes.js";
...
async function run() {
  const result = await sdk.externalPayrolls.getTaxLiabilities({
    companyUuid: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { externalPayrollsGetTaxLiabilities } from "openapi/funcs/externalPayrollsGetTaxLiabilities.js";
...
async function run() {
  const res = await externalPayrollsGetTaxLiabilities(sdk, {
    companyUuid: "<id>",
  });
...
```typescript
import { SDKCore } from "openapi/core.js";
import { externalPayrollsUpdateTaxLiabilities } from "openapi/funcs/externalPayrollsUpdateTaxLiabilities.js";
...
```typescript
import { SDKCore } from "openapi/core.js";
import { externalPayrollsFinalizeTaxLiabilities } from "openapi/funcs/externalPayrollsFinalizeTaxLiabilities.js";
