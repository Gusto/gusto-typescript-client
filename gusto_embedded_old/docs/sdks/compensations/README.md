...
async function run() {
  const result = await sdk.compensations.update({
    compensationId: "<id>",
    requestBody: {
...
import { compensationsUpdate } from "openapi/funcs/compensationsUpdate.js";
...
async function run() {
  const res = await compensationsUpdate(sdk, {
    compensationId: "<id>",
    requestBody: {
      version: "98jr3289h3298hr9329gf9egskt3kagri32qqgiqe3872",
      rate: "60000.00",
