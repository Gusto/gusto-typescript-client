...
import { employeesGetAll } from "../funcs/employeesGetAll.js";
...
import { employeesUpdateHistoricalEmployee } from "../funcs/employeesUpdateHistoricalEmployee.js";
...
export class Employees extends ClientSDK {
  ...
  async getAll(
    ...
    return unwrapAsync(employeesGetAll(
      this,
      request,
      options,
    ));
   ...
   * scope: `employees:manage`
   */
  async updateHistoricalEmployee(
    request: operations.PutV1HistoricalEmployeesRequest,
    options?: RequestOptions,
  ): Promise<components.Employee> {
    return unwrapAsync(employeesUpdateHistoricalEmployee(
      this,
      request,
      options,
    ));
