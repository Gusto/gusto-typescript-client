...
import { employeeTaxSetupGetFederal } from "../funcs/employeeTaxSetupGetFederal.js";
import { employeeTaxSetupGetStateTaxes } from "../funcs/employeeTaxSetupGetStateTaxes.js";
import { employeeTaxSetupUpdateFederal } from "../funcs/employeeTaxSetupUpdateFederal.js";
...
export class EmployeeTaxSetup extends ClientSDK {
  ...
  async getFederal(
    ...
    return unwrapAsync(employeeTaxSetupGetFederal(
      this,
      request,
      options,
    ));
  ...
  async updateFederal(
    ...
    return unwrapAsync(employeeTaxSetupUpdateFederal(
      this,
      request,
      options,
    ));
