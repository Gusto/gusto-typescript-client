...
import { companyBenefitsGetBenefit } from "../funcs/companyBenefitsGetBenefit.js";
...
import { companyBenefitsListAll } from "../funcs/companyBenefitsListAll.js";
...
export class CompanyBenefits extends ClientSDK {
  ...
  async listAll(
    ...
    return unwrapAsync(companyBenefitsListAll(
      this,
      request,
      options,
    ));
  ...
  async getBenefit(
    ...
    return unwrapAsync(companyBenefitsGetBenefit(
      this,
      request,
      options,
    ));
