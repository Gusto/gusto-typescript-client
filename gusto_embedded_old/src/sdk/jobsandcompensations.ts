...
import { jobsAndCompensationsList } from "../funcs/jobsAndCompensationsList.js";
import { jobsAndCompensationsUpdateJob } from "../funcs/jobsAndCompensationsUpdateJob.js";
...
export class JobsAndCompensations extends ClientSDK {
  ...
  async list(
    ...
    return unwrapAsync(jobsAndCompensationsList(
      this,
      request,
      options,
    ));
  ...
  async updateJob(
    ...
    return unwrapAsync(jobsAndCompensationsUpdateJob(
      this,
      request,
      options,
    ));
