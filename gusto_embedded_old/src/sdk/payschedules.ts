...
import { paySchedulesGetUnprocessedTerminationPayPeriods } from "../funcs/paySchedulesGetUnprocessedTerminationPayPeriods.js";
...
export class PaySchedules extends ClientSDK {
   ...
   * scope: `payrolls:read`
   */
  async getUnprocessedTerminationPayPeriods(
    request:
    ...
    return unwrapAsync(paySchedulesGetUnprocessedTerminationPayPeriods(
      this,
      request,
      options,
    ));
