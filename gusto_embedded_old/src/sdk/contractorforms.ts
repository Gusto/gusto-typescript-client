...
import { contractorFormsGenerateDemo1099 } from "../funcs/contractorFormsGenerateDemo1099.js";
...
export class ContractorForms extends ClientSDK {
   ...
   */
  async generateDemo1099(
    request: operations.PostV1SandboxGenerate1099Request,
    options?: RequestOptions,
  ): Promise<components.Form1099> {
    return unwrapAsync(contractorFormsGenerateDemo1099(
      this,
      request,
      options,
    ));
